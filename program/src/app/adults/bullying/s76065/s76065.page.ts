...
@Component({
  selector: 'HumanWisdom-s76065',
  templateUrl: './s76065.page.html',
  styleUrls: ['./s76065.page.scss'],
})
export class S76065Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76065t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76065",this.totalTime)
    localStorage.setItem("avDuration76065",this.avDuration)
  }
}