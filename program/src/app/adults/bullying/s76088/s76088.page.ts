...
@Component({
  selector: 'HumanWisdom-s76088',
  templateUrl: './s76088.page.html',
  styleUrls: ['./s76088.page.scss'],
})
export class S76088Page implements OnInit {
  ...
  ngOnInit() {
    ...
    {
      // var base_color = "rgb(76088,76088,76088)";
  ...
  submitProgress() {
    ...
    this.router.navigate(['/adults/bullying/s76089'])
