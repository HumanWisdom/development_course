...
@Component({
  selector: 'HumanWisdom-s76040',
  templateUrl: './s76040.page.html',
  styleUrls: ['./s76040.page.scss'],
})
export class S76040Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76040t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76040",this.totalTime)
    localStorage.setItem("avDuration76040",this.avDuration)
  }
}