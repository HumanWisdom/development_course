...
@Component({
  selector: 'HumanWisdom-s76006',
  templateUrl: './s76006.page.html',
  styleUrls: ['./s76006.page.scss'],
})
export class S76006Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76006t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76006",this.totalTime)
    localStorage.setItem("avDuration76006",this.avDuration)
  }
}