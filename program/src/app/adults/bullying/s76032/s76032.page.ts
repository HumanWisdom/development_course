...
@Component({
  selector: 'HumanWisdom-s76032',
  templateUrl: './s76032.page.html',
  styleUrls: ['./s76032.page.scss'],
})
export class S76032Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76032t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76032",this.totalTime)
    localStorage.setItem("avDuration76032",this.avDuration)
  }
}