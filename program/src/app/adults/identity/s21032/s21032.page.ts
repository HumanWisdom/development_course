...
@Component({
  selector: 'app-s21032-audio',
  templateUrl: './s21032.page.html',
  styleUrls: ['./s21032.page.scss'],
})
export class S21032Page implements OnInit,OnDestroy {
  ...
  transcriptPage="identity/s21032t"
  toc="identity/s21001"
  bookmark=0
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime21032",this.totalTime)
    localStorage.setItem("avDuration21032",this.avDuration)
