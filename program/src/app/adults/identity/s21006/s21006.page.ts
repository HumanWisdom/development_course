...
@Component({
  selector: 'app-s21006-audio',
  templateUrl: './s21006.page.html',
  styleUrls: ['./s21006.page.scss'],
})
export class S21006Page implements OnInit,OnDestroy {
  ...
  transcriptPage="identity/s21006t"
  toc="identity/s21001"
  bookmark=0
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime21006",this.totalTime)
    localStorage.setItem("avDuration21006",this.avDuration)
