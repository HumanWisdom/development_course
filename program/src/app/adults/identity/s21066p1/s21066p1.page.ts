...
@Component({
  selector: 'app-s21066p1',
  templateUrl: './s21066p1.page.html',
  styleUrls: ['./s21066p1.page.scss'],
})
export class S21066p1Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(21066p1,21066p1,21066p1)";
    ...
    this.q1=this.findQuestion(105).Question
    this.optionList1=this.findQuestion(105).optionList
    this.q2=this.findQuestion(106).Question
    this.optionList2=this.findQuestion(106).optionList
   
    this.q4=this.findQuestion(107).Question
    this.optionList4=this.findQuestion(107).optionList
    this.q5=this.findQuestion(108).Question
    this.optionList5=this.findQuestion(108).optionList
    this.q6=this.findQuestion(109).Question
    this.optionList6=this.findQuestion(109).optionList
  ...
  submitProgress(){
   ...
   this.router.navigate(['/adults/identity/s21066p2'])
  ...
  prev(){
    this.router.navigate(['/identity/s21066'])
