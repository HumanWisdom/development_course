...
@Component({
  selector: 'app-s48103',
  templateUrl: './s48103.page.html',
  styleUrls: ['./s48103.page.scss'],
})
export class S48103Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(48074,48074,48074)";
    ...
    this.q1=this.findQuestion(262).Question
    this.optionList1=this.findQuestion(262).optionList
    this.q2=this.findQuestion(263).Question
    this.optionList2=this.findQuestion(263).optionList   
    this.q3=this.findQuestion(264).Question
    this.optionList3=this.findQuestion(264).optionList
    this.q4=this.findQuestion(265).Question
    this.optionList4=this.findQuestion(265).optionList
    this.q5=this.findQuestion(267).Question
    this.optionList5=this.findQuestion(267).optionList
