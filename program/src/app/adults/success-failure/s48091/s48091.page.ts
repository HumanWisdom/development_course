...
@Component({
  selector: 'app-s48091-audio',
  templateUrl: './s48091.page.html',
  styleUrls: ['./s48091.page.scss'],
})
export class S48091Page implements OnInit,OnDestroy {
  ...
  transcriptPage="success-failure/s48091t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime48091",this.totalTime)
    localStorage.setItem("avDuration48091",this.avDuration)
