...
@Component({
  selector: 'app-s57059',
  templateUrl: './s57059.page.html',
  styleUrls: ['./s57059.page.scss'],
})
export class S57059Page implements OnInit,OnDestroy {
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      this.router.navigate(['/nature-of-i/s57060'])
    

  }
  prev(){
    this.router.navigate(['/nature-of-i/s57058'])
