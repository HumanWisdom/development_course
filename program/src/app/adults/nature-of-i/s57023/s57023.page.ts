...
@Component({
  selector: 'app-s57023-audio',
  templateUrl: './s57023.page.html',
  styleUrls: ['./s57023.page.scss'],
})
export class S57023Page implements OnInit,OnDestroy {
  ...
  transcriptPage="nature-of-i/s57023t"
  ...
  prev(){
    this.router.navigate(['/adults/nature-of-i/s57022'])
