...
@Component({
  selector: 'app-s57027',
  templateUrl: './s57027.page.html',
  styleUrls: ['./s57027.page.scss'],
})
export class S57027Page implements OnInit,OnDestroy {
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      this.router.navigate(['/nature-of-i/s57028'])
    

  }
  prev(){
    this.router.navigate(['/nature-of-i/s57026'])
