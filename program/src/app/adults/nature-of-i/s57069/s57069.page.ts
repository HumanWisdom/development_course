...
@Component({
  selector: 'app-s57069',
  templateUrl: './s57069.page.html',
  styleUrls: ['./s57069.page.scss'],
})
export class S57069Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(57069,57069,57069)";
    ...
    this.q1=this.findQuestion(196).Question
    this.optionList1=this.findQuestion(196).optionList
    this.q2=this.findQuestion(197).Question
    this.optionList2=this.findQuestion(197).optionList
   
    this.q3=this.findQuestion(198).Question
    this.optionList3=this.findQuestion(198).optionList
    this.q4=this.findQuestion(199).Question
    this.optionList4=this.findQuestion(199).optionList
    this.q5=this.findQuestion(200).Question
    this.optionList5=this.findQuestion(200).optionList
