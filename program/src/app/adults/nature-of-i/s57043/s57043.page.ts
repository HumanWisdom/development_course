...
@Component({
  selector: 'app-s57043-audio',
  templateUrl: './s57043.page.html',
  styleUrls: ['./s57043.page.scss'],
})
export class S57043Page implements OnInit,OnDestroy {
  ...
  transcriptPage="nature-of-i/s57043t"
  ...
  prev(){
    this.router.navigate(['/nature-of-i/s57042'])
