...
@Component({
  selector: 'app-s57010',
  templateUrl: './s57010.page.html',
  styleUrls: ['./s57010.page.scss'],
})
export class S57010Page implements OnInit,OnDestroy {
...
createScreen(){
  ...
  prev(){
    this.router.navigate(['/adults/nature-of-i/s57009'])
