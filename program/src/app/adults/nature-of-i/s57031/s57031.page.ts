...
@Component({
  selector: 'app-s57031-audio',
  templateUrl: './s57031.page.html',
  styleUrls: ['./s57031.page.scss'],
})
export class S57031Page implements OnInit,OnDestroy {
  ...
  transcriptPage="nature-of-i/s57031t"
