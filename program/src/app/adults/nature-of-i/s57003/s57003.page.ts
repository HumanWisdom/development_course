...
@Component({
  selector: 'app-s57003',
  templateUrl: './s57003.page.html',
  styleUrls: ['./s57003.page.scss'],
})
export class S57003Page implements OnInit,OnDestroy {
...
createScreen(){
  ...
  prev(){
    this.router.navigate(['/adults/nature-of-i/s57002'])
