...
@Component({
  selector: 'app-s57055',
  templateUrl: './s57055.page.html',
  styleUrls: ['./s57055.page.scss'],
})
export class S57055Page implements OnInit {
  ...
  transcriptPage="nature-of-i/s57055t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/adults/nature-of-i/s57056'])
  ...
  prev(){
    this.router.navigate(['/adults/nature-of-i/s57054'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime57055",this.totalTime)
    localStorage.setItem("avDuration57055",this.avDuration)
  }
}
