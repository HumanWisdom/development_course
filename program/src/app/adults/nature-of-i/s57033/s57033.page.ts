...
@Component({
  selector: 'app-s57033-audio',
  templateUrl: './s57033.page.html',
  styleUrls: ['./s57033.page.scss'],
})
export class S57033Page implements OnInit,OnDestroy {
  ...
  transcriptPage="nature-of-i/s57033t"
