...
@Component({
  selector: 'app-s57041',
  templateUrl: './s57041.page.html',
  styleUrls: ['./s57041.page.scss'],
})
export class S57041Page implements OnInit,OnDestroy {
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s2357003'])
      })
  ...
  prev(){
    this.router.navigate(['/nature-of-i/s57040'])
