...
@Component({
  selector: 'app-s57013-audio',
  templateUrl: './s57013.page.html',
  styleUrls: ['./s57013.page.scss'],
})
export class S57013Page implements OnInit,OnDestroy {
  ...
  transcriptPage="nature-of-i/s57013t"
