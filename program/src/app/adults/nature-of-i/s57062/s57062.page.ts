...
export class S57062Page implements OnInit,OnDestroy {
 ...
 ngOnInit() {
    ...
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark57062")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s5706234'])
      })
  ...
  prev(){
    this.router.navigate(['/nature-of-i/s56061'])
