...
@Component({
  selector: 'app-s18099',
  templateUrl: './s18099.page.html',
  styleUrls: ['./s18099.page.scss'],
})
export class S18099Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(18099,18099,18099)";
    ...
    this.q1=this.findQuestion(181).Question
    this.optionList1=this.findQuestion(181).optionList
    this.q2=this.findQuestion(182).Question
    this.optionList2=this.findQuestion(182).optionList
    this.q3=this.findQuestion(183).Question
    this.optionList3=this.findQuestion(183).optionList
    this.q4=this.findQuestion(184).Question
    this.optionList4=this.findQuestion(184).optionList
    this.q5=this.findQuestion(185).Question
    this.optionList5=this.findQuestion(185).optionList
  ...
  prev(){
    this.router.navigate(['/emotional-needs/s18098'])
