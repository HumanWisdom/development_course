...
@Component({
  selector: 'HumanWisdom-adult-dashboard-v1',
  templateUrl: './adult-dashboard-v1.component.html',
  styleUrls: ['./adult-dashboard-v1.component.scss'],
})
export class AdultDashboardV1Component implements OnInit {
