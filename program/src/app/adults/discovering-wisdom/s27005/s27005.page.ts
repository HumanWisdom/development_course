...
@Component({
  selector: 'app-s27005-audio',
  templateUrl: './s27005.page.html',
  styleUrls: ['./s27005.page.scss'],
})
export class S27005Page implements OnInit,OnDestroy {
  ...
  transcriptPage="discovering-wisdom/s27005t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime27005",this.totalTime)
    localStorage.setItem("avDuration27005",this.avDuration)
