...
export class S49051Page implements OnInit,OnDestroy {
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark49051")))
...
createScreen(){
  ...
  submitProgress(){
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s4905134'])
      })
  ...
  prev(){
    this.router.navigate(['/opinions-beliefs/s49050'])
