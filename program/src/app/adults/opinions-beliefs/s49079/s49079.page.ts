...
@Component({
  selector: 'app-s49079-audio',
  templateUrl: './s49079.page.html',
  styleUrls: ['./s49079.page.scss'],
})
export class S49079Page implements OnInit,OnDestroy {
  ...
  transcriptPage="opinions-beliefs/s49079t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime49079",this.totalTime)
    localStorage.setItem("avDuration49079",this.avDuration)
