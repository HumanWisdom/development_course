...
@Component({
  selector: 'app-s49098',
  templateUrl: './s49098.page.html',
  styleUrls: ['./s49098.page.scss'],
})
export class S49098Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(49098,49098,49098)";
    ...
    this.q1=this.findQuestion(253).Question
    this.optionList1=this.findQuestion(253).optionList
    this.q2=this.findQuestion(254).Question
    this.optionList2=this.findQuestion(254).optionList   
    this.q3=this.findQuestion(255).Question
    this.optionList3=this.findQuestion(255).optionList
    this.q4=this.findQuestion(256).Question
    this.optionList4=this.findQuestion(256).optionList
    this.q5=this.findQuestion(257).Question
    this.optionList5=this.findQuestion(257).optionList
  ...
  prev(){
    this.router.navigate(['/opinions-beliefs/s49097'])
