...
@Component({
  selector: 'app-s49015-audio',
  templateUrl: './s49015.page.html',
  styleUrls: ['./s49015.page.scss'],
})
export class S49015Page implements OnInit,OnDestroy {
  ...
  transcriptPage="opinions-beliefs/s49015t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime49015",this.totalTime)
    localStorage.setItem("avDuration49015",this.avDuration)
