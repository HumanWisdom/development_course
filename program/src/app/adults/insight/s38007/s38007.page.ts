...
@Component({
  selector: 'app-s38007-audio',
  templateUrl: './s38007.page.html',
  styleUrls: ['./s38007.page.scss'],
})
export class S38007Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+4.3.mp3'

  transcriptPage="insight/s38007t"
  toc="insight/s38000"
  bookmark=0
  ...
  submitProgress(){
    ...
    this.router.navigate(['/insight/s38008'])
