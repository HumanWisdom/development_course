...
@Component({
  selector: 'app-s38011',
  templateUrl: './s38011.page.html',
  styleUrls: ['./s38011.page.scss'],
})
export class S38011Page implements OnInit,OnDestroy {

  bg="dark_blue_w10"
  mediaVideo=JSON.parse(localStorage.getItem("mediaVideo"))
  videoLink=this.mediaVideo+'/art_of_enquiry/videos/4.1.mp4'  
...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark38011")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.router.navigate(['/insight/s38012'])
   

  }
  prev(){
    this.router.navigate(['/insight/s38010'])
