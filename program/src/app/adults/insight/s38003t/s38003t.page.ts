...
@Component({
  selector: 'app-s38003t',
  templateUrl: './s38003t.page.html',
  styleUrls: ['./s38003t.page.scss'],
})
export class S38003tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration38003")
  totalTime=localStorage.getItem("totalTime38003")
