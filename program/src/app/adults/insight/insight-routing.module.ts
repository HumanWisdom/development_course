...
const routes: Routes = [
  ...
  },
  {
    path: 's38019p1',
    canActivate:[ActiveGuard],  
    component: S38019p1Page,
  },
  {
    path: 's38019p2',
    canActivate:[ActiveGuard],  
    component: S38019p2Page,
  },
  {
    path: 's38019p3',
    canActivate:[ActiveGuard],  
    component: S38019p3Page,
  },
  {
    path: 's38019p4',
    canActivate:[ActiveGuard],  
    component: S38019p4Page,
  },
  {
    path: 's38019p5',
    canActivate:[ActiveGuard],  
    component: S38019p5Page,
  },
  {
    path: 's38019p6',
    canActivate:[ActiveGuard],  
    component: S38019p6Page,
  },
  {
    path: 's38019p7',
    canActivate:[ActiveGuard],  
    component: S38019p7Page,
  },
  {
    path: 's38019p8',
    canActivate:[ActiveGuard],  
    component: S38019p8Page,
  },
