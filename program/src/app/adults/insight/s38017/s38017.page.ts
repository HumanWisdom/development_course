...
@Component({
  selector: 'app-s38017',
  templateUrl: './s38017.page.html',
  styleUrls: ['./s38017.page.scss'],
})
export class S38017Page implements OnInit,OnDestroy {
...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark38017")))
