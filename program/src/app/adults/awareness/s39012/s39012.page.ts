...
@Component({
  selector: 'app-s39012',
  templateUrl: './s39012.page.html',
  styleUrls: ['./s39012.page.scss'],
})
export class S39012Page implements OnInit {

  bg_tn="bg_red_pink"
  bg_cft="bg_red_pink"
  bg="red_pink_w10"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+5.6.mp3'
  title=""

  toc="awareness/s39000"
  transcriptPage="awareness/s39012t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime39012",this.totalTime)
    localStorage.setItem("avDuration39012",this.avDuration)
  }
}
