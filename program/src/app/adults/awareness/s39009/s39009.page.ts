...
@Component({
  selector: 'app-s39009',
  templateUrl: './s39009.page.html',
  styleUrls: ['./s39009.page.scss'],
})
export class S39009Page implements OnInit {

  bg="red_pink_w8"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+5.5.mp3'
  title=""

  toc="awareness/s39000"
  transcriptPage="awareness/s39009t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime39009",this.totalTime)
    localStorage.setItem("avDuration39009",this.avDuration)
  }
}
