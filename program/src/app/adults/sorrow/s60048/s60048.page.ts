...
@Component({
  selector: 'app-s60048-audio',
  templateUrl: './s60048.page.html',
  styleUrls: ['./s60048.page.scss'],
})
export class S60048Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime60048",this.totalTime)
    localStorage.setItem("avDuration60048",this.avDuration)
