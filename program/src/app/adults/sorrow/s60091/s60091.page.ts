...
@Component({
  selector: 'app-s60091-audio',
  templateUrl: './s60091.page.html',
  styleUrls: ['./s60091.page.scss'],
})
export class S60091Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime60091",this.totalTime)
    localStorage.setItem("avDuration60091",this.avDuration)
