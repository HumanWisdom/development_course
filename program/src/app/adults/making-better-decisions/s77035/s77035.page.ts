...
@Component({
  selector: 'HumanWisdom-s77035',
  templateUrl: './s77035.page.html',
  styleUrls: ['./s77035.page.scss'],
})
export class S77035Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark77035"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark77035"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark77035",JSON.stringify(this.bookmark))
  }
