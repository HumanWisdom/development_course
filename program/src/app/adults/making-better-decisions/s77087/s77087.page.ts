...
@Component({
  selector: 'HumanWisdom-s77087',
  templateUrl: './s77087.page.html',
  styleUrls: ['./s77087.page.scss'],
})
export class S77087Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77087",this.totalTime)
    localStorage.setItem("avDuration77087",this.avDuration)
  }
}