...
@Component({
  selector: 'HumanWisdom-s77010',
  templateUrl: './s77010.page.html',
  styleUrls: ['./s77010.page.scss'],
})
export class S77010Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark77010"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark77010"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark77010",JSON.stringify(this.bookmark))
  }
