...
@Component({
  selector: 'app-s59169',
  templateUrl: './s59169.page.html',
  styleUrls: ['./s59169.page.scss'],
})
export class S59169Page implements OnInit {
  ...
  reflection:any
  reflectionA:any
  r59169=JSON.parse(sessionStorage.getItem("r59169"))
  ...
  submitProgress(){
   ...
   console.log(this.r59169)
      ...
      this.service.submitProgressReflection({
        ...
        error=>{
          console.log(error)
          this.router.navigate(['/leadership/s59170'])
        },
        ()=>{
          this.router.navigate(['/leadership/s59170'])
        })
