...
@Component({
  selector: 'app-s59166',
  templateUrl: './s59166.page.html',
  styleUrls: ['./s59166.page.scss'],
})
export class S59166Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(59166,59166,59166)";
    ...
    this.q1=this.findQuestion(207).Question
    this.optionList1=this.findQuestion(207).optionList
    this.q2=this.findQuestion(208).Question
    this.optionList2=this.findQuestion(208).optionList
   
    this.q4=this.findQuestion(212).Question
    this.optionList4=this.findQuestion(212).optionList
    this.q5=this.findQuestion(213).Question
    this.optionList5=this.findQuestion(213).optionList
    this.q6=this.findQuestion(211).Question
    this.optionList6=this.findQuestion(211).optionList
  ...
  prev(){
    this.router.navigate(['/adults/leadership/s59165'])
