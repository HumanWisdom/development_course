...
@Component({
  selector: 'app-s56049',
  templateUrl: './s56049.page.html',
  styleUrls: ['./s56049.page.scss'],
})
export class S56049Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(56049,56049,56049)";
    ...
    this.q1=this.findQuestion(186).Question
    this.optionList1=this.findQuestion(186).optionList
    this.q2=this.findQuestion(187).Question
    this.optionList2=this.findQuestion(187).optionList
   
    this.q4=this.findQuestion(188).Question
    this.optionList4=this.findQuestion(188).optionList
    this.q5=this.findQuestion(189).Question
    this.optionList5=this.findQuestion(189).optionList
    this.q6=this.findQuestion(190).Question
    this.optionList6=this.findQuestion(190).optionList
  ...
  submitProgress(){
   ...
   this.router.navigate(['/adults/inner-boredom/s56050'])
  ...
  prev(){
    this.router.navigate(['/adults/inner-boredom/s56048'])
