...
export class S56031Page implements OnInit {
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark56031")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s5603134'])
      })
      this.router.navigate(['/inner-boredom/s56032'])
    

  }
  prev(){
    this.router.navigate(['/inner-boredom/s56030'])
