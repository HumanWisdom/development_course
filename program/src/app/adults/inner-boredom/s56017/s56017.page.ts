...
@Component({
  selector: 'app-s56017',
  templateUrl: './s56017.page.html',
  styleUrls: ['./s56017.page.scss'],
})
export class S56017Page implements OnInit {
  ...
  transcriptPage="inner-boredom/s56017t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime56017",this.totalTime)
    localStorage.setItem("avDuration56017",this.avDuration)
