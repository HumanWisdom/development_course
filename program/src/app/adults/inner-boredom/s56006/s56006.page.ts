...
@Component({
  selector: 'app-s56006',
  templateUrl: './s56006.page.html',
  styleUrls: ['./s56006.page.scss'],
})
export class S56006Page implements OnInit {
  ...
  transcriptPage="inner-boredom/s56006t"
  ...
  prev(){
    this.router.navigate(['/adults/inner-boredom/s56005'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime56006",this.totalTime)
    localStorage.setItem("avDuration56006",this.avDuration)
  }
}
