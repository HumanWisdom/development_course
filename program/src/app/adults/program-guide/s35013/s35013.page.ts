...
@Component({
  selector: 'app-s35013',
  templateUrl: './s35013.page.html',
  styleUrls: ['./s35013.page.scss'],
})
export class S35013Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(35013,35013,35013)";
  ...
  prev(){
    this.router.navigate(['/program-guide/s35012'])
