...
@Component({
  selector: 'app-s23025',
  templateUrl: './s23025.page.html',
  styleUrls: ['./s23025.page.scss'],
})
export class S23025Page implements OnInit,OnDestroy {
  ...
  transcriptPage="happiness/s23025t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/happiness/s23026'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime23025",this.totalTime)
    localStorage.setItem("avDuration23025",this.avDuration)
