...
@Component({
  selector: 'app-s23131',
  templateUrl: './s23131.page.html',
  styleUrls: ['./s23131.page.scss'],
})
export class S23131Page implements OnInit,OnDestroy {
...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark3")))
