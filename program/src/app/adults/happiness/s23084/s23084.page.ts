...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark23084")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.router.navigate(['/happiness/s23085'])
  ...
  prev(){
    this.router.navigate(['/happiness/s23083'])
