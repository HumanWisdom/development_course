...
@Component({
  selector: 'app-s23102',
  templateUrl: './s23102.page.html',
  styleUrls: ['./s23102.page.scss'],
})
export class S23102Page implements OnInit {
  ...
  transcriptPage="happiness/s23102t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime23102",this.totalTime)
    localStorage.setItem("avDuration23102",this.avDuration)
  }
}