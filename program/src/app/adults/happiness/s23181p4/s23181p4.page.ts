...
@Component({
  selector: 'app-s23181p4',
  templateUrl: './s23181p4.page.html',
  styleUrls: ['./s23181p4.page.scss'],
})
export class S23181p4Page implements OnInit {
  ...
  submitProgress(){
   ...
   console.log(this.r23181p4)
      ...
      this.service.submitProgressReflection({
        ...
        error=>{
          console.log(error)
          this.router.navigate(['/happiness/s23182'])
        },
        ()=>{
          this.router.navigate(['/happiness/s23182'])
        })
