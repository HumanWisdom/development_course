...
@Component({
  selector: 'app-s23129',
  templateUrl: './s23129.page.html',
  styleUrls: ['./s23129.page.scss'],
})
export class S23129Page implements OnInit {
  ...
  transcriptPage="happiness/s23129t"
  ...
  submitProgress(){
    ...
    this.service.submitProgressAv({
      ...
      this.router.navigate(['/happiness/s23130'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime23129",this.totalTime)
    localStorage.setItem("avDuration23129",this.avDuration)
  }
}