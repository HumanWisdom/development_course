...
@Component({
  selector: 'app-s23181p1',
  templateUrl: './s23181p1.page.html',
  styleUrls: ['./s23181p1.page.scss'],
})
export class S23181p1Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(23181p1,23181p1,23181p1)";
    ...
    this.q1=this.findQuestion(98).Question
    this.optionList1=this.findQuestion(98).optionList
    this.q2=this.findQuestion(99).Question
    this.optionList2=this.findQuestion(99).optionList
   
    this.q4=this.findQuestion(100).Question
    this.optionList4=this.findQuestion(100).optionList
    this.q5=this.findQuestion(101).Question
    this.optionList5=this.findQuestion(101).optionList
    this.q6=this.findQuestion(102).Question
    this.optionList6=this.findQuestion(102).optionList
