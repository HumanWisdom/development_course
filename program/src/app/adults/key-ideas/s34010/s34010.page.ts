...
@Component({
  selector: 'app-s34010-audio',
  templateUrl: './s34010.page.html',
  styleUrls: ['./s34010.page.scss'],
})
export class S34010Page implements OnInit,OnDestroy {

  bg="purple_blue_w1"
  title="Our minds function in similar ways"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/key_ideas/audios/key-ideas+1.2.mp3'

  transcriptPage="key-ideas/s34010t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime34010",this.totalTime)
    localStorage.setItem("avDuration34010",this.avDuration)
