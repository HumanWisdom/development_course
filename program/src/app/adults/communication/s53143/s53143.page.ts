...
@Component({
  selector: 'app-s53143',
  templateUrl: './s53143.page.html',
  styleUrls: ['./s53143.page.scss'],
})
export class S53143Page implements OnInit {
  ...
  transcriptPage="communication/s53143t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime53143",this.totalTime)
    localStorage.setItem("avDuration53143",this.avDuration)
