...
@Component({
  selector: 'app-s53080',
  templateUrl: './s53080.page.html',
  styleUrls: ['./s53080.page.scss'],
})
export class S53080Page implements OnInit {
  ...
  transcriptPage="communication/s53080t"
  ...
  prev(){
    this.router.navigate(['/communication/s53079'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime53080",this.totalTime)
    localStorage.setItem("avDuration53080",this.avDuration)
