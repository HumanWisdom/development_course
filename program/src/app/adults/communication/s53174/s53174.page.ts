...
@Component({
  selector: 'app-s53174',
  templateUrl: './s53174.page.html',
  styleUrls: ['./s53174.page.scss'],
})
export class S53174Page implements OnInit {
  ...
  transcriptPage="communication/s53174t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime53174",this.totalTime)
    localStorage.setItem("avDuration53174",this.avDuration)
