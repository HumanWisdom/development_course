...
@Component({
  selector: 'app-s53199',
  templateUrl: './s53199.page.html',
  styleUrls: ['./s53199.page.scss'],
})
export class S53199Page implements OnInit {
  ...
  transcriptPage="communication/s53199t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime53199",this.totalTime)
    localStorage.setItem("avDuration53199",this.avDuration)
