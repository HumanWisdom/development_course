...
@Component({
  selector: 'app-s53251',
  templateUrl: './s53251.page.html',
  styleUrls: ['./s53251.page.scss'],
})
export class S53251Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(53251,53251,53251)";
    ...
    this.q1=this.findQuestion(164).Question
    this.optionList1=this.findQuestion(164).optionList
    this.q2=this.findQuestion(165).Question
    this.optionList2=this.findQuestion(165).optionList
   
    this.q4=this.findQuestion(166).Question
    this.optionList4=this.findQuestion(166).optionList
    this.q5=this.findQuestion(167).Question
    this.optionList5=this.findQuestion(167).optionList
    this.q6=this.findQuestion(168).Question
    this.optionList6=this.findQuestion(168).optionList
