...
@Component({
  selector: 'app-s46069-audio',
  templateUrl: './s46069.page.html',
  styleUrls: ['./s46069.page.scss'],
})
export class S46069Page implements OnInit,OnDestroy {
  ...
  transcriptPage="food-health/s46069t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime46069",this.totalTime)
    localStorage.setItem("avDuration46069",this.avDuration)
