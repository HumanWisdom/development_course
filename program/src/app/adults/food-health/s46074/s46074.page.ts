...
@Component({
  selector: 'app-s46074',
  templateUrl: './s46074.page.html',
  styleUrls: ['./s46074.page.scss'],
})
export class S46074Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(46074,46074,46074)";
    ...
    this.q1 = this.findQuestion(268).Question
    this.optionList1 = this.findQuestion(268).optionList
    this.q2 = this.findQuestion(269).Question
    this.optionList2 = this.findQuestion(269).optionList
    this.q3 = this.findQuestion(270).Question
    this.optionList3 = this.findQuestion(270).optionList
    this.q4 = this.findQuestion(271).Question
    this.optionList4 = this.findQuestion(271).optionList
    this.q5 = this.findQuestion(272).Question
    this.optionList5 = this.findQuestion(272).optionList
