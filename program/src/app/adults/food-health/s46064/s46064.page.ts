...
@Component({
  selector: 'app-s46064-audio',
  templateUrl: './s46064.page.html',
  styleUrls: ['./s46064.page.scss'],
})
export class S46064Page implements OnInit,OnDestroy {
  ...
  transcriptPage="food-health/s46064t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime46064",this.totalTime)
    localStorage.setItem("avDuration46064",this.avDuration)
