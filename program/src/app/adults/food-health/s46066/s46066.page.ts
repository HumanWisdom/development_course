...
@Component({
  selector: 'app-s46066-audio',
  templateUrl: './s46066.page.html',
  styleUrls: ['./s46066.page.scss'],
})
export class S46066Page implements OnInit,OnDestroy {
  ...
  transcriptPage="food-health/s46066t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/adults/food-health/s46067'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime46066",this.totalTime)
    localStorage.setItem("avDuration46066",this.avDuration)
