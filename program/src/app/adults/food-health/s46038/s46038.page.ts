...
@Component({
  selector: 'app-s46038-audio',
  templateUrl: './s46038.page.html',
  styleUrls: ['./s46038.page.scss'],
})
export class S46038Page implements OnInit,OnDestroy {
  ...
  transcriptPage="food-health/s46038t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime46038",this.totalTime)
    localStorage.setItem("avDuration46038",this.avDuration)
