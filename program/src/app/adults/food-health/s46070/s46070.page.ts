...
@Component({
  selector: 'app-s46070-audio',
  templateUrl: './s46070.page.html',
  styleUrls: ['./s46070.page.scss'],
})
export class S46070Page implements OnInit,OnDestroy {
  ...
  transcriptPage="food-health/s46070t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/food-health/s46071'])
  ...
  prev(){
    this.router.navigate(['/food-health/s46069'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime46070",this.totalTime)
    localStorage.setItem("avDuration46070",this.avDuration)
