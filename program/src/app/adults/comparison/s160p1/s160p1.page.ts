...
@Component({
  selector: 'app-s160p1',
  templateUrl: './s160p1.page.html',
  styleUrls: ['./s160p1.page.scss'],
})
export class S160p1Page implements OnInit {
  ...
  submitProgress(){
    ...
    sessionStorage.setItem("r160p1",this.r160p1)
    this.r160p1=sessionStorage.getItem("r160p1")
   console.log(this.r160p1)
   if(this.r160p1!="undefined")
   {
