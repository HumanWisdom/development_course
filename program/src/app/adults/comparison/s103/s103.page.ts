...
@Component({
  selector: 'app-s103-audio',
  templateUrl: './s103.page.html',
  styleUrls: ['./s103.page.scss'],
})
export class S103Page implements OnInit,OnDestroy {
  ...
  transcriptPage="comparison/s103t"
  toc="comparison/s0"
  bookmark=0
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime103",this.totalTime)
    localStorage.setItem("avDuration103",this.avDuration)
