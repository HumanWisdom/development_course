...
@Component({
  selector: 'app-s115-audio',
  templateUrl: './s115.page.html',
  styleUrls: ['./s115.page.scss'],
})
export class S115Page implements OnInit,OnDestroy {
  ...
  totalTime:any
  bookmark=0
  transcriptPage="/comparison/s115t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime115",this.totalTime)
    localStorage.setItem("avDuration115",this.avDuration)
