...
@Component({
  ...
  styleUrls: ['./s6.page.scss'],
})
export class S6Page implements OnInit,OnDestroy {
...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark6")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      this.router.navigate(['/comparison/s7'])
