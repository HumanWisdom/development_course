...
@Component({
  selector: 'app-s22031',
  templateUrl: './s22031.page.html',
  styleUrls: ['./s22031.page.scss'],
})
export class S22031Page implements OnInit {
  ...
  transcriptPage="meditation/s22031t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime22031",this.totalTime)
    localStorage.setItem("avDuration22031",this.avDuration)
  }
}
