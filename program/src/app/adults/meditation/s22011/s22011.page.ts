...
@Component({
  selector: 'app-s22011-audio',
  templateUrl: './s22011.page.html',
  styleUrls: ['./s22011.page.scss'],
})
export class S22011Page implements OnInit,OnDestroy {
  ...
  transcriptPage="meditation/s22011t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/meditation/s22012'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime22011",this.totalTime)
    localStorage.setItem("avDuration22011",this.avDuration)
