...
@Component({
  selector: 'app-s45058-audio',
  templateUrl: './s45058.page.html',
  styleUrls: ['./s45058.page.scss'],
})
export class S45058Page implements OnInit,OnDestroy {
 ...
 mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  ...
  transcriptPage="habit-addiction/s45058t"
  ...
  prev(){
    this.router.navigate(['/habit-addiction/s45057'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime45058",this.totalTime)
    localStorage.setItem("avDuration45058",this.avDuration)
