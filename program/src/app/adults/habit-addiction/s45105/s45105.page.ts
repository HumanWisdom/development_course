...
@Component({
  selector: 'app-s45105-audio',
  templateUrl: './s45105.page.html',
  styleUrls: ['./s45105.page.scss'],
})
export class S45105Page implements OnInit,OnDestroy {
 ...
 mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  ...
  transcriptPage="habit-addiction/s45105t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime45105",this.totalTime)
    localStorage.setItem("avDuration45105",this.avDuration)
