...
@Component({
  selector: 'app-s45107-audio',
  templateUrl: './s45107.page.html',
  styleUrls: ['./s45107.page.scss'],
})
export class S45107Page implements OnInit,OnDestroy {
 ...
 mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  ...
  transcriptPage="habit-addiction/s45107t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime45107",this.totalTime)
    localStorage.setItem("avDuration45107",this.avDuration)
