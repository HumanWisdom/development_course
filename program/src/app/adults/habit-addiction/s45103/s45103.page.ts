...
@Component({
  selector: 'app-s45103-audio',
  templateUrl: './s45103.page.html',
  styleUrls: ['./s45103.page.scss'],
})
export class S45103Page implements OnInit,OnDestroy {
 ...
 mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  ...
  transcriptPage="habit-addiction/s45103t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/adults/habit-addiction/s45104'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime45103",this.totalTime)
    localStorage.setItem("avDuration45103",this.avDuration)
