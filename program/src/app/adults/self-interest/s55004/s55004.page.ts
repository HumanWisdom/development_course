...
@Component({
  selector: 'app-s55004',
  templateUrl: './s55004.page.html',
  styleUrls: ['./s55004.page.scss'],
})
export class S55004Page implements OnInit,OnDestroy {

  bg="purple_red_w2"
  title="Introduction"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/self-interest/audios/self-interest+1.1.mp3'
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime55004",this.totalTime)
    localStorage.setItem("avDuration55004",this.avDuration)
