...
@Component({
  selector: 'app-s55054',
  templateUrl: './s55054.page.html',
  styleUrls: ['./s55054.page.scss'],
})
export class S55054Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(55054,55054,55054)";
    ...
    this.q1=this.findQuestion(174).Question
    this.optionList1=this.findQuestion(174).optionList
    this.q2=this.findQuestion(175).Question
    this.optionList2=this.findQuestion(175).optionList
   
    this.q4=this.findQuestion(176).Question
    this.optionList4=this.findQuestion(176).optionList
    this.q5=this.findQuestion(177).Question
    this.optionList5=this.findQuestion(177).optionList
    this.q6=this.findQuestion(178).Question
    this.optionList6=this.findQuestion(178).optionList
  ...
  submitProgress(){
   ...
   this.router.navigate(['/adults/self-interest/s55055'])
  ...
  prev(){
    this.router.navigate(['/adults/self-interest/s55053'])
