...
@Component({
  selector: 'app-s615p1',
  templateUrl: './s615p1.page.html',
  styleUrls: ['./s615p1.page.scss'],
})
export class S615p1Page implements OnInit {
  ...
  ngOnInit() {
    ...
    this.q1=this.findQuestion(111).Question
    this.optionList1=this.findQuestion(111).optionList
    this.q2=this.findQuestion(112).Question
    this.optionList2=this.findQuestion(112).optionList
   
    this.q4=this.findQuestion(113).Question
    this.optionList4=this.findQuestion(113).optionList
    this.q5=this.findQuestion(114).Question
    this.optionList5=this.findQuestion(114).optionList
    this.q6=this.findQuestion(115).Question
    this.optionList6=this.findQuestion(115).optionList
