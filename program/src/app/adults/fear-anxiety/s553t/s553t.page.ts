...
@Component({
  selector: 'app-s553t',
  templateUrl: './s553t.page.html',
  styleUrls: ['./s553t.page.scss'],
})
export class S553tPage implements OnInit {

  bg="purple_red_w1" 
  
  bookmark=0
  path=this.router.url
  audioPage="/fear-anxiety/s553"
  ...
  avDuration=localStorage.getItem("avDuration553")
  totalTime=localStorage.getItem("totalTime553")
