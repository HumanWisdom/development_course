...
@Component({
  selector: 'app-s571',
  templateUrl: './s571.page.html',
  styleUrls: ['./s571.page.scss'],
})
export class S571Page implements OnInit {
  ...
  transcriptPage="/fear-anxiety/s571t"
  bookmark=0
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime571",this.totalTime)
    localStorage.setItem("avDuration571",this.avDuration)
