...
@Component({
  selector: 'app-s609',
  templateUrl: './s609.page.html',
  styleUrls: ['./s609.page.scss'],
})
export class S609Page implements OnInit {
  ...
  transcriptPage="/fear-anxiety/s609t"
  ...
  prev(){
    this.router.navigate(['/fear-anxiety/s608'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime609",this.totalTime)
    localStorage.setItem("avDuration609",this.avDuration)
  }
}
