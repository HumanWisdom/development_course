...
@Component({
  selector: 'app-s575',
  templateUrl: './s575.page.html',
  styleUrls: ['./s575.page.scss'],
})
export class S575Page implements OnInit {

  bg="purple_red_w2"
  mediaVideo=JSON.parse(localStorage.getItem("mediaVideo"))
  videoLink=this.mediaVideo+'/fear_anxiety/videos/4.3.mp4'
...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark575")))
 ...
 receiveAvDuration(e){
  ...
  submitProgress(){
    ...
    this.service.submitProgressAv({
      ...
      ()=>{
        this.router.navigate(['/fear-anxiety/s576'])
      })
    

  }
  prev(){
    this.router.navigate(['/fear-anxiety/s574'])
  }
