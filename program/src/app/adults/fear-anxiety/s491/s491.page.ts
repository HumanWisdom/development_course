...
@Component({
  selector: 'app-s491',
  templateUrl: './s491.page.html',
  styleUrls: ['./s491.page.scss'],
})
export class S491Page implements OnInit {
  ...
  transcriptPage="/fear-anxiety/s491t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime491",this.totalTime)
    localStorage.setItem("avDuration491",this.avDuration)
  }
}
