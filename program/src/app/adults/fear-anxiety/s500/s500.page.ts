...
@Component({
  selector: 'app-s500',
  templateUrl: './s500.page.html',
  styleUrls: ['./s500.page.scss'],
})
export class S500Page implements OnInit {
  ...
  transcriptPage="/fear-anxiety/s500t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime500",this.totalTime)
    localStorage.setItem("avDuration500",this.avDuration)
  }
}
