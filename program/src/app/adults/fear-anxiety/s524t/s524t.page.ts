...
@Component({
  selector: 'app-s524t',
  templateUrl: './s524t.page.html',
  styleUrls: ['./s524t.page.scss'],
})
export class S524tPage implements OnInit {

  bg="purple_red_w1" 
  
  bookmark=0
  path=this.router.url
  audioPage="/fear-anxiety/s524"
  ...
  avDuration=localStorage.getItem("avDuration524")
  totalTime=localStorage.getItem("totalTime524")
