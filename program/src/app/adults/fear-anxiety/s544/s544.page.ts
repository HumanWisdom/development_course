...
bg_tn="bg_purple_red"
  ...
  reflection:any
  reflectionA:any
  r544=JSON.parse(sessionStorage.getItem("r544"))
  ...
  submitProgress(e){
    ...
    sessionStorage.setItem("r544",JSON.stringify(e))
   this.r544=sessionStorage.getItem("r544")
   console.log(this.r544)
