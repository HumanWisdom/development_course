...
@Component({
  selector: 'app-s483p1',
  templateUrl: './s483p1.page.html',
  styleUrls: ['./s483p1.page.scss'],
})
export class S483p1Page implements OnInit {
  ...
  constructor(private router: Router,
    ...
    ngOnInit() {
      ...
      this.q1=this.findQuestion(191).Question
      this.optionList1=this.findQuestion(191).optionList
      this.q2=this.findQuestion(192).Question
      this.optionList2=this.findQuestion(192).optionList
      this.q3=this.findQuestion(193).Question
      this.optionList3=this.findQuestion(193).optionList
     
      this.q4=this.findQuestion(194).Question
      this.optionList4=this.findQuestion(194).optionList
      this.q5=this.findQuestion(195).Question
      this.optionList5=this.findQuestion(195).optionList
