...
@Component({
  selector: 'app-s477',
  templateUrl: './s477.page.html',
  styleUrls: ['./s477.page.scss'],
})
export class S477Page implements OnInit {
  ...
  reflection:any
  reflectionA:any
  r477=JSON.parse(sessionStorage.getItem("r477"))
  ...
  submitProgress(e){
   ...
   sessionStorage.setItem("r477",JSON.stringify(e))
   this.r477=JSON.parse(sessionStorage.getItem("r477"))
    ...
    this.service.submitProgressReflection({
      ...
      "Resp":JSON.parse(sessionStorage.getItem("r477"))
    }).subscribe(res=>
      {
