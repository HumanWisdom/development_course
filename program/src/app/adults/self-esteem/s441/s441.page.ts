...
@Component({
  selector: 'app-s441',
  templateUrl: './s441.page.html',
  styleUrls: ['./s441.page.scss'],
})
export class S441Page implements OnInit {
  ...
  transcriptPage="self-esteem/s441t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/self-esteem/s442'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime441",this.totalTime)
    localStorage.setItem("avDuration441",this.avDuration)
