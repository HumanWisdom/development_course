...
@Component({
  selector: 'app-s433',
  templateUrl: './s433.page.html',
  styleUrls: ['./s433.page.scss'],
})
export class S433Page implements OnInit,OnDestroy {
  userId:any
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/self_esteem.jpg"
  tocColor="white"
  lastvisited = false;
  stories: any = []
