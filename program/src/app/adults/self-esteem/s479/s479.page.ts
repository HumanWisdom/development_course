...
@Component({
  selector: 'app-s479',
  templateUrl: './s479.page.html',
  styleUrls: ['./s479.page.scss'],
})
export class S479Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r479 = JSON.parse(sessionStorage.getItem("r479"))
  ...
  submitProgress(e) {
    ...
    sessionStorage.setItem("r479", JSON.stringify(e))
    this.r479 = JSON.parse(sessionStorage.getItem("r479"))
    ...
    this.service.submitProgressReflection({
      ...
      "Resp": JSON.parse(sessionStorage.getItem("r479"))
    }).subscribe(res => {
