...
export class S32013Page implements OnInit,OnDestroy {
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark32013")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.router.navigate(['/benefits-of-wisdom/s32014'])
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s3201334'])
      })
  ...
  goNext(){
   // this.router.navigate(['/discovering-wisdom/s32013'])
