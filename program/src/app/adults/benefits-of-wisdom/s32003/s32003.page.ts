...
export class S32003Page implements OnInit,OnDestroy {
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark32003")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s3200334'])
      })
  ...
  prev(){
    this.router.navigate(['/benefits-of-wisdom/s32002'])

  }
  

  goNext(){
   // this.router.navigate(['/discovering-wisdom/s32003'])
