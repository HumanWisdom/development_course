...
@Component({
  selector: 'app-s32006',
  templateUrl: './s32006.page.html',
  styleUrls: ['./s32006.page.scss'],
})
export class S32006Page implements OnInit {
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark32006",JSON.stringify(this.bookmark))
  }
createScreen(){
