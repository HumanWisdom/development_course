...
@Component({
  selector: 'app-s32012-audio',
  templateUrl: './s32012.page.html',
  styleUrls: ['./s32012.page.scss'],
})
export class S32012Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/benefits_of_wisdom/audios/benefits-of-wisdom+1.2.mp3'

  transcriptPage="benefits-of-wisdom/s32012t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime32012",this.totalTime)
    localStorage.setItem("avDuration32012",this.avDuration)
