...
@Component({
  selector: 'app-s37007-audio',
  templateUrl: './s37007.page.html',
  styleUrls: ['./s37007.page.scss'],
})
export class S37007Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+3.3.mp3'

  transcriptPage="three-steps-enquiry/s37007t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime37007",this.totalTime)
    localStorage.setItem("avDuration37007",this.avDuration)
