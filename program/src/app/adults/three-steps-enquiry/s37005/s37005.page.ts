...
@Component({
  selector: 'app-s37005-audio',
  templateUrl: './s37005.page.html',
  styleUrls: ['./s37005.page.scss'],
})
export class S37005Page implements OnInit,OnDestroy {

  bg="pink_orange_w4"
  title="Step #2 - Accept the fact without judgement."
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+3.2.mp3'

  transcriptPage="three-steps-enquiry/s37005t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime37005",this.totalTime)
    localStorage.setItem("avDuration37005",this.avDuration)
