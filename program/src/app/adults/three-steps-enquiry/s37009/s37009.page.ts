...
@Component({
  selector: 'app-s37009-audio',
  templateUrl: './s37009.page.html',
  styleUrls: ['./s37009.page.scss'],
})
export class S37009Page implements OnInit,OnDestroy {

  bg="pink_orange_w8"
  title="A friend forgets your birthday"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+3.4.mp3'

  transcriptPage="three-steps-enquiry/s37009t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime37009",this.totalTime)
    localStorage.setItem("avDuration37009",this.avDuration)
