...
@Component({
  selector: 'app-s37003-audio',
  templateUrl: './s37003.page.html',
  styleUrls: ['./s37003.page.scss'],
})
export class S37003Page implements OnInit,OnDestroy {

  bg="pink_orange_w2"
  title="Step #1 - Notice what you are thinking or feeling"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/art_of_enquiry/audios/enquiry+3.1.mp3'
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime37003",this.totalTime)
    localStorage.setItem("avDuration37003",this.avDuration)
