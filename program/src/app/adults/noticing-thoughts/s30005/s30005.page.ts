...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark30005")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s2330005'])
      })
      this.router.navigate(['/noticing-thoughts/s30006'])
    

  }
  prev(){
    this.router.navigate(['/noticing-thoughts/s30004'])
