...
@Component({
  selector: 'app-s73105',
  templateUrl: './s73105.page.html',
  styleUrls: ['./s73105.page.scss'],
})
export class S73105Page implements OnInit {
  ...
  reflection:any
  reflectionA:any
  r73105=JSON.parse(sessionStorage.getItem("r73105"))
  ...
  submitProgress(){
   ...
   console.log(this.r73105)
      ...
      this.service.submitProgressReflection({
        ...
        error=>{
          console.log(error)
          this.router.navigate(['/money/s73106'])
        },
        ()=>{
          this.router.navigate(['/money/s73106'])
        })
