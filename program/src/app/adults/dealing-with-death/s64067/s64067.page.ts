...
@Component({
  selector: 'app-s64067',
  templateUrl: './s64067.page.html',
  styleUrls: ['./s64067.page.scss'],
})
export class S64067Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(64067,64067,64067)";
    ...
    this.q1=this.findQuestion(248).Question
    this.optionList1=this.findQuestion(248).optionList
    this.q2=this.findQuestion(249).Question
    this.optionList2=this.findQuestion(249).optionList   
    this.q3=this.findQuestion(250).Question
    this.optionList3=this.findQuestion(250).optionList
    this.q4=this.findQuestion(251).Question
    this.optionList4=this.findQuestion(251).optionList
    this.q5=this.findQuestion(252).Question
    this.optionList5=this.findQuestion(252).optionList
  ...
  submitProgress(){
   ...
   this.router.navigate(['/adults/dealing-with-death/s64068'])
