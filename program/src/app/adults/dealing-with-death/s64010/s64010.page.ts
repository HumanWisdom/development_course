...
@Component({
  selector: 'app-s64010-audio',
  templateUrl: './s64010.page.html',
  styleUrls: ['./s64010.page.scss'],
})
export class S64010Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-death/s64010t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime64010",this.totalTime)
    localStorage.setItem("avDuration64010",this.avDuration)
