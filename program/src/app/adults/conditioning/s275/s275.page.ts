...
@Component({
  selector: 'app-s275',
  templateUrl: './s275.page.html',
  styleUrls: ['./s275.page.scss'],
})
export class S275Page implements OnInit {
  ...
  transcriptPage="conditioning/s275t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime275",this.totalTime)
    localStorage.setItem("avDuration275",this.avDuration)
  }
}
