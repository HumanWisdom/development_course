...
@Component({
  selector: 'app-s269',
  templateUrl: './s269.page.html',
  styleUrls: ['./s269.page.scss'],
})
export class S269Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime269",this.totalTime)
    localStorage.setItem("avDuration269",this.avDuration)
  }
}
