...
@Component({
  selector: 'app-s249',
  templateUrl: './s249.page.html',
  styleUrls: ['./s249.page.scss'],
})
export class S249Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime249",this.totalTime)
    localStorage.setItem("avDuration249",this.avDuration)
  }
}
