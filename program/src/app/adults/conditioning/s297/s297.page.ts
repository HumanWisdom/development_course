...
@Component({
  selector: 'app-s297',
  templateUrl: './s297.page.html',
  styleUrls: ['./s297.page.scss'],
})
export class S297Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime297",this.totalTime)
    localStorage.setItem("avDuration297",this.avDuration)
  }
}
