...
@Component({
  selector: 'app-s298',
  templateUrl: './s298.page.html',
  styleUrls: ['./s298.page.scss'],
})
export class S298Page implements OnInit {
  ...
  transcriptPage="conditioning/s298t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime298",this.totalTime)
    localStorage.setItem("avDuration298",this.avDuration)
  }
}
