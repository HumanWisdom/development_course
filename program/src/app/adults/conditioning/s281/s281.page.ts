...
@Component({
  selector: 'app-s281',
  templateUrl: './s281.page.html',
  styleUrls: ['./s281.page.scss'],
})
export class S281Page implements OnInit {
  ...
  transcriptPage="conditioning/s281t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime281",this.totalTime)
    localStorage.setItem("avDuration281",this.avDuration)
  }
}
