...
@Component({
  selector: 'app-s47068',
  templateUrl: './s47068.page.html',
  styleUrls: ['./s47068.page.scss'],
})
export class S47068Page implements OnInit {
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark47068",JSON.stringify(this.bookmark))
  }
createScreen(){
