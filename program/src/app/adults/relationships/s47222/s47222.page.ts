...
@Component({
  selector: 'app-s47222',
  templateUrl: './s47222.page.html',
  styleUrls: ['./s47222.page.scss'],
})
export class S47222Page implements OnInit {
  ...
  transcriptPage="relationships/s47222t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime47222",this.totalTime)
    localStorage.setItem("avDuration47222",this.avDuration)
