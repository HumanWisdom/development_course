...
@Component({
  selector: 'app-s47267',
  templateUrl: './s47267.page.html',
  styleUrls: ['./s47267.page.scss'],
})
export class S47267Page implements OnInit {
  ...
  transcriptPage="relationships/s47267t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime47267",this.totalTime)
    localStorage.setItem("avDuration47267",this.avDuration)
