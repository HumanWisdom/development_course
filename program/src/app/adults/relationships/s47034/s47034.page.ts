...
@Component({
  selector: 'app-s47034',
  templateUrl: './s47034.page.html',
  styleUrls: ['./s47034.page.scss'],
})
export class S47034Page implements OnInit {
  ...
  transcriptPage="relationships/s47034t"
  ...
  prev(){
    this.router.navigate(['/relationships/s47033'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime47034",this.totalTime)
    localStorage.setItem("avDuration47034",this.avDuration)
