...
@Component({
  selector: 'app-s47002-audio',
  templateUrl: './s47002.page.html',
  styleUrls: ['./s47002.page.scss'],
})
export class S47002Page implements OnInit,OnDestroy {
  ...
  transcriptPage="relationships/s47002t"
  ...
  prev(){
    this.router.navigate(['/relationships/s47000'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime47002",this.totalTime)
    localStorage.setItem("avDuration47002",this.avDuration)
