 ...
 option:any
  ...
  ngOnInit() {
    ...
    {this.userId=JSON.parse(sessionStorage.getItem("userId"))}
      ...
      if(JSON.parse(sessionStorage.getItem("bookmark47006"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark47006"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark47006",JSON.stringify(this.bookmark))
  }
