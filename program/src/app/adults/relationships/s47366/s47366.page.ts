...
@Component({
  selector: 'app-s47366',
  templateUrl: './s47366.page.html',
  styleUrls: ['./s47366.page.scss'],
})
export class S47366Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(47366,47366,47366)";
    ...
    this.optionList1=this.findQuestion(154).optionList
    this.q2=this.findQuestion(155).Question
    this.optionList2=this.findQuestion(155).optionList
    this.q3=this.findQuestion(156).Question
    this.optionList3=this.findQuestion(156).optionList
    this.q4=this.findQuestion(157).Question
    this.optionList4=this.findQuestion(157).optionList
  ...
  submitProgress(){
   ...
   this.totalTime = this.endTime - this.startTime;
    ...
    this.service.submitProgressQuestion({"ModuleId":this.moduleId,
      ...
      this.router.navigate(['/adults/relationships/s47367'])


  }
  prev(){
    this.router.navigate(['/relationships/s47365'])
