...
@Component({
  selector: 'app-s63044',
  templateUrl: './s63044.page.html',
  styleUrls: ['./s63044.page.scss'],
})
export class S63044Page implements OnInit {
    ...
    transcriptPage="living-with-peace/s63044t"
    ...
    ngOnDestroy(){
      localStorage.setItem("totalTime63044",this.totalTime)
      localStorage.setItem("avDuration63044",this.avDuration)
