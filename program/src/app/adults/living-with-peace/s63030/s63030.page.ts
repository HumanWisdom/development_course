...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark63030")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.router.navigate(['/living-with-peace/s63031'])
  ...
  prev(){
    this.router.navigate(['/living-with-peace/s63029'])
