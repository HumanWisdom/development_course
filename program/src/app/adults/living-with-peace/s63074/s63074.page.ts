...
@Component({
  selector: 'app-s63074',
  templateUrl: './s63074.page.html',
  styleUrls: ['./s63074.page.scss'],
})
export class S63074Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(63074,63074,63074)";
    ...
    this.q1=this.findQuestion(223).Question
    this.optionList1=this.findQuestion(223).optionList
    this.q2=this.findQuestion(225).Question
    this.optionList2=this.findQuestion(225).optionList   
    this.q3=this.findQuestion(227).Question
    this.optionList3=this.findQuestion(227).optionList
    this.q4=this.findQuestion(228).Question
    this.optionList4=this.findQuestion(228).optionList
    this.q5=this.findQuestion(229).Question
    this.optionList5=this.findQuestion(229).optionList
