...
@Component({
  selector: 'app-s342',
  templateUrl: './s342.page.html',
  styleUrls: ['./s342.page.scss'],
})
export class S342Page implements OnInit {
 ...
 avDuration:any
 transcriptPage="/criticism/s342t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark342")))
