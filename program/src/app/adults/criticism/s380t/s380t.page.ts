...
@Component({
  selector: 'app-s380t',
  templateUrl: './s380t.page.html',
  styleUrls: ['./s380t.page.scss'],
})
export class S380tPage implements OnInit {

  bg="criticism_w1" 
  
  bookmark=0
  path=this.router.url
  audioPage="/criticism/s380"
  toc="/criticism/s324"
  ...
  avDuration=localStorage.getItem("avDuration380")
  totalTime=localStorage.getItem("totalTime380")
