...
@Component({
  selector: 'app-s410',
  templateUrl: './s410.page.html',
  styleUrls: ['./s410.page.scss'],
})
export class S410Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s410t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark410")))
