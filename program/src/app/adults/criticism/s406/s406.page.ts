...
@Component({
  selector: 'app-s406',
  templateUrl: './s406.page.html',
  styleUrls: ['./s406.page.scss'],
})
export class S406Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s406t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark406")))
