...
@Component({
  selector: 'app-s369',
  templateUrl: './s369.page.html',
  styleUrls: ['./s369.page.scss'],
})
export class S369Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s369t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark369")))
