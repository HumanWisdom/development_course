...
@Component({
  selector: 'app-s407',
  templateUrl: './s407.page.html',
  styleUrls: ['./s407.page.scss'],
})
export class S407Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s407t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark407")))
