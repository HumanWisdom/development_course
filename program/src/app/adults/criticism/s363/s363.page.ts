...
@Component({
  selector: 'app-s363',
  templateUrl: './s363.page.html',
  styleUrls: ['./s363.page.scss'],
})
export class S363Page implements OnInit {

  bg="criticism_w3" 
  title="Criticizing children"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/Criticism/audios/criticism+2.3.mp3'  
  ...
  avDuration:any
  transcriptPage="/criticism/s363t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark363")))
