...
@Component({
  selector: 'app-s388',
  templateUrl: './s388.page.html',
  styleUrls: ['./s388.page.scss'],
})
export class S388Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s388t"
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark388")))
...
createScreen(){
  ...
  prev(){
    this.router.navigate(['/adults/criticism/s387'])
