...
@Component({
  selector: 'app-s20058',
  templateUrl: './s20058.page.html',
  styleUrls: ['./s20058.page.scss'],
})
export class S20058Page implements OnInit {
  ...
  toc="pleasure/s20001"
  transcriptPage="pleasure/s20058t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime20058",this.totalTime)
    localStorage.setItem("avDuration20058",this.avDuration)
  }
}
