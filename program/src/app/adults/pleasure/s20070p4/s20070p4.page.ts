...
@Component({
  selector: 'app-s20070p4',
  templateUrl: './s20070p4.page.html',
  styleUrls: ['./s20070p4.page.scss'],
})
export class S20070p4Page implements OnInit {
  ...
  reflection:any
  reflectionA:any
  r20070p4=JSON.parse(sessionStorage.getItem("r20070p4"))
