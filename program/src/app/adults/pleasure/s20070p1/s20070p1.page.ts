...
@Component({
  selector: 'app-s20070p1',
  templateUrl: './s20070p1.page.html',
  styleUrls: ['./s20070p1.page.scss'],
})
export class S20070p1Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(20070p1,20070p1,20070p1)";
    ...
    this.q1=this.findQuestion(93).Question
    this.optionList1=this.findQuestion(93).optionList
    this.q2=this.findQuestion(94).Question
    this.optionList2=this.findQuestion(94).optionList
   
    this.q4=this.findQuestion(95).Question
    this.optionList4=this.findQuestion(95).optionList
    this.q5=this.findQuestion(96).Question
    this.optionList5=this.findQuestion(96).optionList
    this.q6=this.findQuestion(97).Question
    this.optionList6=this.findQuestion(97).optionList
  ...
  prev(){
    this.router.navigate(['/pleasure/s20070'])
