...
@Component({
  selector: 'app-s20013',
  templateUrl: './s20013.page.html',
  styleUrls: ['./s20013.page.scss'],
})
export class S20013Page implements OnInit {
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark20013",JSON.stringify(this.bookmark))
  }
createScreen(){
  ...
  submitProgress(){
    ...
    this.router.navigate(['/pleasure/s20014'])
