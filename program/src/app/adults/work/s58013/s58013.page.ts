...
@Component({
  selector: 'app-s58013-audio',
  templateUrl: './s58013.page.html',
  styleUrls: ['./s58013.page.scss'],
})
export class S58013Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/work/audios/work+1.3.mp3'

  transcriptPage="work/s58013t"
  toc="work/s58001"
  bookmark=0
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime58013",this.totalTime)
    localStorage.setItem("avDuration58013",this.avDuration)
