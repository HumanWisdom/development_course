...
export class S62147Page implements OnInit,OnDestroy {
 ...
 ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark62147")))
...
createScreen(){
  ...
  submitProgress(){
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s6214734'])
      })
      this.router.navigate(['/love/s62148'])
