...
@Component({
  selector: 'app-s62172-audio',
  templateUrl: './s62172.page.html',
  styleUrls: ['./s62172.page.scss'],
})
export class S62172Page implements OnInit,OnDestroy {
  ...
  submitProgress(){
    ...
    this.router.navigate(['/love/s62173'])
   
 
  }
  prev(){
    this.router.navigate(['/love/s62171'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime62172",this.totalTime)
    localStorage.setItem("avDuration62172",this.avDuration)
