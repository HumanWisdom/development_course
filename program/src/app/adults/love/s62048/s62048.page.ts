...
ngOnInit() {
    ...
    this.startTime = Date.now();
    console.log("session bookmark",JSON.parse(sessionStorage.getItem("bookmark62048")))
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s26204862048'])
      })
  ...
  prev(){
    this.router.navigate(['/love/s62047'])
