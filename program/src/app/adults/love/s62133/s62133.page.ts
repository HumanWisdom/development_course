...
@Component({
  selector: 'app-s62133-audio',
  templateUrl: './s62133.page.html',
  styleUrls: ['./s62133.page.scss'],
})
export class S62133Page implements OnInit,OnDestroy {
  ...
  submitProgress(){
    ...
    this.router.navigate(['/love/s62134'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime62133",this.totalTime)
    localStorage.setItem("avDuration62133",this.avDuration)
