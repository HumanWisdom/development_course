...
@Component({
  selector: 'app-s62170-audio',
  templateUrl: './s62170.page.html',
  styleUrls: ['./s62170.page.scss'],
})
export class S62170Page implements OnInit,OnDestroy {
  ...
  prev(){
    this.router.navigate(['/love/s62169'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime62170",this.totalTime)
    localStorage.setItem("avDuration62170",this.avDuration)
