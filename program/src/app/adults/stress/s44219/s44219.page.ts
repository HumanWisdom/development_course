...
@Component({
  selector: 'app-s44219-audio',
  templateUrl: './s44219.page.html',
  styleUrls: ['./s44219.page.scss'],
})
export class S44219Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime44219",this.totalTime)
    localStorage.setItem("avDuration44219",this.avDuration)
