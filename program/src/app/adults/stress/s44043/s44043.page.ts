...
@Component({
  selector: 'app-s44043-audio',
  templateUrl: './s44043.page.html',
  styleUrls: ['./s44043.page.scss'],
})
export class S44043Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime44043",this.totalTime)
    localStorage.setItem("avDuration44043",this.avDuration)
