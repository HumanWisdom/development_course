...
@Component({
  selector: 'app-s44138-audio',
  templateUrl: './s44138.page.html',
  styleUrls: ['./s44138.page.scss'],
})
export class S44138Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime44138",this.totalTime)
    localStorage.setItem("avDuration44138",this.avDuration)
