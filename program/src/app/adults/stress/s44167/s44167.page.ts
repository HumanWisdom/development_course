...
@Component({
  selector: 'app-s44167-audio',
  templateUrl: './s44167.page.html',
  styleUrls: ['./s44167.page.scss'],
})
export class S44167Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime44167",this.totalTime)
    localStorage.setItem("avDuration44167",this.avDuration)
