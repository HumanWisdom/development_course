...
@Component({
  selector: 'app-s44007-audio',
  templateUrl: './s44007.page.html',
  styleUrls: ['./s44007.page.scss'],
})
export class S44007Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime44007",this.totalTime)
    localStorage.setItem("avDuration44007",this.avDuration)
