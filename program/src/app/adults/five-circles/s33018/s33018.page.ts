...
@Component({
  selector: 'app-s33018-audio',
  templateUrl: './s33018.page.html',
  styleUrls: ['./s33018.page.scss'],
})
export class S33018Page implements OnInit,OnDestroy {

  bg="purple_blue_w1"
  title="Get support now section"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/five_circles/audios/five-circles+1.7.mp3'
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime33018",this.totalTime)
    localStorage.setItem("avDuration33018",this.avDuration)
