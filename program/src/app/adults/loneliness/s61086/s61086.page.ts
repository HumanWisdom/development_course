...
@Component({
  selector: 'app-s61086-audio',
  templateUrl: './s61086.page.html',
  styleUrls: ['./s61086.page.scss'],
})
export class S61086Page implements OnInit,OnDestroy {
  ...
  transcriptPage="loneliness/s61086t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime61086",this.totalTime)
    localStorage.setItem("avDuration61086",this.avDuration)
