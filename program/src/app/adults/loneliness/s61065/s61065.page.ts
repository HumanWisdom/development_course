...
@Component({
  selector: 'app-s61065-audio',
  templateUrl: './s61065.page.html',
  styleUrls: ['./s61065.page.scss'],
})
export class S61065Page implements OnInit,OnDestroy {
  ...
  transcriptPage="loneliness/s61065t"
  ...
  prev(){
    this.router.navigate(['/loneliness/s61064'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime61065",this.totalTime)
    localStorage.setItem("avDuration61065",this.avDuration)
