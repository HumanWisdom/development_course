...
@Component({
  selector: 'app-s61074',
  templateUrl: './s61074.page.html',
  styleUrls: ['./s61074.page.scss'],
})
export class S61074Page implements OnInit {
  ...
  transcriptPage="loneliness/s61074t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime61074",this.totalTime)
    localStorage.setItem("avDuration61074",this.avDuration)
  }
}
