...
@Component({
  selector: 'app-s61043',
  templateUrl: './s61043.page.html',
  styleUrls: ['./s61043.page.scss'],
})
export class S61043Page implements OnInit {
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark61043",JSON.stringify(this.bookmark))
  }
createScreen(){
