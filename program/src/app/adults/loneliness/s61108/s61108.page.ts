...
@Component({
  selector: 'app-s61108',
  templateUrl: './s61108.page.html',
  styleUrls: ['./s61108.page.scss'],
})
export class S61108Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $( document ).ready(function() {
      // var base_color = "rgb(61108,61108,61108)";
  ...
  submitProgress(){
   ...
   this.router.navigate(['/adults/loneliness/s61109'])
  ...
  prev(){
    this.router.navigate(['/adults/loneliness/s61107'])
