...
@Component({
  selector: 'app-s61027',
  templateUrl: './s61027.page.html',
  styleUrls: ['./s61027.page.scss'],
})
export class S61027Page implements OnInit {
  ...
  transcriptPage="loneliness/s61027t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime61027",this.totalTime)
    localStorage.setItem("avDuration61027",this.avDuration)
  }
}
