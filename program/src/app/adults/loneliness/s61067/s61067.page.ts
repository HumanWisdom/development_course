...
@Component({
  selector: 'app-s61067-audio',
  templateUrl: './s61067.page.html',
  styleUrls: ['./s61067.page.scss'],
})
export class S61067Page implements OnInit,OnDestroy {
  ...
  transcriptPage="loneliness/s61067t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime61067",this.totalTime)
    localStorage.setItem("avDuration61067",this.avDuration)
