...
export class BlogIndexPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.meta.addTags([
      { name: 'title', content: "Explore Your Inner World with Our Self-Discovery Blog" },
      { name: 'description', content:"Explore Your Inner World with Our Self-Discovery Blog" }
    ]);
  ...
  viewblog(item){
    ...
    this.router.navigate(['blog-article'], {queryParams: {sId: `${item['BlogID']}`}})
  }
