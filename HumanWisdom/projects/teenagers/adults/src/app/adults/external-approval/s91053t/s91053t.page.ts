...
@Component({
  selector: 'app-s91053t',
  templateUrl: './s91053t.page.html',
  styleUrls: ['./s91053t.page.scss'],
})
export class S91053tPage implements OnInit {
  ...
  audioPage="/external-approval/s91053"
  ...
  avDuration=localStorage.getItem("avDuration91053")
  totalTime=localStorage.getItem("totalTime91053")
