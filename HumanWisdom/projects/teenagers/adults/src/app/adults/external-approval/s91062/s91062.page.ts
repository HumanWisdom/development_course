...
@Component({
  selector: 'app-s91062',
  templateUrl: './s91062.page.html',
  styleUrls: ['./s91062.page.scss'],
})
export class S91062Page implements OnInit,OnDestroy {
  ...
  transcriptPage="external-approval/s91062t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91062",this.totalTime)
    localStorage.setItem("avDuration91062",this.avDuration)
  }
}