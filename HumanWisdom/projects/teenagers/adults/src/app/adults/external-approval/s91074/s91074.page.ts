...
@Component({
  selector: 'app-s91074',
  templateUrl: './s91074.page.html',
  styleUrls: ['./s91074.page.scss'],
})
export class S91074Page implements OnInit,OnDestroy {

  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w6"
  title="#5 Develop a regular breathing and meditation practice. Discover your own sense of peace"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/external-approval/audios/2.6.mp3'

  transcriptPage="external-approval/s91074t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91074",this.totalTime)
    localStorage.setItem("avDuration91074",this.avDuration)
  }
}