...
@Component({
  selector: 'app-s92124',
  templateUrl: './s92124.page.html',
  styleUrls: ['./s92124.page.scss'],
})
export class S92124Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/dealing-with-depression/audios/4.4.mp3'

  transcriptPage="dealing-with-depression/s92124t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92124",this.totalTime)
    localStorage.setItem("avDuration92124",this.avDuration)
  }
}