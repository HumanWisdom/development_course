...
@Component({
  selector: 'app-s92168',
  templateUrl: './s92168.page.html',
  styleUrls: ['./s92168.page.scss'],
})
export class S92168Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s92168t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92168",this.totalTime)
    localStorage.setItem("avDuration92168",this.avDuration)
  }
}