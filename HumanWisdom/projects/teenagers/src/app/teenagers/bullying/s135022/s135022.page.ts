...
@Component({
  selector: 'app-s135022',
  templateUrl: './s135022.page.html',
  styleUrls: ['./s135022.page.scss'],
})
export class S135022Page implements OnInit,OnDestroy 
{
  ...
  audioLink=this.mediaAudio+'/teenagers/modules/bullying/audios/1.6.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime135022",this.totalTime)
    localStorage.setItem("avDuration135022",this.avDuration)
  }
