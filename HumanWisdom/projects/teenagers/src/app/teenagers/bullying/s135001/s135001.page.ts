...
@Component({
  selector: 'app-s135001',
  templateUrl: './s135001.page.html',
...
export class S135001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/135.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
