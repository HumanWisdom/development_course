...
@Component({
  selector: 'app-s156003',
  templateUrl: './s156003.page.html',
  styleUrls: ['./s156003.page.scss'],
})
export class S156003Page implements OnInit,OnDestroy {
  ...
  prev()
  {
    this.router.navigate(['/teenagers/dealing-with-depression/s156002'])
  }
