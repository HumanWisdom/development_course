...
@Component({
  selector: 'app-s156063',
  templateUrl: './s156063.page.html',
  styleUrls: ['./s156063.page.scss'],
})
export class S156063Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark156063"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark156063"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark156063",JSON.stringify(this.bookmark))
  }
  ...
  submitProgress()
  {
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/adults/dealing-with-depression/s156063'])
      })
  }
