...
@Component({
  selector: 'app-s156175',
  templateUrl: './s156175.page.html',
  styleUrls: ['./s156175.page.scss'],
})
export class S156175Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s156175t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime156175",this.totalTime)
    localStorage.setItem("avDuration156175",this.avDuration)
  }
}