...
@Component({
  selector: 'app-s156201',
  templateUrl: './s156201.page.html',
  styleUrls: ['./s156201.page.scss'],
})
export class S156201Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s156201t"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/dealing-with-depression/s156202'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime156201",this.totalTime)
    localStorage.setItem("avDuration156201",this.avDuration)
  }
}