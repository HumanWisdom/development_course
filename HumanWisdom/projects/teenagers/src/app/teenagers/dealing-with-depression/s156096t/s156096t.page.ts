...
@Component({
  selector: 'app-s156096t',
  templateUrl: './s156096t.page.html',
  styleUrls: ['./s156096t.page.scss'],
})
export class S156096tPage implements OnInit {
  ...
  audioPage="/dealing-with-depression/s156096"
  ...
  avDuration=localStorage.getItem("avDuration156096")
  totalTime=localStorage.getItem("totalTime156096")
