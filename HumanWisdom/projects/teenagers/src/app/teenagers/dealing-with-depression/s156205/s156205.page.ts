...
@Component({
  selector: 'app-s156205',
  templateUrl: './s156205.page.html',
  styleUrls: ['./s156205.page.scss'],
})
export class S156205Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s156205t"
  ...
  prev()
  {
    this.router.navigate(['/dealing-with-depression/s156204'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime156205",this.totalTime)
    localStorage.setItem("avDuration156205",this.avDuration)
  }
}