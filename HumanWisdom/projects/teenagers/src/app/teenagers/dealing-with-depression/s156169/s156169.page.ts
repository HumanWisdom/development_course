...
@Component({
  selector: 'app-s156169',
  templateUrl: './s156169.page.html',
  styleUrls: ['./s156169.page.scss'],
})
export class S156169Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s156169t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime156169",this.totalTime)
    localStorage.setItem("avDuration156169",this.avDuration)
  }
}