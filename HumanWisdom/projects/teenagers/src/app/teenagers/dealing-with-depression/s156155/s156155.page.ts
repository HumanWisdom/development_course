...
@Component({
  selector: 'app-s156155',
  templateUrl: './s156155.page.html',
  styleUrls: ['./s156155.page.scss'],
})
export class S156155Page implements OnInit {
  ...
  progressPercent:any
  progressText="4/9"
  link="/teenagers/dealing-with-depression/s156156"
