...
@Component({
  selector: 'app-s156004',
  templateUrl: './s156004.page.html',
  styleUrls: ['./s156004.page.scss'],
})
export class S156004Page implements OnInit, OnDestroy {
  ...
  submitProgress() 
  {
    ...
    this.router.navigate(['/teenagers/dealing-with-depression/s156005'])
