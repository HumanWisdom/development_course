...
@Component({
  selector: 'app-s156128t',
  templateUrl: './s156128t.page.html',
  styleUrls: ['./s156128t.page.scss'],
})
export class S156128tPage implements OnInit {
  ...
  audioPage="/dealing-with-depression/s156128"
  ...
  avDuration=localStorage.getItem("avDuration156128")
  totalTime=localStorage.getItem("totalTime156128")
