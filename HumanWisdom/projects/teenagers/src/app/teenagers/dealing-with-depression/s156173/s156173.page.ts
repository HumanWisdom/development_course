...
@Component({
  selector: 'app-s156173',
  templateUrl: './s156173.page.html',
  styleUrls: ['./s156173.page.scss'],
})
export class S156173Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/dealing-with-depression/audios/5.5.mp3'

  transcriptPage="dealing-with-depression/s156173t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime156173",this.totalTime)
    localStorage.setItem("avDuration156173",this.avDuration)
  }
}