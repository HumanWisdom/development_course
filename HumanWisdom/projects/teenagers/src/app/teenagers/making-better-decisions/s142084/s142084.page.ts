...
@Component({
  selector: 'HumanWisdom-s142084',
  templateUrl: './s142084.page.html',
  styleUrls: ['./s142084.page.scss'],
})
export class S142084Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142084",this.totalTime)
    localStorage.setItem("avDuration142084",this.avDuration)
  }
