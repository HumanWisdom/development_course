...
@Component({
  selector: 'HumanWisdom-s142096',
  templateUrl: './s142096.page.html',
  styleUrls: ['./s142096.page.scss'],
})
export class S142096Page implements OnInit,OnDestroy {
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/making-better-decisions/s142097'])
  ...
  prev()
  {
    this.router.navigate(['/teenagers/making-better-decisions/s142095'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime142096",this.totalTime)
    localStorage.setItem("avDuration142096",this.avDuration)
  }
