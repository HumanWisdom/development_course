...
@Component({
  selector: 'HumanWisdom-s142112',
  templateUrl: './s142112.page.html',
  styleUrls: ['./s142112.page.scss'],
})
export class S142112Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r142112 = sessionStorage.getItem("r142112")
  r142112 = sessionStorage.getItem("r142112") !== 'null' ? sessionStorage.getItem("r142112") : '';
