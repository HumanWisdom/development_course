...
@Component({
  selector: 'HumanWisdom-s142054',
  templateUrl: './s142054.page.html',
  styleUrls: ['./s142054.page.scss'],
})
export class S142054Page implements OnInit,OnDestroy {
  ...
  prev()
  {
    this.router.navigate(['/teenagers/making-better-decisions/s142053'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime142054",this.totalTime)
    localStorage.setItem("avDuration142054",this.avDuration)
  }
