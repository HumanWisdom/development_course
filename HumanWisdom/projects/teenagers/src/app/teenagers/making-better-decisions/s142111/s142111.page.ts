...
@Component({
  selector: 'HumanWisdom-s142111',
  templateUrl: './s142111.page.html',
  styleUrls: ['./s142111.page.scss'],
})
export class S142111Page implements OnInit {
  ...
  ngOnInit() {
    ...
    {
      // var base_color = "rgb(142111,142111,142111)";
