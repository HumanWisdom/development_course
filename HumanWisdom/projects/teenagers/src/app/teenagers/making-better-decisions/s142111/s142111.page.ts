...
export class S142111Page implements OnInit {
  ...
  ngOnInit() {
    ...
    this.q1 = this.findQuestion(581).Question
    this.optionList1 = this.findQuestion(581).optionList
    this.q2 = this.findQuestion(582).Question
    this.optionList2 = this.findQuestion(582).optionList
    this.q3 = this.findQuestion(583).Question
    this.optionList3 = this.findQuestion(583).optionList
    this.q4 = this.findQuestion(584).Question
    this.optionList4 = this.findQuestion(584).optionList
    this.q5 = this.findQuestion(585).Question
    this.optionList5 = this.findQuestion(585).optionList
