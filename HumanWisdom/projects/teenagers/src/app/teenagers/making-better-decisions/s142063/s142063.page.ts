...
@Component({
  selector: 'HumanWisdom-s142063',
  templateUrl: './s142063.page.html',
  styleUrls: ['./s142063.page.scss'],
})
export class S142063Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142063",this.totalTime)
    localStorage.setItem("avDuration142063",this.avDuration)
  }
