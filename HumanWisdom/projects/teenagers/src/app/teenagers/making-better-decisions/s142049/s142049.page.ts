...
@Component({
  selector: 'HumanWisdom-s142049',
  templateUrl: './s142049.page.html',
  styleUrls: ['./s142049.page.scss'],
})
export class S142049Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142049",this.totalTime)
    localStorage.setItem("avDuration142049",this.avDuration)
  }
