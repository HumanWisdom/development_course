...
@Component({
  selector: 'HumanWisdom-s142088',
  templateUrl: './s142088.page.html',
  styleUrls: ['./s142088.page.scss'],
})
export class S142088Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142088",this.totalTime)
    localStorage.setItem("avDuration142088",this.avDuration)
  }
