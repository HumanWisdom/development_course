...
@Component({
  selector: 'HumanWisdom-s142094',
  templateUrl: './s142094.page.html',
  styleUrls: ['./s142094.page.scss'],
})
export class S142094Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142094",this.totalTime)
    localStorage.setItem("avDuration142094",this.avDuration)
  }
