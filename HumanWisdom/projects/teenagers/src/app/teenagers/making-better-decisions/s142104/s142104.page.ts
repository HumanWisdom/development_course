...
@Component({
  selector: 'HumanWisdom-s142104',
  templateUrl: './s142104.page.html',
  styleUrls: ['./s142104.page.scss'],
})
export class S142104Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark142104"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark142104"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark142104",JSON.stringify(this.bookmark))
  }
  ...
  submitProgress()
  {
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/adults/making-better-decisions/s142104'])
      })
  }
