...
@Component({
  selector: 'HumanWisdom-s142098',
  templateUrl: './s142098.page.html',
  styleUrls: ['./s142098.page.scss'],
})
export class S142098Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142098",this.totalTime)
    localStorage.setItem("avDuration142098",this.avDuration)
  }
