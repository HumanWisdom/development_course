...
@Component({
  selector: 'HumanWisdom-s142092',
  templateUrl: './s142092.page.html',
  styleUrls: ['./s142092.page.scss'],
})
export class S142092Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime142092",this.totalTime)
    localStorage.setItem("avDuration142092",this.avDuration)
  }
