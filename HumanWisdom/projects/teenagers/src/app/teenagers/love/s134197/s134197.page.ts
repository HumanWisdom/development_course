...
@Component({
  selector: 'app-s134197-audio',
  templateUrl: './s134197.page.html',
  styleUrls: ['./s134197.page.scss'],
})
export class S134197Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime134197",this.totalTime)
    localStorage.setItem("avDuration134197",this.avDuration)
  }
