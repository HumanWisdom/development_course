...
@Component({
  selector: 'app-s134209',
  templateUrl: './s134209.page.html',
  styleUrls: ['./s134209.page.scss'],
})
export class S134209Page implements OnInit {
  ...
  submitProgress() {
    ...
    this.router.navigate(['/teenagers/love/s134210'])
  ...
  prev() {
    this.router.navigate(['/teenagers/love/s134208'])
