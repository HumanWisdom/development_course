...
@Component({
  selector: 'app-s62166-audio',
  templateUrl: './s62166.page.html',
  styleUrls: ['./s62166.page.scss'],
})
export class S62166Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime62166",this.totalTime)
    localStorage.setItem("avDuration62166",this.avDuration)
