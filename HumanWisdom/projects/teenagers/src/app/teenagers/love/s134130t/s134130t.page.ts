...
@Component({
  selector: 'app-s134130t',
  templateUrl: './s134130t.page.html',
  styleUrls: ['./s134130t.page.scss'],
})
export class S134130tPage implements OnInit 
{
  ...
  audioPage="teenagers/love/s134130"
  ...
  avDuration=localStorage.getItem("avDuration134130")
  totalTime=localStorage.getItem("totalTime134130")
