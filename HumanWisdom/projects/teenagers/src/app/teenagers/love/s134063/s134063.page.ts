...
@Component({
  selector: 'app-s134063-audio',
  templateUrl: './s134063.page.html',
  styleUrls: ['./s134063.page.scss'],
})
export class S134063Page implements OnInit,OnDestroy {
...
>>>>>>> 5bf63073094facf5d8a4d68631859365156c688e
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime134063",this.totalTime)
    localStorage.setItem("avDuration134063",this.avDuration)
  }
