...
@Component({
  selector: 'app-s134001',
  templateUrl: './s134001.page.html',
  styleUrls: ['./s134001.page.scss'],
})
export class S134001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/134.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
