...
@Component({
  selector: 'app-s134162t',
  templateUrl: './s134162t.page.html',
  styleUrls: ['./s134162t.page.scss'],
})
export class S134162tPage implements OnInit {
  ...
  audioPage="teenagers/love/s134162"
  ...
  avDuration=localStorage.getItem("avDuration134162")
  totalTime=localStorage.getItem("totalTime134162")
