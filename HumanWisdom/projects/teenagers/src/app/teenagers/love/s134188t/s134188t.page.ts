...
@Component({
  selector: 'app-s134188t',
  templateUrl: './s134188t.page.html',
  styleUrls: ['./s134188t.page.scss'],
})
export class S134188tPage implements OnInit {
  ...
  audioPage="teenagers/love/s134188"
  ...
  avDuration=localStorage.getItem("avDuration134188")
  totalTime=localStorage.getItem("totalTime134188")
