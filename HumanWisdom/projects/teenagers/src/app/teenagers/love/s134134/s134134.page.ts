...
@Component({
  selector: 'app-s134134',
  templateUrl: './s134134.page.html',
  styleUrls: ['./s134134.page.scss'],
})
export class S134134Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_pink"
  bg_cft="bg_blue_pink"
  bg="blue_pink_w4"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime134134",this.totalTime)
    localStorage.setItem("avDuration134134",this.avDuration)
  }
