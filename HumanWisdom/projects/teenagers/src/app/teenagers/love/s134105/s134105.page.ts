...
@Component({
  selector: 'app-s134105',
  templateUrl: './s134105.page.html',
  styleUrls: ['./s134105.page.scss'],
})
export class S134105Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_pink"
  bg_cft="bg_blue_pink"
  bg="blue_pink_w1"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime134105",this.totalTime)
    localStorage.setItem("avDuration134105",this.avDuration)
  }
