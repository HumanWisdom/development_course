...
@Component({
  selector: 'app-s134210',
  templateUrl: './s134210.page.html',
  styleUrls: ['./s134210.page.scss'],
})
export class S134210Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r134210 = JSON.parse(sessionStorage.getItem("r134210"))
  ...
  submitProgress() {
    ...
    this.router.navigate(['/love/s134211'])
  ...
  prev() {
    this.router.navigate(['/adults/love/s134209'])
