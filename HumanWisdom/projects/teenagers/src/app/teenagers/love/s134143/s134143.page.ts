...
@Component({
  selector: 'app-s134143',
  templateUrl: './s134143.page.html',
  styleUrls: ['./s134143.page.scss'],
})
export class S134143Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_pink"
  bg_cft="bg_blue_pink"
  bg="blue_pink_w1"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime134143",this.totalTime)
    localStorage.setItem("avDuration134143",this.avDuration)
  }
