...
@Component({
  selector: 'app-s134175t',
  templateUrl: './s134175t.page.html',
  styleUrls: ['./s134175t.page.scss'],
})
export class S134175tPage implements OnInit {
  ...
  audioPage="teenagers/love/s134175"
  ...
  avDuration=localStorage.getItem("avDuration134175")
  totalTime=localStorage.getItem("totalTime134175")
