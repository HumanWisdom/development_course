...
@Component({
  selector: 'app-s115057',
  templateUrl: './s115057.page.html',
  styleUrls: ['./s115057.page.scss'],
})
export class S115057Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    this.q1 = this.findQuestion(414).Question
    this.optionList1 = this.findQuestion(414).optionList
    this.q2 = this.findQuestion(415).Question
    this.optionList2 = this.findQuestion(415).optionList
    this.q3 = this.findQuestion(416).Question
    this.optionList3 = this.findQuestion(416).optionList
    this.q4 = this.findQuestion(417).Question
    this.optionList4 = this.findQuestion(417).optionList
    this.q5 = this.findQuestion(418).Question
    this.optionList5 = this.findQuestion(418).optionList
  ...
  submitProgress() 
  {
    ...
    this.router.navigate(['/teenagers/self-interest/s115058'])
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/self-interest/s115056'])
  }
