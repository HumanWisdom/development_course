...
@Component({
  selector: 'app-s115001',
  templateUrl: './s115001.page.html',
  styleUrls: ['./s115001.page.scss'],
})
export class S115001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/115.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
   ...
   // continue where you left    
    this.service.clickModule(115, this.userId).subscribe(res => {
