...
@Component({
  selector: 'app-s115052',
  templateUrl: './s115052.page.html',
  styleUrls: ['./s115052.page.scss'],
})
export class S115052Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple_red"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime115052",this.totalTime)
    localStorage.setItem("avDuration115052",this.avDuration)
  }
