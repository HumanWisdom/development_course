...
@Component({
  selector: 'app-s122021',
  templateUrl: './s122021.page.html',
  styleUrls: ['./s122021.page.scss'],
})
export class S122021Page implements OnInit, OnDestroy {
  ...
  ngOnInit() 
  {
    ...
    if (JSON.parse(sessionStorage.getItem("bookmark122021")) == 0)
      this.bookmark = 0
  ...
  receiveBookmark(e) 
  {
    ...
    if (e == true)
      ...
      this.bookmark = 0
    sessionStorage.setItem("bookmark122021", JSON.stringify(this.bookmark))
  }
