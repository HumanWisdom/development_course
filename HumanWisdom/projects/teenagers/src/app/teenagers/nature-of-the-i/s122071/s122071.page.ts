...
@Component({
  selector: 'app-s122071',
  templateUrl: './s122071.page.html',
  styleUrls: ['./s122071.page.scss'],
})

export class S122071Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w2" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime122071",this.totalTime)
    localStorage.setItem("avDuration122071",this.avDuration)
  }
