...
@Component({
  selector: 'app-s122015',
  templateUrl: './s122015.page.html',
  styleUrls: ['./s122015.page.scss'],
})

export class S122015Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w2" 
  ...
  audioLink=this.mediaAudio+'/nature-of-the-i/audios/1.4.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime122015",this.totalTime)
    localStorage.setItem("avDuration122015",this.avDuration)
  }
