...
@Component({
  selector: 'app-s122075',
  templateUrl: './s122075.page.html',
  styleUrls: ['./s122075.page.scss'],
})
export class S122075Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(122075,122075,122075)";
    ...
    this.q1 = this.findQuestion(487).Question
    this.optionList1 = this.findQuestion(487).optionList
    this.q2 = this.findQuestion(488).Question
    this.optionList2 = this.findQuestion(488).optionList
    this.q3 = this.findQuestion(489).Question
    this.optionList3 = this.findQuestion(489).optionList
    this.q4 = this.findQuestion(490).Question
    this.optionList4 = this.findQuestion(490).optionList
    this.q5 = this.findQuestion(491).Question
    this.optionList5 = this.findQuestion(491).optionList
