...
@Component({
  selector: 'app-s122049',
  templateUrl: './s122049.page.html',
  styleUrls: ['./s122049.page.scss'],
})

export class S122049Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w2" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime122049",this.totalTime)
    localStorage.setItem("avDuration122049",this.avDuration)
  }
