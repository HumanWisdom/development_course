...
@Component({
  selector: 'app-s122001',
  templateUrl: './s122001.page.html',
  styleUrls: ['./s122001.page.scss'],
})
export class S122001Page implements OnInit,OnDestroy {
