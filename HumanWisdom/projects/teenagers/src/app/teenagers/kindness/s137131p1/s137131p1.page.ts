...
@Component({
  selector: 'app-s137131p1',
  templateUrl: './s137131p1.page.html',
  styleUrls: ['./s137131p1.page.scss'],
})
export class S137131p1Page implements OnInit {
  ...
  ngOnInit() {
    ...
    if (JSON.parse(sessionStorage.getItem("bookmark137131p1")) == 0)
      this.bookmark = 0
    else if (this.bookmarkList.includes(this.screenNumber) || JSON.parse(sessionStorage.getItem("bookmark137131p1")) == 1)
      this.bookmark = 1
  }
  ...
  receiveBookmark(e) {
    ...
    if (e == true)
      ...
      this.bookmark = 0
    sessionStorage.setItem("bookmark137131p1", JSON.stringify(this.bookmark))
  }
