...
@Component({
  selector: 'app-s137028',
  templateUrl: './s137028.page.html',
  styleUrls: ['./s137028.page.scss'],
})
export class S137028Page implements OnInit, OnDestroy 
{
  ...
  transcriptPage="kindness/s137028t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime137028",this.totalTime)
    localStorage.setItem("avDuration137028",this.avDuration)
  }
