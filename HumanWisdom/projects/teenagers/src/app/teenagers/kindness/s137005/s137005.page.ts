...
@Component({
  selector: 'app-s137005',
  templateUrl: './s137005.page.html',
  styleUrls: ['./s137005.page.scss'],
})
export class S137005Page implements OnInit,OnDestroy {
  ...
  transcriptPage="kindness/s137005t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime137005",this.totalTime)
    localStorage.setItem("avDuration137005",this.avDuration)
  }
