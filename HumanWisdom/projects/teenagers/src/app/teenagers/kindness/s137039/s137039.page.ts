...
@Component({
  selector: 'HumanWisdom-s137039',
  templateUrl: './s137039.page.html',
  styleUrls: ['./s137039.page.scss'],
})
export class S137039Page implements OnInit {
  ...
  transcriptPage="kindness/s137039t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime137039",this.totalTime)
    localStorage.setItem("avDuration137039",this.avDuration)
  }
