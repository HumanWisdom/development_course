...
@Component({
  selector: 'HumanWisdom-s137066t',
  templateUrl: './s137066t.page.html',
  styleUrls: ['./s137066t.page.scss'],
})
export class S137066tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration137066")
  totalTime=localStorage.getItem("totalTime137066")
