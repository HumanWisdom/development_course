...
@Component({
  ...
  templateUrl: './s101001.page.html',
  styleUrls: ['./s101001.page.scss'],
})
export class S101001Page implements OnInit,OnDestroy {
  ...
  t:any
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/101.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
