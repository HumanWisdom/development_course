...
@Component({
  selector: 'app-s101015-audio',
  templateUrl: './s101015.page.html',
  styleUrls: ['./s101015.page.scss'],
})
export class S101015Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime101015",this.totalTime)
    localStorage.setItem("avDuration101015",this.avDuration)
  }
