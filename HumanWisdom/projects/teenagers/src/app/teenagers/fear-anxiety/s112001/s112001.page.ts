...
@Component({
  ...
  templateUrl: './s112001.page.html',
  styleUrls: ['./s112001.page.scss'],
})
export class S112001Page implements OnInit,OnDestroy {
  userId:any
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/112.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
