...
@Component({
  selector: 'app-s112128t',
  templateUrl: './s112128t.page.html',
  styleUrls: ['./s112128t.page.scss'],
})
export class S112128tPage implements OnInit {
  ...
  audioPage="/fear-anxiety/s112128"
