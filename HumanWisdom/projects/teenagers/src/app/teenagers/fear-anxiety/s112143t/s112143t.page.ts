...
@Component({
  selector: 'app-s112143t',
  templateUrl: './s112143t.page.html',
  styleUrls: ['./s112143t.page.scss'],
})
export class S112143tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112143"
