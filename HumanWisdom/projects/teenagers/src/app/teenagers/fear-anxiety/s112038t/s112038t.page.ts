...
@Component({
  selector: 'app-s112038t',
  templateUrl: './s112038t.page.html',
  styleUrls: ['./s112038t.page.scss'],
})
export class S112038tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112038"
  ...
  avDuration=localStorage.getItem("avDuration112038")
  totalTime=localStorage.getItem("totalTime112038")
