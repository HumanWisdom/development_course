...
@Component({
  selector: 'app-s112082t',
  templateUrl: './s112082t.page.html',
  styleUrls: ['./s112082t.page.scss'],
})
export class S112082tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112082"
  ...
  avDuration=localStorage.getItem("avDuration112082")
  totalTime=localStorage.getItem("totalTime112082")
