...
@Component({
  selector: 'app-s112084t',
  templateUrl: './s112084t.page.html',
  styleUrls: ['./s112084t.page.scss'],
})
export class S112084tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112084"
  ...
  avDuration=localStorage.getItem("avDuration112084")
  totalTime=localStorage.getItem("totalTime112084")
