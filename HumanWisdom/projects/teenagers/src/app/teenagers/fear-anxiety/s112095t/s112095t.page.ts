...
@Component({
  selector: 'app-s112095t',
  templateUrl: './s112095t.page.html',
  styleUrls: ['./s112095t.page.scss'],
})
export class S112095tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112095"
  ...
  avDuration=localStorage.getItem("avDuration112095")
  totalTime=localStorage.getItem("totalTime112095")
