...
@Component({
  selector: 'app-s112104t',
  templateUrl: './s112104t.page.html',
  styleUrls: ['./s112104t.page.scss'],
})
export class S112104tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112104"
  ...
  avDuration=localStorage.getItem("avDuration112104")
  totalTime=localStorage.getItem("totalTime112104")
