...
@Component({
  selector: 'app-s112167',
  templateUrl: './s112167.page.html',
  styleUrls: ['./s112167.page.scss'],
})
export class S112167Page implements OnInit {
  ...
  prev(){
    this.router.navigate(['/teenagers/fear-anxiety/s112161'])
