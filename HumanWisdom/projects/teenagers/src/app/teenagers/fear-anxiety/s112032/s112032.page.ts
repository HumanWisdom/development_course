...
@Component({
  selector: 'app-s112032',
  templateUrl: './s112032.page.html',
  styleUrls: ['./s112032.page.scss'],
})
export class S112032Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime112032",this.totalTime)
    localStorage.setItem("avDuration112032",this.avDuration)
  }
}
