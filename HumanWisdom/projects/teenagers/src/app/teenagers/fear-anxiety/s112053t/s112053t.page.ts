...
@Component({
  selector: 'app-s112053t',
  templateUrl: './s112053t.page.html',
  styleUrls: ['./s112053t.page.scss'],
})
export class S112053tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112053"
  ...
  avDuration=localStorage.getItem("avDuration112053")
  totalTime=localStorage.getItem("totalTime112053")
