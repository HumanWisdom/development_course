...
@Component({
  selector: 'app-s112146t',
  templateUrl: './s112146t.page.html',
  styleUrls: ['./s112146t.page.scss'],
})
export class S112146tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112146"
  ...
  prev(){
    this.router.navigate(['/teenagers/fear-anxiety/s112145'])
  }
