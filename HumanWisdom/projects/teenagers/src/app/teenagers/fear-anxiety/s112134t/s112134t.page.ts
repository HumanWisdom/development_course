...
@Component({
  selector: 'app-s112134t',
  templateUrl: './s112134t.page.html',
  styleUrls: ['./s112134t.page.scss'],
})
export class S112134tPage implements OnInit {
  ...
  audioPage="/fear-anxiety/s112134"
