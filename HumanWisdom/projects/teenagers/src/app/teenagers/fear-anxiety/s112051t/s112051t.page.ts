...
@Component({
  selector: 'app-s112051t',
  templateUrl: './s112051t.page.html',
  styleUrls: ['./s112051t.page.scss'],
})
export class S112051tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112051"
  ...
  avDuration=localStorage.getItem("avDuration112051")
  totalTime=localStorage.getItem("totalTime112051")
