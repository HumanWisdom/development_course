...
@Component({
  selector: 'app-s112007',
  templateUrl: './s112007.page.html',
  styleUrls: ['./s112007.page.scss'],
})
export class S112007Page implements OnInit {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime112007",this.totalTime)
    localStorage.setItem("avDuration112007",this.avDuration)
  }
