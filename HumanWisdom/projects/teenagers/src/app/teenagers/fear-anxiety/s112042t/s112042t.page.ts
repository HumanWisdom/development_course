...
@Component({
  selector: 'app-s112042t',
  templateUrl: './s112042t.page.html',
  styleUrls: ['./s112042t.page.scss'],
})
export class S112042tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112042"
  ...
  avDuration=localStorage.getItem("avDuration112042")
  totalTime=localStorage.getItem("totalTime112042")
