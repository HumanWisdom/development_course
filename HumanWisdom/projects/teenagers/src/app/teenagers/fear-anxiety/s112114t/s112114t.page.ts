...
@Component({
  selector: 'app-s112114t',
  templateUrl: './s112114t.page.html',
  styleUrls: ['./s112114t.page.scss'],
})
export class S112114tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112114"
