...
@Component({
  selector: 'app-s112055',
  templateUrl: './s112055.page.html',
  styleUrls: ['./s112055.page.scss'],
})
export class S112055Page implements OnInit {
  ...
  submitProgress(){
    ...
    this.router.navigate(['/fear-anxiety/s112056'])
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime112055",this.totalTime)
    localStorage.setItem("avDuration112055",this.avDuration)
  }
}
