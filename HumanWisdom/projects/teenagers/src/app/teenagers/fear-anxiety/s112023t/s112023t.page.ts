...
@Component({
  selector: 'app-s112023t',
  templateUrl: './s112023t.page.html',
  styleUrls: ['./s112023t.page.scss'],
})
export class S112023tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112023"
