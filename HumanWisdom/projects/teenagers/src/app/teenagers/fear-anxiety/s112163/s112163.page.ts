...
@Component({
  selector: 'app-s112163',
  templateUrl: './s112163.page.html',
  styleUrls: ['./s112163.page.scss'],
})
export class S112163Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(112163,112163,112163)";
    ...
    this.q1 = this.findQuestion(435).Question
    this.optionList1 = this.findQuestion(435).optionList
    this.q2 = this.findQuestion(436).Question
    this.optionList2 = this.findQuestion(436).optionList
    this.q3 = this.findQuestion(437).Question
    this.optionList3 = this.findQuestion(437).optionList
    this.q4 = this.findQuestion(438).Question
    this.optionList4 = this.findQuestion(438).optionList
    this.q5 = this.findQuestion(439).Question
    this.optionList5 = this.findQuestion(439).optionList
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/fear-anxiety/s112162'])
  }
