...
@Component({
  selector: 'app-s112139t',
  templateUrl: './s112139t.page.html',
  styleUrls: ['./s112139t.page.scss'],
})
export class S112139tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112139"
