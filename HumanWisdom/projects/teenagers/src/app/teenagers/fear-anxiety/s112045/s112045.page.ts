...
@Component({
  selector: 'app-s112045',
  templateUrl: './s112045.page.html',
  styleUrls: ['./s112045.page.scss'],
})
export class S112045Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime112045",this.totalTime)
    localStorage.setItem("avDuration112045",this.avDuration)
  }
}
