...
@Component({
  selector: 'app-s112122t',
  templateUrl: './s112122t.page.html',
  styleUrls: ['./s112122t.page.scss'],
})
export class S112122tPage implements OnInit {
  ...
  audioPage="/teenagers/fear-anxiety/s112122"
