...
@Component({
  selector: 'app-s112102',
  templateUrl: './s112102.page.html',
  styleUrls: ['./s112102.page.scss'],
})
export class S112102Page implements OnInit {
...
ngOnInit() {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark112102"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark112102"))==1)
      this.bookmark=1
