...
@Component({
  selector: 'app-s112166',
  templateUrl: './s112166.page.html',
  styleUrls: ['./s112166.page.scss'],
})
export class S112166Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r112166 = JSON.parse(sessionStorage.getItem("r112166"))
  ...
  submitProgress() 
  {
    ...
    sessionStorage.setItem("r112166", this.r112166)
    this.r112166 = sessionStorage.getItem("r112166")
    console.log(this.r112166)
    if (this.r112166 != "undefined") 
    {
