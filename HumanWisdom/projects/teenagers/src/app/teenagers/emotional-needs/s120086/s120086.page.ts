...
@Component({
  selector: 'app-s120086',
  templateUrl: './s120086.page.html',
  styleUrls: ['./s120086.page.scss'],
})
export class S120086Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_pink"
  bg_cft="bg_blue_pink"
  bg="blue_pink_w4"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/emotional-needs/s120087'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime120086",this.totalTime)
    localStorage.setItem("avDuration120086",this.avDuration)
  }
