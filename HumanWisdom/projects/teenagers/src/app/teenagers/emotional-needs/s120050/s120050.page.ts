...
@Component({
  selector: 'app-s120050',
  templateUrl: './s120050.page.html',
  styleUrls: ['./s120050.page.scss'],
})
export class S120050Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_pink"
  bg_cft="bg_blue_pink"
  bg="blue_pink_w12"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/emotional-needs/s120051'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime120050",this.totalTime)
    localStorage.setItem("avDuration120050",this.avDuration)
  }
