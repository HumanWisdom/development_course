...
@Component({
  selector: 'app-s120064',
  templateUrl: './s120064.page.html',
  styleUrls: ['./s120064.page.scss'],
})
export class S120064Page implements OnInit 
{
  ...
  submitProgress(e) 
  {
    ...
    sessionStorage.setItem("r120064", JSON.stringify(e))
    this.r120064 = sessionStorage.getItem("r120064")
    console.log(this.r120064)
