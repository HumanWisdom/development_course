...
@Component({
  selector: 'app-s120073',
  templateUrl: './s120073.page.html',
  styleUrls: ['./s120073.page.scss'],
})
export class S120073Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_pink"
  bg_cft="bg_blue_pink"
  bg="blue_pink_w4"
  ...
  transcriptPage="emotional-needs/s120073t"
