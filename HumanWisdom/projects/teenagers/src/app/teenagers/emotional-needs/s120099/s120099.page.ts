...
@Component({
  selector: 'app-s120099',
  templateUrl: './s120099.page.html',
  styleUrls: ['./s120099.page.scss'],
})
export class S120099Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(120099,120099,120099)";
    ...
    this.q1 = this.findQuestion(465).Question
    this.optionList1 = this.findQuestion(465).optionList
    this.q2 = this.findQuestion(466).Question
    this.optionList2 = this.findQuestion(466).optionList
    this.q3 = this.findQuestion(467).Question
    this.optionList3 = this.findQuestion(467).optionList
    this.q4 = this.findQuestion(468).Question
    this.optionList4 = this.findQuestion(468).optionList
    this.q5 = this.findQuestion(469).Question
    this.optionList5 = this.findQuestion(469).optionList
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/emotional-needs/s120098'])
  }
