...
@Component({
  selector: 'app-s120001',
  templateUrl: './s120001.page.html',
  styleUrls: ['./s120001.page.scss'],
})
export class S120001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/120.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
   ...
   // continue where you left    
    this.service.clickModule(120, this.userId).subscribe(res => {
