...
@Component({
  selector: 'app-s113013',
  templateUrl: './s113013.page.html',
  styleUrls: ['./s113013.page.scss'],
})
export class S113013Page implements OnInit 
{
  bg_tn="bg_light_blue"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime113013",this.totalTime)
    localStorage.setItem("avDuration113013",this.avDuration)
  }
