...
@Component({
  selector: 'app-s113001',
  templateUrl: './s113001.page.html',
  styleUrls: ['./s113001.page.scss'],
})
export class S113001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/113.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    // continue where you left    
       this.service.clickModule(113, this.userId).subscribe(res => {
