...
@Component({
  selector: 'app-s129066',
  templateUrl: './s129066.page.html',
  styleUrls: ['./s129066.page.scss'],
})
export class S129066Page implements OnInit 
{
  ...
  submitProgress(e) 
  {
    ...
    sessionStorage.setItem("r129066", JSON.stringify(e))
    this.r129066 = sessionStorage.getItem("r129066")
    console.log(this.r129066)
