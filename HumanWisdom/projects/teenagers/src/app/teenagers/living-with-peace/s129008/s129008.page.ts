...
@Component({
  selector: 'app-s129008',
  templateUrl: './s129008.page.html',
  styleUrls: ['./s129008.page.scss'],
})

export class S129008Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w2" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime129008",this.totalTime)
    localStorage.setItem("avDuration129008",this.avDuration)
  }
