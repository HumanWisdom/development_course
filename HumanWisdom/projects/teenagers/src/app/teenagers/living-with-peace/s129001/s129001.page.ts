...
@Component({
  ...
  templateUrl: './s129001.page.html',
  styleUrls: ['./s129001.page.scss'],
})
export class S129001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/129.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
