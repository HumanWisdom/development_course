...
@Component({
  selector: 'app-s129070',
  templateUrl: './s129070.page.html',
  styleUrls: ['./s129070.page.scss'],
})

export class S129070Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w2" 
  ...
  transcriptPage="living-with-peace/s129070t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime129070",this.totalTime)
    localStorage.setItem("avDuration129070",this.avDuration)
  }
