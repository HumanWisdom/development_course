...
@Component({
  selector: 'app-s129077',
  templateUrl: './s129077.page.html',
  styleUrls: ['./s129077.page.scss'],
})
export class S129077Page implements OnInit 
{
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/living-with-peace/s129076'])
  }
