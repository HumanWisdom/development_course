...
@Component({
  selector: 'app-s129004',
  templateUrl: './s129004.page.html',
  styleUrls: ['./s129004.page.scss'],
})

export class S129004Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_overlay_footer"
  userId:any
