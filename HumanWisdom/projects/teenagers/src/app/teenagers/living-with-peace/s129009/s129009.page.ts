...
@Component({
  selector: 'app-s129009',
  templateUrl: './s129009.page.html',
  styleUrls: ['./s129009.page.scss'],
})
export class S129009Page implements OnInit 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w11"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime129009",this.totalTime)
    localStorage.setItem("avDuration129009",this.avDuration)
  }
