...
@Component({
  selector: 'app-s126035',
  templateUrl: './s126035.page.html',
  styleUrls: ['./s126035.page.scss'],
})
export class S126035Page implements OnInit,OnDestroy 
{
  bg_tn="bg_teal"
  bg_cft="bg_teal"
  bg="teal_w12"
  ...
  prev()
  {
    this.router.navigate(['/self-esteem/s126034'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime126035",this.totalTime)
    localStorage.setItem("avDuration126035",this.avDuration)
  }
