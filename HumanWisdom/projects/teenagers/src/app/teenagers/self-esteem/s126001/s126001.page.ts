...
@Component({
  selector: 'app-s126001',
  templateUrl: './s126001.page.html',
  styleUrls: ['./s126001.page.scss'],
})
export class S126001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/126.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    else
    {
     ...
     // continue where you left    
    this.service.clickModule(126, this.userId).subscribe(res => {
