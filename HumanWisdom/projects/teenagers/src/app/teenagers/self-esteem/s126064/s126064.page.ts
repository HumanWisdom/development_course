...
@Component({
  selector: 'app-s126064',
  templateUrl: './s126064.page.html',
  styleUrls: ['./s126064.page.scss'],
})
export class S126064Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(126064,126064,126064)";
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/self-esteem/s126063'])
  }
