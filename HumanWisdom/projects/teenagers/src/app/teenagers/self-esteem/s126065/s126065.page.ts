...
@Component({
  selector: 'app-s126065',
  templateUrl: './s126065.page.html',
  styleUrls: ['./s126065.page.scss'],
})
export class S126065Page implements OnInit 
{
  ...
  submitProgress() 
  {
    ...
    sessionStorage.setItem("r126065", this.r126065)
    this.r126065 = sessionStorage.getItem("r126065")
    console.log(this.r126065)
    if (this.r126065 != "undefined") 
    {
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/self-esteem/s126064'])
  }
