...
@Component({
  selector: 'app-why-do-i-a06',
  templateUrl: './why-do-i-a06.page.html',
  styleUrls: ['./why-do-i-a06.page.scss'],
})
export class WhyDoIA06Page implements OnInit {
  isAdults = false;
  isSubscriber = false;
  ...
  if (isLoggedIn && isSubscribed) {
    ...
    this.router.navigate(['/teenagers/find-answers/why-do-i/why-do-i-a06-at']);
  } else {
