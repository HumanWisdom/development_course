...
@Component({
  selector: 'app-how-can-i-a07-at',
  templateUrl: './how-can-i-a07-at.page.html',
  styleUrls: ['./how-can-i-a07-at.page.scss'],
})
export class HowCanIA07AtPage implements OnInit {
