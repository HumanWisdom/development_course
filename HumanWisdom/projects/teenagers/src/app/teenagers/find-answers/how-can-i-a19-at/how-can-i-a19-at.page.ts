...
@Component({
  selector: 'app-how-can-i-a19-at',
  templateUrl: './how-can-i-a19-at.page.html',
  styleUrls: ['./how-can-i-a19-at.page.scss'],
})
export class HowCanIA19AtPage implements OnInit {
