...
@Component({
  selector: 'app-how-can-i-a18-at',
  templateUrl: './how-can-i-a18-at.page.html',
  styleUrls: ['./how-can-i-a18-at.page.scss'],
})
export class HowCanIA18AtPage implements OnInit {
