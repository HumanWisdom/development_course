...
@Component({
  selector: 'app-how-can-i-a14-at',
  templateUrl: './how-can-i-a14-at.page.html',
  styleUrls: ['./how-can-i-a14-at.page.scss'],
})
export class HowCanIA14AtPage implements OnInit {
