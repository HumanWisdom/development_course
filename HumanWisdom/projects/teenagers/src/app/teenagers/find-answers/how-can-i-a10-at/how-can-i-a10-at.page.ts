...
@Component({
  selector: 'app-how-can-i-a10-at',
  templateUrl: './how-can-i-a10-at.page.html',
  styleUrls: ['./how-can-i-a10-at.page.scss'],
})
export class HowCanIA10AtPage implements OnInit {
