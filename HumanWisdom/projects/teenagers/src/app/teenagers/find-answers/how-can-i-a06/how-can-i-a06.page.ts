...
@Component({
  selector: 'app-how-can-i-a06',
  templateUrl: './how-can-i-a06.page.html',
  styleUrls: ['./how-can-i-a06.page.scss'],
})
export class HowCanIA06Page implements OnInit {
  ...
  if (isLoggedIn && isSubscribed) {
    ...
    this.router.navigate(['/teenagers/find-answers/how-can-i/how-can-i-a06-at']);
  } else {
