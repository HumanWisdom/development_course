...
@Component({
  selector: 'app-how-can-i-a08',
  templateUrl: './how-can-i-a08.page.html',
  styleUrls: ['./how-can-i-a08.page.scss'],
})
export class HowCanIA08Page implements OnInit {
  ...
  if (isLoggedIn && isSubscribed) {
    ...
    this.router.navigate(['/teenagers/find-answers/how-can-i/how-can-i-a08-at']);
  } else {
