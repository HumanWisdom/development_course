...
@Component({
  selector: 'app-how-can-i-a05-at',
  templateUrl: './how-can-i-a05-at.page.html',
  styleUrls: ['./how-can-i-a05-at.page.scss'],
})
export class HowCanIA05AtPage implements OnInit {
