...
@Component({
  selector: 'app-how-can-i-a08-at',
  templateUrl: './how-can-i-a08-at.page.html',
  styleUrls: ['./how-can-i-a08-at.page.scss'],
})
export class HowCanIA08AtPage implements OnInit {
