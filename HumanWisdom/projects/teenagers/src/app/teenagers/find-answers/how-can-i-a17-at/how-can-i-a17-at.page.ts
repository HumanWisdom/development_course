...
@Component({
  selector: 'app-how-can-i-a17-at',
  templateUrl: './how-can-i-a17-at.page.html',
  styleUrls: ['./how-can-i-a17-at.page.scss'],
})
export class HowCanIA17AtPage implements OnInit {
