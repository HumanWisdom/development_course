...
@Component({
  selector: 'app-how-can-i-a16-at',
  templateUrl: './how-can-i-a16-at.page.html',
  styleUrls: ['./how-can-i-a16-at.page.scss'],
})
export class HowCanIA16AtPage implements OnInit {
