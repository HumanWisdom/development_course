...
@Component({
  selector: 'app-s109073',
  templateUrl: './s109073.page.html',
  styleUrls: ['./s109073.page.scss'],
})
export class S109073Page implements OnInit {
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r109073", this.r109073)
    this.r109073 = sessionStorage.getItem("r109073")
    console.log(this.r109073)
