...
@Component({
  selector: 'app-s109061-audio',
  templateUrl: './s109061.page.html',
  styleUrls: ['./s109061.page.scss'],
})
export class S109061Page implements OnInit,OnDestroy {
  ...
  transcriptPage="meditation/s109061t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime109061",this.totalTime)
    localStorage.setItem("avDuration109061",this.avDuration)
  }
