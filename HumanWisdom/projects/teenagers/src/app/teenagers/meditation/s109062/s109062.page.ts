...
export class S109062Page implements OnInit,OnDestroy {
  ...
  transcriptPage="meditation/s109062t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime109062",this.totalTime)
    localStorage.setItem("avDuration109062",this.avDuration)
  }
