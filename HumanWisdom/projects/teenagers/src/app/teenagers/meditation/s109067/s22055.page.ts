...
@Component({
  selector: 'app-s22055',
  templateUrl: './s22055.page.html',
  styleUrls: ['./s22055.page.scss'],
})
export class S22055Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(22055,22055,22055)";
    ...
    this.q1 = this.findQuestion(87).Question
    this.optionList1 = this.findQuestion(87).optionList
    this.q2 = this.findQuestion(89).Question
    this.optionList2 = this.findQuestion(89).optionList

    this.q4 = this.findQuestion(90).Question
    this.optionList4 = this.findQuestion(90).optionList
    this.q5 = this.findQuestion(91).Question
    this.optionList5 = this.findQuestion(91).optionList
    this.q6 = this.findQuestion(92).Question
    this.optionList6 = this.findQuestion(92).optionList
  ...
  submitProgress() {
    ...
    this.router.navigate(['/adults/meditation/s22056'])
  ...
  prev() {
    this.router.navigate(['/adults/meditation/s22054'])
