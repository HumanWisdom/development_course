...
@Component({
  ...
  styleUrls: ['./s109074.page.scss'],
})
export class S109074Page implements OnInit {
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r109074", this.r109074)
    this.r109074 = sessionStorage.getItem("r109074")
    console.log(this.r109074)
    ...
    this.service.submitProgressReflection({
      ...
      error => {
        console.log(error)
        this.router.navigate(['/teenagers/meditation/s109075'])
      },
      () => {
        this.router.navigate(['/teenagers/meditation/s109075'])
      })
  ...
  prev() {
    this.router.navigate(['/teenagers/meditation/s109073'])
