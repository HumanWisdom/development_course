...
export class S109075Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r109075 = JSON.parse(sessionStorage.getItem("r109075"))
  progName= "teenagers"
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r109075", this.r109075)
    this.r109075 = sessionStorage.getItem("r109075")
    console.log(this.r109075)
