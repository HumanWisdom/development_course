...
export class S109072Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r109072 = JSON.parse(sessionStorage.getItem("r109072"))
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r109072", this.r109072)
    this.r109072 = sessionStorage.getItem("r109072")
    console.log(this.r109072)
