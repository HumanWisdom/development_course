...
@Component({
  selector: 'app-s109048',
  templateUrl: './s109048.page.html',
  styleUrls: ['./s109048.page.scss'],
})
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark109048",JSON.stringify(this.bookmark))
  }
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
       ...
       // this.router.navigate(['/teenagers/meditation/s109048p1'])
      })
