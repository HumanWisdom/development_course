...
@Component({
  selector: 'app-s109042-audio',
  templateUrl: './s109042.page.html',
  styleUrls: ['./s109042.page.scss'],
})
export class S109042Page implements OnInit,OnDestroy {
  ...
  transcriptPage="meditation/s109042t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime109042",this.totalTime)
    localStorage.setItem("avDuration109042",this.avDuration)
  }
