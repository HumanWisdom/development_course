...
@Component({
  selector: 'app-s109011-audio',
  templateUrl: './s109011.page.html',
  styleUrls: ['./s109011.page.scss'],
})
export class S109011Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/modules/meditation/audios/1.2.mp3'
  ...
  prev()
  {
    this.router.navigate(['/teenagers/meditation/s109010'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime109011",this.totalTime)
    localStorage.setItem("avDuration109011",this.avDuration)
  }
