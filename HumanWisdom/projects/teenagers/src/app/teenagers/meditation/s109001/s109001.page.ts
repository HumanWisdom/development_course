...
@Component({
  selector: 'app-s109001',
  templateUrl: './s109001.page.html',
  styleUrls: ['./s109001.page.scss'],
})
export class S109001Page implements OnInit,OnDestroy {
  userId:any
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/109.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
 ...
 constructor
  ...
  ngOnInit() 
  {
    ...
    else
    {
     ...
     // continue where you left    
    this.service.clickModule(109, this.userId).subscribe(res => {
