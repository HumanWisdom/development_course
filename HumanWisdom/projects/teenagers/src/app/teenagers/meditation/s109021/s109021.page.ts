...
@Component({
  selector: 'app-s109021-audio',
  templateUrl: './s109021.page.html',
  styleUrls: ['./s109021.page.scss'],
})
export class S109021Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime109021",this.totalTime)
    localStorage.setItem("avDuration109021",this.avDuration)
  }
