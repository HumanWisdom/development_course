...
@Component({
  selector: 'app-s123057',
  templateUrl: './s123057.page.html',
  styleUrls: ['./s123057.page.scss'],
})

export class S123057Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w3"
 ...
 this.router.navigate(['/teenagers/external-approval/s123056'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime123057",this.totalTime)
    localStorage.setItem("avDuration123057",this.avDuration)
  }
