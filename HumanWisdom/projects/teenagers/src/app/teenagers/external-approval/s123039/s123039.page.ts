...
@Component({
  selector: 'app-s123039',
  templateUrl: './s123039.page.html',
  styleUrls: ['./s123039.page.scss'],
})

export class S123039Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w3"
 ...
 this.router.navigate(['/teenagers/external-approval/s123039p1'])
 ...
 this.router.navigate(['/teenagers/external-approval/s123038'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime123039",this.totalTime)
    localStorage.setItem("avDuration123039",this.avDuration)
  }
