...
@Component({
  selector: 'app-s123032',
  templateUrl: './s123032.page.html',
  styleUrls: ['./s123032.page.scss'],
})

export class S123032Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w3"
 ...
 this.router.navigate(['/teenagers/external-approval/s123031'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime123032",this.totalTime)
    localStorage.setItem("avDuration123032",this.avDuration)
  }
