...
@Component({
  selector: 'app-s123001',
  templateUrl: './s123001.page.html',
  styleUrls: ['./s123001.page.scss'],
})
export class S123001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/123.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    else
    {
     ...
     // continue where you left    
    this.service.clickModule(123, this.userId).subscribe(res => {
