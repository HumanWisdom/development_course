...
export class S123082Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r123082 = JSON.parse(sessionStorage.getItem("r123082"))
  ...
  submitProgress() 
  {
    ...
    sessionStorage.setItem("r123082", this.r123082)
    this.r123082 = sessionStorage.getItem("r123082")
    console.log(this.r123082)
    if (this.r123082 != "undefined") 
    {
