...
@Component({
  selector: 'app-s123074',
  templateUrl: './s123074.page.html',
  styleUrls: ['./s123074.page.scss'],
})

export class S123074Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w3"
  ...
  prev()
  {
  this.router.navigate(['/teenagers/external-approval/s123073'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime123074",this.totalTime)
    localStorage.setItem("avDuration123074",this.avDuration)
  }
