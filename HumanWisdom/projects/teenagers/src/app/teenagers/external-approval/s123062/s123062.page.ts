...
@Component({
  selector: 'app-s123062',
  templateUrl: './s123062.page.html',
  styleUrls: ['./s123062.page.scss'],
})

export class S123062Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue_w3"
  bg_cft="bg_blue_w3"
  bg="blue_w3"
 ...
 this.router.navigate(['/teenagers/external-approval/s123061'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime123062",this.totalTime)
    localStorage.setItem("avDuration123062",this.avDuration)
  }
