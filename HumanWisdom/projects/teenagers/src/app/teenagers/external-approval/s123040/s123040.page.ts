...
export class S123040Page implements OnInit {
  ...
  submitProgress(e) {
    ...
    sessionStorage.setItem("r123040", JSON.stringify(e))
    this.r123040 = sessionStorage.getItem("r123040")
    console.log(this.r123040)
    this.service.submitProgressReflection({
      ...
      error => {
        console.log(error)
     this.router.navigate(['/teenagers/external-approval/s123040p1'])
