...
@Component({
  selector: 'app-s141094-audio',
  templateUrl: './s141094.page.html',
  styleUrls: ['./s141094.page.scss'],
})
export class S141094Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime141094",this.totalTime)
    localStorage.setItem("avDuration141094",this.avDuration)
  }
