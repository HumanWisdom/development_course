...
@Component({
  selector: 'app-s141027t',
  templateUrl: './s141027t.page.html',
  styleUrls: ['./s141027t.page.scss'],
})
export class S141027tPage implements OnInit {
  ...
  audioPage="/teenagers/success-failure/s141027"
  ...
  avDuration=localStorage.getItem("avDuration141027")
  totalTime=localStorage.getItem("totalTime141027")
