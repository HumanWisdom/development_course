...
@Component({
  selector: 'app-s141034',
  templateUrl: './s141034.page.html',
  styleUrls: ['./s141034.page.scss'],
})
export class S141034Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r141034 = JSON.parse(sessionStorage.getItem("r141034"))
