...
@Component({
  selector: 'app-s141108',
  templateUrl: './s141108.page.html',
  styleUrls: ['./s141108.page.scss'],
})
export class S141108Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r141108 = JSON.parse(sessionStorage.getItem("r141108"))
  progName= "teenagers"
