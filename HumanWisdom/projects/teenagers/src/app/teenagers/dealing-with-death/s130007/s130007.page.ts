...
@Component({
  selector: 'app-s130007',
  templateUrl: './s130007.page.html',
  styleUrls: ['./s130007.page.scss'],
})
export class S130007Page implements OnInit,OnDestroy 
{
  bg_tn="bg_teal"
  bg_cft="bg_teal"
  bg="teal_w5"
  ...
  prev()
  {
    this.router.navigate(['/teenagers/dealing-with-death/s130006'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime130007",this.totalTime)
    localStorage.setItem("avDuration130007",this.avDuration)
  }
