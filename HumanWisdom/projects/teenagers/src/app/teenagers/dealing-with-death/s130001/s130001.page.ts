...
@Component({
  selector: 'app-s130001',
  templateUrl: './s130001.page.html',
  styleUrls: ['./s130001.page.scss'],
})
export class S130001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/130.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    // continue where you left    
    this.service.clickModule(130, this.userId).subscribe(res => {
