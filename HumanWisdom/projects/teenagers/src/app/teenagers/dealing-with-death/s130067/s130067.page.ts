...
@Component({
  selector: 'app-s130067',
  templateUrl: './s130067.page.html',
  styleUrls: ['./s130067.page.scss'],
})
export class S130067Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r130067 = JSON.parse(sessionStorage.getItem("r130067"))
  ...
  submitProgress() 
  {
    ...
    sessionStorage.setItem("r130067", this.r130067)
    this.r130067 = sessionStorage.getItem("r130067")
    console.log(this.r130067)
    if (this.r130067 != "undefined") 
    {
