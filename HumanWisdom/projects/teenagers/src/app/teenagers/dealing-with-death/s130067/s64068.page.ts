...
@Component({
  selector: 'app-s64068',
  templateUrl: './s64068.page.html',
  styleUrls: ['./s64068.page.scss'],
})
export class S64068Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r64068 = JSON.parse(sessionStorage.getItem("r64068"))
  r64068 = sessionStorage.getItem("r64068") !== 'null' ? sessionStorage.getItem("r64068") : '';
  ...
  prev() {
    this.router.navigate(['/adults/dealing-with-death/s64067'])
