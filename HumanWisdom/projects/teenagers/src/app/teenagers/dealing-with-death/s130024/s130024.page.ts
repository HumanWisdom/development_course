...
@Component({
  selector: 'app-s130024',
  templateUrl: './s130024.page.html',
  styleUrls: ['./s130024.page.scss'],
})
export class S130024Page implements OnInit,OnDestroy 
{
  bg_tn="bg_teal"
  bg_cft="bg_teal"
  bg="teal_w5"
  ...
  audioLink=this.mediaAudio+'/modules/dealing-with-death/audios/1.4.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime130024",this.totalTime)
    localStorage.setItem("avDuration130024",this.avDuration)
  }
