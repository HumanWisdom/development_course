...
@Component({
  selector: 'app-s130069',
  templateUrl: './s130069.page.html',
  styleUrls: ['./s130069.page.scss'],
})
export class S130069Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r130069 = JSON.parse(sessionStorage.getItem("r130069"))
  ...
  submitProgress() 
  {
    ...
    sessionStorage.setItem("r130069", this.r130069)
    this.r130069 = sessionStorage.getItem("r130069")
    console.log(this.r130069)
    if (this.r130069 != "undefined") 
    {
