...
@Component({
  selector: 'app-s130053',
  templateUrl: './s130053.page.html',
  styleUrls: ['./s130053.page.scss'],
})
export class S130053Page implements OnInit 
{
  bg_tn = "bg_teal"
  bg_cft = "bg_teal"
  bg = "teal_w10"
  ...
  goNext() 
  {
    this.router.navigate(['/teenagers/dealing-with-death/s130054'])
