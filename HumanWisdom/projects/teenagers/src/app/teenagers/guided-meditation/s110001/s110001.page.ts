...
@Component({
  ...
  templateUrl: './s110001.page.html',
  styleUrls: ['./s110001.page.scss'],
})
export class S110001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/110.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
