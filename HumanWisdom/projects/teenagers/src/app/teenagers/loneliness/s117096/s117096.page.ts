...
@Component({
  selector: 'app-s117096',
  templateUrl: './s117096.page.html',
  styleUrls: ['./s117096.page.scss'],
})
export class S117096Page implements OnInit,OnDestroy 
{
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark117096",JSON.stringify(this.bookmark))
  }
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime117096",this.totalTime)
