...
@Component({
  selector: 'app-s117001',
  templateUrl: './s117001.page.html',
  styleUrls: ['./s117001.page.scss'],
})
export class S117001Page implements OnInit,OnDestroy {
  ...
  t:any
  lonelinessResume=sessionStorage.getItem("lonelinessResume")
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/117.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
