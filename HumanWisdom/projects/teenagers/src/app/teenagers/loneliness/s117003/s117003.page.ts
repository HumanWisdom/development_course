...
@Component({
  selector: 'app-s117003',
  templateUrl: './s117003.page.html',
  styleUrls: ['./s117003.page.scss'],
})
export class S117003Page implements OnInit, OnDestroy 
{
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/loneliness/s117002'])
  }
  ...
  goNext() 
  {
    ...
    this.router.navigate(['/teenagers/loneliness/s117004'])
  }
