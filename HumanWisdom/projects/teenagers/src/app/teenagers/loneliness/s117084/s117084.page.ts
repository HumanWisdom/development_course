...
@Component({
  selector: 'app-s117084',
  templateUrl: './s117084.page.html',
  styleUrls: ['./s117084.page.scss'],
})
export class S117084Page implements OnInit 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime117084",this.totalTime)
    localStorage.setItem("avDuration117084",this.avDuration)
  }
