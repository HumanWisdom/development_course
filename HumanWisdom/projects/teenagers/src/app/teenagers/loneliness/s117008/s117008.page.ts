...
@Component({
  selector: 'app-s117008',
  templateUrl: './s117008.page.html',
  styleUrls: ['./s117008.page.scss'],
})
export class S117008Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r117008 = JSON.parse(sessionStorage.getItem("r117008"))
  shared: any
  confirmed: any
