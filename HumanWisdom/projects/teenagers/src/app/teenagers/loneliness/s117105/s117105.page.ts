...
@Component({
  selector: 'app-s117105',
  templateUrl: './s117105.page.html',
  styleUrls: ['./s117105.page.scss'],
})
export class S117105Page implements OnInit,OnDestroy 
{
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark117105",JSON.stringify(this.bookmark))
  }
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/loneliness/s117106'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime117105",this.totalTime)
