...
@Component({
  selector: 'app-s117006',
  templateUrl: './s117006.page.html',
  styleUrls: ['./s117006.page.scss'],
})
export class S117006Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime117006",this.totalTime)
    localStorage.setItem("avDuration117006",this.avDuration)
  }
