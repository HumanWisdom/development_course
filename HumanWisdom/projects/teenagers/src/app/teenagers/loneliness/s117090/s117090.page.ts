...
@Component({
  selector: 'app-s117090',
  templateUrl: './s117090.page.html',
  styleUrls: ['./s117090.page.scss'],
})
export class S117090Page implements OnInit,OnDestroy 
{
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark117090",JSON.stringify(this.bookmark))
  }
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime117090",this.totalTime)
