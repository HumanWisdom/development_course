...
@Component({
  selector: 'app-awareness-exercises-transcript',
  templateUrl: './awareness-exercises-transcript.page.html',
  styleUrls: ['./awareness-exercises-transcript.page.scss'],
})
export class AwarenessExercisesTranscriptPage implements OnInit 
{
