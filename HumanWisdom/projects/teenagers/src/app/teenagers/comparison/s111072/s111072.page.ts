...
@Component({
  selector: 'app-s111072',
  templateUrl: './s111072.page.html',
  styleUrls: ['./s111072.page.scss'],
})
export class S111072Page implements OnInit,OnDestroy 
{
  ...
  prev()
  {
    this.router.navigate(['/teenagers/comparison/s111071'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime111072",this.totalTime)
    localStorage.setItem("avDuration111072",this.avDuration)
  }
