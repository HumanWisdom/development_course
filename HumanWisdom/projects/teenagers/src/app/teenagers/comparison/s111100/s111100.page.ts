...
@Component({
  selector: 'app-s111100',
  templateUrl: './s111100.page.html',
  styleUrls: ['./s111100.page.scss'],
})
export class S111100Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime111100",this.totalTime)
    localStorage.setItem("avDuration111100",this.avDuration)
  }
