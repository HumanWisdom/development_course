...
@Component({
  selector: 'app-s111001',
  templateUrl: './s111001.page.html',
  styleUrls: ['./s111001.page.scss'],
})
export class S111001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/111.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
   ...
   // continue where you left    
    this.service.clickModule(111, this.userId).subscribe(res => {
