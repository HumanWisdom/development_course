...
@Component({
  selector: 'app-s111092',
  templateUrl: './s111092.page.html',
  styleUrls: ['./s111092.page.scss'],
})
export class S111092Page implements OnInit 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime111092",this.totalTime)
    localStorage.setItem("avDuration111092",this.avDuration)
  }
