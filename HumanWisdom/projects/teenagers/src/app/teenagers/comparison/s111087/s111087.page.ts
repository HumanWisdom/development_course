...
@Component({
  selector: 'app-s111087',
  templateUrl: './s111087.page.html',
  styleUrls: ['./s111087.page.scss'],
})
export class S111087Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime111087",this.totalTime)
    localStorage.setItem("avDuration111087",this.avDuration)
  }
