...
@Component({
  selector: 'app-s127001',
  templateUrl: './s127001.page.html',
  styleUrls: ['./s127001.page.scss'],
})
export class S127001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/127.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
 ...
 // continue where you left    
    this.service.clickModule(127, this.userId).subscribe(res => {
