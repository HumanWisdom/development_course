...
@Component({
  selector: 'app-s45153',
  templateUrl: './s45153.page.html',
  styleUrls: ['./s45153.page.scss'],
})
export class S45153Page implements OnInit {
  ...
  ngOnInit() {
    ...
    this.q1 = this.findQuestion(273).Question
    this.optionList1 = this.findQuestion(273).optionList
    this.q2 = this.findQuestion(274).Question
    this.optionList2 = this.findQuestion(274).optionList
    this.q3 = this.findQuestion(275).Question
    this.optionList3 = this.findQuestion(275).optionList
    this.q4 = this.findQuestion(276).Question
    this.optionList4 = this.findQuestion(276).optionList
    this.q5 = this.findQuestion(277).Question
    this.optionList5 = this.findQuestion(277).optionList
  ...
  submitProgress() {
    ...
    this.router.navigate(['/adults/habit-addiction/s45154'])
