...
@Component({
  selector: 'app-s127104',
  templateUrl: './s127104.page.html',
  styleUrls: ['./s127104.page.scss'],
})
export class S127104Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w8"
  ...
  audioLink=this.mediaAudio+'/teenagers/modules/habit-addiction/audios/1.2.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime127104",this.totalTime)
    localStorage.setItem("avDuration127104",this.avDuration)
  }
