...
@Component({
  selector: 'app-s127107',
  templateUrl: './s127107.page.html',
  styleUrls: ['./s127107.page.scss'],
})
export class S127107Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w11"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime127107",this.totalTime)
    localStorage.setItem("avDuration127107",this.avDuration)
  }
