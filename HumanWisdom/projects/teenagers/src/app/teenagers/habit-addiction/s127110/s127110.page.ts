...
@Component({
  selector: 'app-s127110',
  templateUrl: './s127110.page.html',
  styleUrls: ['./s127110.page.scss'],
})
export class S127110Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w2"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/habit-addiction/s127111'])
  ...
  prev()
  {
    this.router.navigate(['/teenagers/habit-addiction/s127109'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime127110",this.totalTime)
    localStorage.setItem("avDuration127110",this.avDuration)
  }
