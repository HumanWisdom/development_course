...
@Component({
  selector: 'app-s127015',
  templateUrl: './s127015.page.html',
  styleUrls: ['./s127015.page.scss'],
})
export class S127015Page implements OnInit {
  ...
  ngOnInit() {
    ...
    this.q1 = this.findQuestion(523).Question
    this.optionList1 = this.findQuestion(523).optionList
