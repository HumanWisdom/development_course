...
@Component({
  selector: 'app-s140100-audio',
  templateUrl: './s140100.page.html',
  styleUrls: ['./s140100.page.scss'],
})
export class S140100Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime140100",this.totalTime)
    localStorage.setItem("avDuration140100",this.avDuration)
  }
