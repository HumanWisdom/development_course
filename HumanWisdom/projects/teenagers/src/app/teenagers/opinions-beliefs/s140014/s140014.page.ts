...
@Component({
  selector: 'app-s140014',
  templateUrl: './s140014.page.html',
  styleUrls: ['./s140014.page.scss'],
})
export class S140014Page implements OnInit {
  ...
  submitProgress(e) 
  {
    ...
    sessionStorage.setItem("r140014", JSON.stringify(e))
    this.r140014 = sessionStorage.getItem("r140014")
    console.log(this.r140014)
