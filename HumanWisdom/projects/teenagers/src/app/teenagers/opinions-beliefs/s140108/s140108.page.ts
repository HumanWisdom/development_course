...
@Component({
  selector: 'app-s140108',
  templateUrl: './s140108.page.html',
  styleUrls: ['./s140108.page.scss'],
})
export class S140108Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r140108 = JSON.parse(sessionStorage.getItem("r140108"))
  r140108 = sessionStorage.getItem("r140108") !== 'null' ? sessionStorage.getItem("r140108") : '';
  progName= "teenagers"
