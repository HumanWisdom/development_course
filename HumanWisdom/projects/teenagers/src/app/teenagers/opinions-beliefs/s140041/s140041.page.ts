...
@Component({
  selector: 'app-s140041-audio',
  templateUrl: './s140041.page.html',
  styleUrls: ['./s140041.page.scss'],
})
export class S140041Page implements OnInit,OnDestroy {
  ...
  transcriptPage="opinions-beliefs/s140041t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime140041",this.totalTime)
    localStorage.setItem("avDuration140041",this.avDuration)
  }
