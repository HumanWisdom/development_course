...
@Component({
  selector: 'app-s124062',
  templateUrl: './s124062.page.html',
  styleUrls: ['./s124062.page.scss'],
})
export class S124062Page implements OnInit 
{
  ...
  transcriptPage="pleasure/s124062t"
  userId:any
  ...
  prev()
  {
    ...
    this.router.navigate(['/teenagers/pleasure/s124061'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime124062",this.totalTime)
    localStorage.setItem("avDuration124062",this.avDuration)
  }
