...
@Component({
  selector: 'app-s124027',
  templateUrl: './s124027.page.html',
  styleUrls: ['./s124027.page.scss'],
})
export class S124027Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime124027",this.totalTime)
    localStorage.setItem("avDuration124027",this.avDuration)
  }
