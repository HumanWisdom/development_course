...
@Component({
  selector: 'app-s124078',
  templateUrl: './s124078.page.html',
  styleUrls: ['./s124078.page.scss'],
})
export class S124078Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r124078 = JSON.parse(sessionStorage.getItem("r124078"))
  progName= "teenagers"
  constructor
  (
  ...
  submitProgress() 
  {
    ...
    if (this.r124078 != "undefined") 
    {
      this.service.submitProgressReflection({
        ...
        error => {
          console.log(error)
          this.router.navigate(['/teenagers/pleasure/s124079'])
        },
        () => {
          this.router.navigate(['/teenagers/pleasure/s124079'])
        })
