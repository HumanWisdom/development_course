...
@Component({
  selector: 'app-s124065',
  templateUrl: './s124065.page.html',
  styleUrls: ['./s124065.page.scss'],
})
export class S124065Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime124065",this.totalTime)
    localStorage.setItem("avDuration124065",this.avDuration)
  }
