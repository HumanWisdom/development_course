...
@Component({
  selector: 'app-s124024',
  templateUrl: './s124024.page.html',
  styleUrls: ['./s124024.page.scss'],
})
export class S124024Page implements OnInit,OnDestroy 
{
  ...
  audioLink=this.mediaAudio+'/modules/pleasure/audios/2.3.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime124024",this.totalTime)
    localStorage.setItem("avDuration124024",this.avDuration)
  }
