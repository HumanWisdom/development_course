...
@Component({
  selector: 'app-s124029',
  templateUrl: './s124029.page.html',
  styleUrls: ['./s124029.page.scss'],
})
export class S124029Page implements OnInit 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime124029",this.totalTime)
    localStorage.setItem("avDuration124029",this.avDuration)
  }
