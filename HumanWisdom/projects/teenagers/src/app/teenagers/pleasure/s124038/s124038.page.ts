...
@Component({
  selector: 'app-s124038',
  templateUrl: './s124038.page.html',
  styleUrls: ['./s124038.page.scss'],
})
export class S124038Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime124038",this.totalTime)
    localStorage.setItem("avDuration124038",this.avDuration)
  }
