...
@Component({
  selector: 'app-s124075',
  templateUrl: './s124075.page.html',
  styleUrls: ['./s124075.page.scss'],
})
export class S124075Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(124075,124075,124075)";
