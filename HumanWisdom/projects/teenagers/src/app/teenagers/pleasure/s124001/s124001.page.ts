...
@Component({
  selector: 'app-s124001',
  templateUrl: './s124001.page.html',
  styleUrls: ['./s124001.page.scss'],
})
export class S124001Page implements OnInit,OnDestroy {
