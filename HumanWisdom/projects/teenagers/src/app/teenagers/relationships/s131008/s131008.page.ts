...
@Component({
  selector: 'app-s131008',
  templateUrl: './s131008.page.html',
  styleUrls: ['./s131008.page.scss'],
})
export class S131008Page implements OnInit { 
  ...
  ngOnInit() {
    ...
    {this.userId=JSON.parse(sessionStorage.getItem("userId"))}
      ...
      if(JSON.parse(sessionStorage.getItem("bookmark131008"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark131008"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark131008",JSON.stringify(this.bookmark))
  }
