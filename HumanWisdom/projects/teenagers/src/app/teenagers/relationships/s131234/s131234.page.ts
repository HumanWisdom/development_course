...
@Component({
  selector: 'app-s131234',
  templateUrl: './s131234.page.html',
  styleUrls: ['./s131234.page.scss'],
})
export class S131234Page implements OnInit {
  ...
  prev()
  {
    this.router.navigate(['/teenagers/relationships/s131233'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime131234",this.totalTime)
    localStorage.setItem("avDuration131234",this.avDuration)
  }
