...
@Component({
  selector: 'app-s131059',
  templateUrl: './s131059.page.html',
  styleUrls: ['./s131059.page.scss'],
})
export class S131059Page implements OnInit {
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w11"
  ...
  progressPercent:any
  progressText="2/10"
  link="/teenagers/relationships/s131060"
