...
@Component({
  selector: 'app-s131182',
  templateUrl: './s131182.page.html',
  styleUrls: ['./s131182.page.scss'],
})
export class S131182Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w6"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/relationships/s131183'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime131182",this.totalTime)
    localStorage.setItem("avDuration131182",this.avDuration)
  }
