...
@Component({
  selector: 'app-s131101',
  templateUrl: './s131101.page.html',
  styleUrls: ['./s131101.page.scss'],
})
export class S131101Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w5"
  ...
  prev()
  {
    this.router.navigate(['/relationships/s131100'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime131101",this.totalTime)
    localStorage.setItem("avDuration131101",this.avDuration)
  }
