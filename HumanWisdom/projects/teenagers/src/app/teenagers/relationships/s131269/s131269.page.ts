...
@Component({
  selector: 'app-s131269',
  templateUrl: './s131269.page.html',
  styleUrls: ['./s131269.page.scss'],
})
export class S131269Page implements OnInit {
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/relationships/s131270'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime131269",this.totalTime)
    localStorage.setItem("avDuration131269",this.avDuration)
  }
