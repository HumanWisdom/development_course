...
@Component({
  selector: 'app-s131038',
  templateUrl: './s131038.page.html',
  styleUrls: ['./s131038.page.scss'],
})
export class S131038Page implements OnInit {
  ...
  prev()
  {
    this.router.navigate(['/teenagers/relationships/s131037'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime131037",this.totalTime)
    localStorage.setItem("avDuration131037",this.avDuration)
  }
