...
@Component({
  selector: 'app-s131073',
  templateUrl: './s131073.page.html',
  styleUrls: ['./s131073.page.scss'],
})
export class S131073Page implements OnInit,OnDestroy 
{
  bg_tn="bg_purple"
  bg_cft="bg_purple"
  bg="purple_w6"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/relationships/s131074'])
  ...
  prev()
  {
    this.router.navigate(['/teenagers/relationships/s131072'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime131073",this.totalTime)
    localStorage.setItem("avDuration131073",this.avDuration)
  }
