...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157010',
  templateUrl: './s157010.page.html',
  styleUrls: ['./s157010.page.scss'],
})
export class S157010Page implements OnInit {
  dayclass = 'intro'
  enableAlert =false;
  ...
  ngOnInit() {
   ...
   if (x) {
    var data = x.filter(x => x.ScreenNo.includes('157010'));
  ...
  if (this.lastClick >= (Date.now() - this.delay))
{
    ...
    setTimeout(() => {
      if (this.slideStart < this.totalSlidesCount) {
        ...
        if(this.currentDay>this.totaldays){
          this.router.navigate(['teenagerss/wisdom-exercise/s157011']);
        }else{
          this.getdayevent(this.currentDay.toString());
        }
      } else {
  ...
  getClass(day) {
    ...
    else if (day === '157010p1') {
      dayclass = '1';
    }
    else if (day === '157010p2') {
      dayclass = '2';
    }
    else if (day === '157010p3') {
      dayclass = '3';
    }
    else if (day === '157010p4') {
      dayclass = '4';
    }
    else if (day === '157010p5') {
      dayclass = '5';
    }
    else if (day === '157010p6') {
      dayclass = '6';
    }
    else if (day === '157010p7') {
      dayclass = '7';
    }
