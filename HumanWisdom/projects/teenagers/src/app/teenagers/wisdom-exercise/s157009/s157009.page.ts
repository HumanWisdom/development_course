...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157009',
  templateUrl: './s157009.page.html',
  styleUrls: ['./s157009.page.scss'],
})
export class S157009Page implements OnInit {
  dayclass = 'intro'
  ...
  ngOnInit() {
   ...
   if (x) {
    var data = x.filter(x => x.ScreenNo.includes('157009'));
  ...
  next() {
    ...
    setTimeout(() => {
      if (this.slideStart < this.totalSlidesCount) {
        ...
        this.vistedScreens.push({
          "ScreenNo": '157009p' + (parseInt(this.screenNumber.substring(6, 7))),
          "ModuleID": 157,
          "SessionID": 0,
        })
        if(this.currentDay>this.totaldays){
          this.router.navigate(['teenagerss/wisdom-exercise/s157010']);
        }else{
          this.getdayevent(this.currentDay.toString());
        }
      } else {
  ...
  getClass(day) {
    ...
    else if (day === '157009p1') {
      dayclass = '1';
    }
    else if (day === '157009p2') {
      dayclass = '2';
    }
    else if (day === '157009p3') {
      dayclass = '3';
    }
    else if (day === '157009p4') {
      dayclass = '4';
    }
    else if (day === '157009p5') {
      dayclass = '5';
    }
    else if (day === '157009p6') {
      dayclass = '6';
    }
    else if (day === '157009p7') {
      dayclass = '7';
    }
    else if (day === '157009p8') {
      dayclass = '8';
    }
    else if (day === '157009p9') {
      dayclass = '9';
    }
    else if (day === '157009p10') {
      dayclass = '10';
    }
    ...
    setTimeout(() => {
      if (this.slideStart < 1) {
        ...
        if(this.currentDay<0){
          this.router.navigate(['teenagerss/wisdom-exercise/s157008']);
        }else{
          this.getdayevent(this.currentDay.toString());
        }
      }
