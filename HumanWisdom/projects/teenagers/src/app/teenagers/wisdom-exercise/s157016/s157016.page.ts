...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157016',
  templateUrl: './s157016.page.html',
  styleUrls: ['./s157016.page.scss'],
})

export class S157016Page implements OnInit {
  dayclass = 'intro'
  ...
  ngOnInit() {
   ...
   if (x) {
    var data = x.filter(x => x.ScreenNo.includes('157016'));
  ...
  next() {
    ...
    setTimeout(() => {
      if (this.slideStart < this.totalSlidesCount) {
        ...
        this.vistedScreens.push({
          "ScreenNo": '157016p' + (parseInt(this.screenNumber.substring(6, this.screenNumber.length))),
          "ModuleID": 157,
          "SessionID": 0,
        })
  ...
  getClass(day) {
    ...
    else if (day === '157016p1') {
      dayclass = '1';
    }
    else if (day === '157016p2') {
      dayclass = '2';
    }
    else if (day === '157016p3') {
      dayclass = '3';
    }
    else if (day === '157016p4') {
      dayclass = '4';
    }
    else if (day === '157016p5') {
      dayclass = '5';
    }
    else if (day === '157016p6') {
      dayclass = '6';
    }
    else if (day === '157016p7') {
      dayclass = '7';
    }
