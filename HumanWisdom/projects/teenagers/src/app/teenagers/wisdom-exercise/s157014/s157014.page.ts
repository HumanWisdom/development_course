...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157014',
  templateUrl: './s157014.page.html',
  styleUrls: ['./s157014.page.scss'],
})

export class S157014Page implements OnInit {
  dayclass = 'intro'
  ...
  getClass(day) {
    ...
    else if (day === '157014p1') {
      dayclass = '1';
    }
    else if (day === '157014p2') {
      dayclass = '2';
    }
    else if (day === '157014p3') {
      dayclass = '3';
    }
    else if (day === '157014p4') {
      dayclass = '4';
    }
    else if (day === '157014p5') {
      dayclass = '5';
    }
    else if (day === '157014p6') {
      dayclass = '6';
    }
    else if (day === '157014p7') {
      dayclass = '7';
    }
