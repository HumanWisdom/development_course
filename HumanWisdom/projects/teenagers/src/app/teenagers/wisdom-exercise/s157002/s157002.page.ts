...
@Component({
  ...
  templateUrl: "./s157002.page.html",
  styleUrls: ["./s157002.page.scss"],
})
export class S157002Page implements OnInit, AfterViewInit {
  dayclass = "intro";
  enableAlert =false;
