...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157006',
  templateUrl: './s157006.page.html',
  styleUrls: ['./s157006.page.scss'],
})
export class S157006Page implements OnInit {
  dayclass = 'intro'
  enableAlert=false;
  ...
  ngOnInit() {
    ...
    if (x) {
     var data = x.filter(x => x.ScreenNo.includes('157006'));
  ...
  next() {
    ...
    setTimeout(() => {
      if (this.slideStart < this.totalSlidesCount) {
        ...
        this.vistedScreens.push({
          "ScreenNo": '157006p' + (parseInt(this.screenNumber.substring(7, 8))),
          "ModuleID": 157,
          "SessionID": 0,
        })
        if(this.currentDay>this.totaldays){
          this.router.navigate(['teenagers/wisdom-exercise/s157007']);
        }else{
          this.getdayevent(this.currentDay.toString());
        }
      } else {
  ...
  //     dayclass = "0";
  //   }
  //   else if (day === '157006p1') {
  //     dayclass = '1';
  //   }
  //   else if (day === '157006p2') {
  //     dayclass = '2';
  //   }
  //   else if (day === '157006p3') {
  //     dayclass = '3';
  //   }
  //   else if (day === '157006p4') {
  //     dayclass = '4';
  //   }
  //   else if (day === '157006p5') {
  //     dayclass = '5';
  //   }
