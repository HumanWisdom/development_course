...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157013',
  templateUrl: './s157013.page.html',
  styleUrls: ['./s157013.page.scss'],
})

export class S157013Page implements OnInit {
  dayclass = 'intro'
  ...
  next() {
    ...
    setTimeout(() => {
      if (this.slideStart < this.totalSlidesCount) {
        ...
        this.vistedScreens.push({
          "ScreenNo": '157013p' + (parseInt(this.screenNumber.substring(7, this.screenNumber.length))),
          "ModuleID": 157,
          "SessionID": 0,
        })
  ...
  //     dayclass = "0";
  //   }
  //   else if (day === '157013p1') {
  //     dayclass = '1';
  //   }
  //   else if (day === '157013p2') {
  //     dayclass = '2';
  //   }
  //   else if (day === '157013p3') {
  //     dayclass = '3';
  //   }
  //   else if (day === '157013p4') {
  //     dayclass = '4';
  //   }
  //   else if (day === '157013p5') {
  //     dayclass = '5';
  //   }
  //   else if (day === '157013p6') {
  //     dayclass = '6';
  //   }
  //   else if (day === '157013p7') {
  //     dayclass = '7';
  //   }
