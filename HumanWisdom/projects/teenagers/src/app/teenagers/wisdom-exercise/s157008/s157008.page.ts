...
declare var $: any;
@Component({
  selector: 'HumanWisdom-s157008',
  templateUrl: './s157008.page.html',
  styleUrls: ['./s157008.page.scss'],
})
export class S157008Page implements OnInit {
  // active_color = "#FFC455";
...
/*
    this.teenagers.GetVisitedScreen(this.moduleId).subscribe((x: any) => {
      if (x) {
...
*/
  ...
  next() {
    ...
    setTimeout(() => {
      if (this.slideStart < this.totalSlidesCount) {
        ...
        this.vistedScreens.push({
          "ScreenNo": '157008p' + (parseInt(this.screenNumber.substring(6, 7))),
          "ModuleID": 157,
          "SessionID": 0,
        })
        if(this.currentDay>this.totaldays){
          this.router.navigate(['teenagerss/wisdom-exercise/s157009']);
        }else{
          this.getdayevent(this.currentDay.toString());
        }
      } else {
  ...
  getClass(day) {
    ...
    else if (day === '157008p1') {
      dayclass = '1';
    }
    else if (day === '157008p2') {
      dayclass = '2';
    }
    else if (day === '157008p3') {
      dayclass = '3';
    }
    else if (day === '157008p4') {
      dayclass = '4';
    }
    else if (day === '157008p5') {
      dayclass = '5';
    }
    else if (day === '157008p6') {
      dayclass = '6';
    }
    else if (day === '157008p7') {
      dayclass = '7';
    }
