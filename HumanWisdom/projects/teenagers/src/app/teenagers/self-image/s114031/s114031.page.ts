...
@Component({
  selector: 'app-s114031',
  templateUrl: './s114031.page.html',
  styleUrls: ['./s114031.page.scss'],
})
export class S114031Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w12"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime114031",this.totalTime)
    localStorage.setItem("avDuration114031",this.avDuration)
  }
