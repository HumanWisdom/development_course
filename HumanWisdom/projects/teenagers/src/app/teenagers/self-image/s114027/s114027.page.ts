...
@Component({
  selector: 'app-s114027',
  templateUrl: './s114027.page.html',
  styleUrls: ['./s114027.page.scss'],
})
export class S114027Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w8"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime114027",this.totalTime)
    localStorage.setItem("avDuration114027",this.avDuration)
  }
