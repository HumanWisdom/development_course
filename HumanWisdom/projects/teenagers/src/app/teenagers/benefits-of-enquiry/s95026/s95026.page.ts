...
@Component({
  selector: 'HumanWisdom-s95026',
  templateUrl: './s95026.page.html',
  styleUrls: ['./s95026.page.scss'],
})
export class S95026Page implements OnInit {
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r95026", this.r95026)
    this.r95026 = sessionStorage.getItem("r95026")
    console.log(this.r95026)
