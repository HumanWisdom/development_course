...
@Component({
  selector: 'app-s95006-audio',
  templateUrl: './s95006.page.html',
  styleUrls: ['./s95006.page.scss'],
})
export class S95006Page implements OnInit,OnDestroy {
  ...
  ngOnInit() {
   ...
   this.startTime = Date.now();
    ...
    this.startTime = Date.now();
    this.createScreen()
    if(JSON.parse(sessionStorage.getItem("bookmar95006"))==0)
      this.bookmark=0
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark95006",JSON.stringify(this.bookmark))
  }
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime95006",this.totalTime)
    localStorage.setItem("avDuration95006",this.avDuration)
