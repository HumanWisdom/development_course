...
@Component({
  selector: 'HumanWisdom-s95025',
  templateUrl: './s95025.page.html',
  styleUrls: ['./s95025.page.scss'],
})
export class S95025Page implements OnInit {
  ...
  submitProgress() {
    ...
    this.service.submitProgressReflection({
      ...
      error => {
        console.log(error)
        this.router.navigate(['/teenagers/benefits-of-enquiry/s95026'])
      },
      () => {
        this.router.navigate(['/teenagers/benefits-of-enquiry/s95026'])
      })
