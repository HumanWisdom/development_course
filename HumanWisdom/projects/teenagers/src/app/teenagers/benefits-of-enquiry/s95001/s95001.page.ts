...
@Component({
  selector: 'app-s95001',
  templateUrl: './s95001.page.html',
  styleUrls: ['./s95001.page.scss'],
})
export class S95001Page implements OnInit, OnDestroy  {
  ...
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/teenagers/95.webp"
  tocColor="white"
  ...
  ngOnInit() 
  {
    ...
    {this.userId=JSON.parse(localStorage.getItem("userId"))}
     // continue where you left    
    this.service.clickModule(95, this.userId).subscribe(res => {
