...
@Component({
  selector: 'app-s95003t',
  templateUrl: './s95003t.page.html',
  styleUrls: ['./s95003t.page.scss'],
})
export class S95003tPage implements OnInit {
  ...
  audioPage="/teenagers/benefits-of-enquiry/s95003"
  ...
  avDuration=localStorage.getItem("avDuration95003")
  totalTime=localStorage.getItem("totalTime95003")
