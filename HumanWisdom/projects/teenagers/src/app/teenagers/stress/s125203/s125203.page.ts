...
@Component({
  selector: 'app-s125203',
  templateUrl: './s125203.page.html',
  styleUrls: ['./s125203.page.scss'],
})
export class S125203Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w7"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime125203",this.totalTime)
    localStorage.setItem("avDuration125203",this.avDuration)
  }
