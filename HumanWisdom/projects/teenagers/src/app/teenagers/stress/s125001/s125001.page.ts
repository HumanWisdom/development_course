...
@Component({
  selector: 'app-s125001',
  templateUrl: './s125001.page.html',
  styleUrls: ['./s125001.page.scss'],
})
export class S125001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/125.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
