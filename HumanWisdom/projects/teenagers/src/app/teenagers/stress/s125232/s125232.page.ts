...
@Component({
  selector: 'app-s125232',
  templateUrl: './s125232.page.html',
  styleUrls: ['./s125232.page.scss'],
})
export class S125232Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w12"
  ...
  audioLink=this.mediaAudio+'teenagers/stress/audiosteenagers/stress+7.14.mp3'
...
>>>>>>> 5bf63073094facf5d8a4d68631859365156c688e
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime125232",this.totalTime)
    localStorage.setItem("avDuration125232",this.avDuration)
  }
