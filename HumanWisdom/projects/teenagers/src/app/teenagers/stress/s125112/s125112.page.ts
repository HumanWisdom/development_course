...
@Component({
  selector: 'app-s125112',
  templateUrl: './s125112.page.html',
  styleUrls: ['./s125112.page.scss'],
})
export class S125112Page implements OnInit 
{
  ...
  submitProgress(e) 
  {
    ...
    sessionStorage.setItem("r125112", JSON.stringify(e))
    this.r125112 = sessionStorage.getItem("r125112")
    console.log(this.r125112)
