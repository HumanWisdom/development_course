...
@Component({
  selector: 'app-s125220',
  templateUrl: './s125220.page.html',
  styleUrls: ['./s125220.page.scss'],
})
export class S125220Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w12"
  ...
  audioLink=this.mediaAudio+'teenagers/stress/audiosteenagers/stress+7.10.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime125220",this.totalTime)
    localStorage.setItem("avDuration125220",this.avDuration)
  }
