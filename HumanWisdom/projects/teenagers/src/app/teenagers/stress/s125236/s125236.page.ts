...
@Component({
  selector: 'app-s125236',
  templateUrl: './s125236.page.html',
  styleUrls: ['./s125236.page.scss'],
})
export class S125236Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w4"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime125236",this.totalTime)
    localStorage.setItem("avDuration125236",this.avDuration)
  }
