...
@Component({
  selector: 'app-s125206',
  templateUrl: './s125206.page.html',
  styleUrls: ['./s125206.page.scss'],
})
export class S125206Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w10"
  ...
  audioLink=this.mediaAudio+'/teenagers/modules/stress/audios/1.22.mp3'
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime125206",this.totalTime)
    localStorage.setItem("avDuration125206",this.avDuration)
  }
