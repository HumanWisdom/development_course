...
@Component({
  selector: 'app-s132084t',
  templateUrl: './s132084t.page.html',
  styleUrls: ['./s132084t.page.scss'],
})
export class S132084tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132084"
  ...
  avDuration=localStorage.getItem("avDuration132084")
  totalTime=localStorage.getItem("totalTime132084")
