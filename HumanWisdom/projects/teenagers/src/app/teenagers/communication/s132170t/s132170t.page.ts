...
@Component({
  selector: 'app-s132170t',
  templateUrl: './s132170t.page.html',
  styleUrls: ['./s132170t.page.scss'],
})
export class S132170tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132170"
  ...
  avDuration=localStorage.getItem("avDuration132170")
  totalTime=localStorage.getItem("totalTime132170")
