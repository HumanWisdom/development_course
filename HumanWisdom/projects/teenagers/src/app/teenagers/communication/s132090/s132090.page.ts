...
@Component({
  selector: 'app-s132090',
  templateUrl: './s132090.page.html',
  styleUrls: ['./s132090.page.scss'],
})
export class S132090Page implements OnInit {
  ...
  transcriptPage="communication/s132090t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime132090",this.totalTime)
    localStorage.setItem("avDuration132090",this.avDuration)
  }
