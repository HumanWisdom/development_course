...
@Component({
  selector: 'app-s53037',
  templateUrl: './s53037.page.html',
  styleUrls: ['./s53037.page.scss'],
})
export class S53037Page implements OnInit {
  ...
  transcriptPage="communication/s53037t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime53037",this.totalTime)
    localStorage.setItem("avDuration53037",this.avDuration)
