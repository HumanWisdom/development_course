...
@Component({
  selector: 'app-s132245t',
  templateUrl: './s132245t.page.html',
  styleUrls: ['./s132245t.page.scss'],
})
export class S132245tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132245"
  ...
  avDuration=localStorage.getItem("avDuration132245")
  totalTime=localStorage.getItem("totalTime132245")
