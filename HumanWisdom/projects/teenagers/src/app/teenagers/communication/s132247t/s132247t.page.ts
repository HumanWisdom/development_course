...
@Component({
  selector: 'app-s132247t',
  templateUrl: './s132247t.page.html',
  styleUrls: ['./s132247t.page.scss'],
})
export class S132247tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132247"
  ...
  avDuration=localStorage.getItem("avDuration132247")
  totalTime=localStorage.getItem("totalTime132247")
