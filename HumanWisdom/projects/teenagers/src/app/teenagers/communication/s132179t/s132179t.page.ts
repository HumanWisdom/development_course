...
@Component({
  selector: 'app-s132179t',
  templateUrl: './s132179t.page.html',
  styleUrls: ['./s132179t.page.scss'],
})
export class S132179tPage implements OnInit {
  ...
  audioPage="/communication/s132179"
  ...
  avDuration=localStorage.getItem("avDuration132179")
  totalTime=localStorage.getItem("totalTime132179")
