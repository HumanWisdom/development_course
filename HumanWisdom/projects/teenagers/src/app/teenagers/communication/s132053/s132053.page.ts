...
export class S132053Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w8"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime132053",this.totalTime)
    localStorage.setItem("avDuration132053",this.avDuration)
  }
