...
@Component({
  selector: 'app-s132173t',
  templateUrl: './s132173t.page.html',
  styleUrls: ['./s132173t.page.scss'],
})
export class S132173tPage implements OnInit {
  ...
  audioPage="/communication/s132173"
  ...
  avDuration=localStorage.getItem("avDuration132173")
  totalTime=localStorage.getItem("totalTime132173")
