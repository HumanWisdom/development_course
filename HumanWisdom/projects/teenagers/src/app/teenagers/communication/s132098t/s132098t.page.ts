...
@Component({
  selector: 'app-s132098t',
  templateUrl: './s132098t.page.html',
  styleUrls: ['./s132098t.page.scss'],
})
export class S132098tPage implements OnInit {
  ...
  audioPage="/communication/s132098"
  ...
  avDuration=localStorage.getItem("avDuration132098")
  totalTime=localStorage.getItem("totalTime132098")
