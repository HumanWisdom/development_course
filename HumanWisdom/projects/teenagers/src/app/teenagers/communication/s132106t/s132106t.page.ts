...
@Component({
  selector: 'app-s132106t',
  templateUrl: './s132106t.page.html',
  styleUrls: ['./s132106t.page.scss'],
})
export class S132106tPage implements OnInit {
  ...
  audioPage="/communication/s132106"
  ...
  avDuration=localStorage.getItem("avDuration132106")
  totalTime=localStorage.getItem("totalTime132106")
