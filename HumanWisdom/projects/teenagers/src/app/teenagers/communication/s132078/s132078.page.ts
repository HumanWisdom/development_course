...
@Component({
  selector: 'app-s132078',
  templateUrl: './s132078.page.html',
  styleUrls: ['./s132078.page.scss'],
})
export class S132078Page implements OnInit {
  ...
  transcriptPage="communication/s132078t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime132078",this.totalTime)
    localStorage.setItem("avDuration132078",this.avDuration)
  }
