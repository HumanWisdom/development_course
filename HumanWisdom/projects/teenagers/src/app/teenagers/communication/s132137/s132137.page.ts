...
// /tb copied mul;tiple times
  ...
  // /multistep wizard
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark132137"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark132137"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark132137",JSON.stringify(this.bookmark))
  }
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
       ...
       // this.router.navigate(['/132137/s132137'])
      })
