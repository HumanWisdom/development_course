...
export class S132051Page implements OnInit, OnDestroy {
  ...
  ngOnInit() 
  {
    ...
    if (JSON.parse(sessionStorage.getItem("bookmark132051")) == 0)
      this.bookmark = 0
    else if (this.bookmarkList.includes(this.screenNumber) || JSON.parse(sessionStorage.getItem("bookmark132051")) == 1)
      this.bookmark = 1
  }
  ...
  receiveBookmark(e) 
  {
    ...
    if (e == true)
      ...
      this.bookmark = 0
    sessionStorage.setItem("bookmark132051", JSON.stringify(this.bookmark))
  }
