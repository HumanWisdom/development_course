...
@Component({
  selector: 'app-s132096t',
  templateUrl: './s132096t.page.html',
  styleUrls: ['./s132096t.page.scss'],
})
export class S132096tPage implements OnInit {
  ...
  audioPage="/communication/s132096"
  ...
  avDuration=localStorage.getItem("avDuration132096")
  totalTime=localStorage.getItem("totalTime132096")
