...
@Component({
  selector: 'app-s132200',
  templateUrl: './s132200.page.html',
  styleUrls: ['./s132200.page.scss'],
})
export class S132200Page implements OnInit {
  ...
  transcriptPage="communication/s132200t"
