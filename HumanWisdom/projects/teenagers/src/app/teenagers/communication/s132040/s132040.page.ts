...
export class S132040Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w5"
  ...
  transcriptPage="communication/s132040t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime132040",this.totalTime)
    localStorage.setItem("avDuration132040",this.avDuration)
  }
