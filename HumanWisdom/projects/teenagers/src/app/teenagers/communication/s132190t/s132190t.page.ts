...
@Component({
  selector: 'app-s132190t',
  templateUrl: './s132190t.page.html',
  styleUrls: ['./s132190t.page.scss'],
})
export class S132190tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132190"
  ...
  avDuration=localStorage.getItem("avDuration132190")
  totalTime=localStorage.getItem("totalTime132190")
