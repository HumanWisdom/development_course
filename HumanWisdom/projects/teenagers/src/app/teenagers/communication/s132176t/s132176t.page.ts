...
@Component({
  selector: 'app-s132176t',
  templateUrl: './s132176t.page.html',
  styleUrls: ['./s132176t.page.scss'],
})
export class S132176tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132176"
  ...
  avDuration=localStorage.getItem("avDuration132176")
  totalTime=localStorage.getItem("totalTime132176")
