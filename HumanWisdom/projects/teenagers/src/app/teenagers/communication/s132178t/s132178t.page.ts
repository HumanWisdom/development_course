...
@Component({
  selector: 'app-s132178t',
  templateUrl: './s132178t.page.html',
  styleUrls: ['./s132178t.page.scss'],
})
export class S132178tPage implements OnInit {
  ...
  audioPage="/teenagers/communication/s132178"
  ...
  avDuration=localStorage.getItem("avDuration132178")
  totalTime=localStorage.getItem("totalTime132178")
