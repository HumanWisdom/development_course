...
@Component({
  selector: 'app-s132054',
  templateUrl: './s132054.page.html',
  styleUrls: ['./s132054.page.scss'],
})
export class S132054Page implements OnInit,OnDestroy 
{
  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w8"
  ...
  transcriptPage="communication/s132054t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime132054",this.totalTime)
    localStorage.setItem("avDuration132054",this.avDuration)
  }
