...
export class S132080Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r132080 = JSON.parse(sessionStorage.getItem("r132080"))
  ...
  submitProgress(e) 
  {
    ...
    sessionStorage.setItem("r132080", JSON.stringify(e))
    this.r132080 = sessionStorage.getItem("r132080")
    console.log(this.r132080)
