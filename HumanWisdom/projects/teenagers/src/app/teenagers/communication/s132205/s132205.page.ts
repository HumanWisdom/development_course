...
@Component({
  selector: 'app-s132205',
  templateUrl: './s132205.page.html',
  styleUrls: ['./s132205.page.scss'],
})
export class S132205Page implements OnInit {
  ...
  transcriptPage="communication/s132205t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime132205",this.totalTime)
    localStorage.setItem("avDuration132205",this.avDuration)
  }
}
