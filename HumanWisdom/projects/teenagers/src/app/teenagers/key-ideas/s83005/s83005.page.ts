...
@Component({
  selector: 'app-s83005',
  templateUrl: './s83005.page.html',
  styleUrls: ['./s83005.page.scss'],
})
export class S83005Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime83005",this.totalTime)
    localStorage.setItem("avDuration83005",this.avDuration)
  }
}