...
@Component({
  selector: 'app-s83010',
  templateUrl: './s83010.page.html',
  styleUrls: ['./s83010.page.scss'],
})
export class S83010Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime83010",this.totalTime)
    localStorage.setItem("avDuration83010",this.avDuration)
  }
}