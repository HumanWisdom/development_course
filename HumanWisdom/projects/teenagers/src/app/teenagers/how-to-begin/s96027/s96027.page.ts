...
export class S96027Page implements OnInit {
  ...
  sessionPoints(){
    ...
    "ScreenNos":"96002,96003,96004,96005,96006,96007,96008,96009,96010,96011,96012,96013,96014,96015,96016,96017,96018,96019,96020,96021,96022,96023,96024,96025,96026"})
    .subscribe(res=>
  ...
  submitProgress(){
    this.router.navigate(['/teenagers/how-to-begin/s96028'])
