...
@Component({
  selector: 'app-s105108',
  templateUrl: './s105108.page.html',
  styleUrls: ['./s105108.page.scss'],
})
export class S105108Page implements OnInit,OnDestroy 
{
  ...
  prev()
  {
    this.router.navigate(['/teenagers/conditioning/s105107'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime105108",this.totalTime)
    localStorage.setItem("avDuration105108",this.avDuration)
  }
