...
@Component({
  ...
  templateUrl: './s105001.page.html',
  styleUrls: ['./s105001.page.scss'],
})
export class S105001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/105.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
