...
@Component({
  selector: 'app-s105048',
  templateUrl: './s105048.page.html',
  styleUrls: ['./s105048.page.scss'],
})
export class S105048Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime105048",this.totalTime)
    localStorage.setItem("avDuration105048",this.avDuration)
  }
