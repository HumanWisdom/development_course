...
@Component({
  selector: 'app-s105135',
  templateUrl: './s105135.page.html',
  styleUrls: ['./s105135.page.scss'],
})
export class S105135Page implements OnInit 
{
  ...
  reflection: any
  reflectionA: any
  r105135 = JSON.parse(sessionStorage.getItem("r105135"))
  ...
  submitProgress() 
  {
    ...
    sessionStorage.setItem("r105135", this.r105135)
    this.r105135 = sessionStorage.getItem("r105135")
    console.log(this.r105135)
    if (this.r105135 != "undefined") 
    {
