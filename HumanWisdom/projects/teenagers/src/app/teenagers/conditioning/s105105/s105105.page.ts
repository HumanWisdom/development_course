...
@Component({
  selector: 'app-s105105',
  templateUrl: './s105105.page.html',
  styleUrls: ['./s105105.page.scss'],
})
export class S105105Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime105105",this.totalTime)
    localStorage.setItem("avDuration105105",this.avDuration)
  }
