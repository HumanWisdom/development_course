...
@Component({
  selector: 'app-s105072',
  templateUrl: './s105072.page.html',
  styleUrls: ['./s105072.page.scss'],
})
export class S105072Page implements OnInit,OnDestroy 
{
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/conditioning/s105073'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime105072",this.totalTime)
    localStorage.setItem("avDuration105072",this.avDuration)
  }
