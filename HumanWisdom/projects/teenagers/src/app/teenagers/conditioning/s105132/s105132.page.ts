...
@Component({
  selector: 'app-s105132',
  templateUrl: './s105132.page.html',
  styleUrls: ['./s105132.page.scss'],
})
export class S105132Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(105132,105132,105132)";
