...
@Component({
  selector: 'app-s105104',
  templateUrl: './s105104.page.html',
  styleUrls: ['./s105104.page.scss'],
})
export class S105104Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime105104",this.totalTime)
    localStorage.setItem("avDuration105104",this.avDuration)
  }
