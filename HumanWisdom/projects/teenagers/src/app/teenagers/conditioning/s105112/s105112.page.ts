...
@Component({
  selector: 'app-s105112',
  templateUrl: './s105112.page.html',
  styleUrls: ['./s105112.page.scss'],
})
export class S105112Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    console.log(this.sendOption,this.sessionOption105112)
    if(this.sessionOption105112==null)
    {
      this.sessionOption105112=[]
      this.sendOption=[]
    }
    this.createScreen()
  ...
  {
    if(this.optionList && this.sessionOption105112) 
    {
      this.optionList.forEach((d) => {
        if(this.sessionOption105112.includes(d['OptId'])) {
  ...
  selectOption(id,e, divid)
  {
    ...
    sessionStorage.setItem("sessionOption105112",JSON.stringify(this.sendOption))
  }
  ...
  {
    if(this.sessionOption105112.includes(id))
    {
      // document.getElementById(divid).style.backgroundColor = '#FFC455';
      return true
    }
