...
@Component({
  selector: 'app-s105078t',
  templateUrl: './s105078t.page.html',
  styleUrls: ['./s105078t.page.scss'],
})
export class S105078tPage implements OnInit 
{
  ...
  audioPage="/teenagers/conditioning/s105078"
  ...
  avDuration=localStorage.getItem("avDuration105078")
  totalTime=localStorage.getItem("totalTime105078")
