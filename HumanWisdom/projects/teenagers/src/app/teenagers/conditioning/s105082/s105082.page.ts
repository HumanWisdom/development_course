...
@Component({
  selector: 'app-s105082',
  templateUrl: './s105082.page.html',
  styleUrls: ['./s105082.page.scss'],
})
export class S105082Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime105082",this.totalTime)
    localStorage.setItem("avDuration105082",this.avDuration)
  }
