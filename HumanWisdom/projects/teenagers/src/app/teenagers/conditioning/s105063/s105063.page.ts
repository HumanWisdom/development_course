...
@Component({
  selector: 'app-s105063',
  templateUrl: './s105063.page.html',
  styleUrls: ['./s105063.page.scss'],
})
export class S105063Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime105063",this.totalTime)
    localStorage.setItem("avDuration105063",this.avDuration)
  }
