...
@Component({
  selector: 'app-s81014',
  templateUrl: './s81014.page.html',
  styleUrls: ['./s81014.page.scss'],
})
export class S81014Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark81014"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark81014"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark81014",JSON.stringify(this.bookmark))
  }
