...
@Component({
  selector: 'app-s81016',
  templateUrl: './s81016.page.html',
  styleUrls: ['./s81016.page.scss'],
})
export class S81016Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark81016"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark81016"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark81016",JSON.stringify(this.bookmark))
  }
