...
@Component({
  selector: 'app-s81015',
  templateUrl: './s81015.page.html',
  styleUrls: ['./s81015.page.scss'],
})
export class S81015Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark81015"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark81015"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark81015",JSON.stringify(this.bookmark))
  }
