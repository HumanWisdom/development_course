...
@Component({
  selector: 'app-s81001',
  templateUrl: './s81001.page.html',
  styleUrls: ['./s81001.page.scss'],
})
export class S81001Page implements OnInit,OnDestroy {
  ...
  { 
    this.service.setmoduleID(81);
    this.service.getModulebyId(81).subscribe(res=>{
      this.moduleData=res;
