...
@Component({
  selector: 'app-s78003p0',
  templateUrl: './s78003p0.page.html',
  styleUrls: ['./s78003p0.page.scss'],
})
export class S78003p0Page implements OnInit,OnDestroy {
...
ngOnInit() {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark78003p0"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark78003p0"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark78003p0",JSON.stringify(this.bookmark))
  }
createScreen(){
