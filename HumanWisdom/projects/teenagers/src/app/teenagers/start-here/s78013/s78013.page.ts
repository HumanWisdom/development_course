...
@Component({
  selector: 'app-s78013',
  templateUrl: './s78013.page.html',
  styleUrls: ['./s78013.page.scss'],
})
export class S78013Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(78013,78013,78013)";
    ...
    this.q1 = this.findQuestion(132).Question
    this.optionList1 = this.findQuestion(132).optionList
    this.q2 = this.findQuestion(133).Question
    this.optionList2 = this.findQuestion(133).optionList

    this.q4 = this.findQuestion(134).Question
    this.optionList4 = this.findQuestion(134).optionList
    this.q5 = this.findQuestion(135).Question
    this.optionList5 = this.findQuestion(135).optionList
    this.q6 = this.findQuestion(136).Question
    this.optionList6 = this.findQuestion(136).optionList
  ...
  submitProgress() {
    ...
    this.router.navigate(['/teenagers/start-here/s78014'])
  ...
  prev() {
    this.router.navigate(['/teenagers/start-here/s78012'])
