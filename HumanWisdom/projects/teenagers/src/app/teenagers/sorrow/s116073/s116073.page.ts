...
@Component({
  selector: 'app-s116073-audio',
  templateUrl: './s116073.page.html',
  styleUrls: ['./s116073.page.scss'],
})
export class S116073Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime116073",this.totalTime)
    localStorage.setItem("avDuration116073",this.avDuration)
  }
}
