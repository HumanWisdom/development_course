...
@Component({
  selector: 'app-s116072-audio',
  templateUrl: './s116072.page.html',
  styleUrls: ['./s116072.page.scss'],
})
export class S116072Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/teenagers/modules/sorrow/audios/1.1.mp3'
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime116072",this.totalTime)
    localStorage.setItem("avDuration116072",this.avDuration)
  }
}
