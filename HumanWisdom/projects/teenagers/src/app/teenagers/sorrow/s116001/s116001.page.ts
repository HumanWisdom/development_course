...
@Component({
  selector: 'app-s116001',
  templateUrl: './s116001.page.html',
  styleUrls: ['./s116001.page.scss'],
})
export class S116001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/116.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
