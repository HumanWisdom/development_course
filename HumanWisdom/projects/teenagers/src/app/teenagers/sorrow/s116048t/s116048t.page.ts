...
@Component({
  selector: 'app-s116048t',
  templateUrl: './s116048t.page.html',
  styleUrls: ['./s116048t.page.scss'],
})
export class S116048tPage implements OnInit {
  ...
  audioPage="/teenagers/sorrow/s116048"
  ...
  avDuration=localStorage.getItem("avDuration116048")
  totalTime=localStorage.getItem("totalTime116048")
