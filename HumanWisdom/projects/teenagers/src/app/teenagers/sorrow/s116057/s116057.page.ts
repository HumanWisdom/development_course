...
@Component({
  selector: 'app-s116057-audio',
  templateUrl: './s116057.page.html',
  styleUrls: ['./s116057.page.scss'],
})
export class S116057Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime116057",this.totalTime)
    localStorage.setItem("avDuration116057",this.avDuration)
  }
}
