...
@Component({
  selector: 'app-s116109',
  templateUrl: './s116109.page.html',
  styleUrls: ['./s116109.page.scss'],
})
export class S116109Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r116109 = JSON.parse(sessionStorage.getItem("r116109"))
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r116109", this.r116109)
    this.r116109 = sessionStorage.getItem("r116109")
    console.log(this.r116109)
