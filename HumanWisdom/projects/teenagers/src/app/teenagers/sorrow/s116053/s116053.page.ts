...
@Component({
  selector: 'app-s116053',
  templateUrl: './s116053.page.html',
  styleUrls: ['./s116053.page.scss'],
})
export class S116053Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime116053",this.totalTime)
    localStorage.setItem("avDuration116053",this.avDuration)
  }
}
