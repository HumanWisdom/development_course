...
@Component({
  selector: 'app-s138001',
  templateUrl: './s138001.page.html',
  styleUrls: ['./s138001.page.scss'],
})
export class S138001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/138.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    this.service.clickModule(138,this.userId).subscribe(res=>
      {
