...
@Component({
  selector: 'app-s138089-audio',
  templateUrl: './s138089.page.html',
  styleUrls: ['./s138089.page.scss'],
})

export class S138089Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="social-media/s138089t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime138089",this.totalTime)
    localStorage.setItem("avDuration138089",this.avDuration)
  }
