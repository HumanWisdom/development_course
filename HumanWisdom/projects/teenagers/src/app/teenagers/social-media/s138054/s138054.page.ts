...
@Component({
  selector: 'app-s138054-audio',
  templateUrl: './s138054.page.html',
  styleUrls: ['./s138054.page.scss'],
})

export class S138054Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="social-media/s138054t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime138054",this.totalTime)
    localStorage.setItem("avDuration138054",this.avDuration)
  }
