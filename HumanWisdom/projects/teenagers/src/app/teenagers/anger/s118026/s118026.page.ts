...
@Component({
  selector: 'app-s118026-audio',
  templateUrl: './s118026.page.html',
  styleUrls: ['./s118026.page.scss'],
})
export class S118026Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime118026",this.totalTime)
    localStorage.setItem("avDuration118026",this.avDuration)
  }
