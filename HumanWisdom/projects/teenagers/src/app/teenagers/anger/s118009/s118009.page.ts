...
@Component({
  selector: 'app-s118009',
  templateUrl: './s118009.page.html',
  styleUrls: ['./s118009.page.scss'],
})
export class S118009Page implements OnInit 
{
  bg_tn="bg_red_pink"
  bg_cft="bg_red_pink"
  bg="red_pink_w7"
  ...
  prev()
  {
    ...
    this.router.navigate(['/anger/s118008'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime118009",this.totalTime)
    localStorage.setItem("avDuration118009",this.avDuration)
  }
