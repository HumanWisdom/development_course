...
@Component({
  selector: 'app-s118040',
  templateUrl: './s118040.page.html',
  styleUrls: ['./s118040.page.scss'],
})
export class S118040Page implements OnInit,OnDestroy 
{
  bg_tn="bg_red_pink"
  bg_cft="bg_red_pink"
  bg="red_pink_w7"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/anger/s118041'])
  ...
  prev()
  {
    this.router.navigate(['/anger/s118039'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime118040",this.totalTime)
    localStorage.setItem("avDuration118040",this.avDuration)
  }
