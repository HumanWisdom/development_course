...
@Component({
  selector: 'app-s118091',
  templateUrl: './s118091.page.html',
  styleUrls: ['./s118091.page.scss'],
})
export class S118091Page implements OnInit,OnDestroy 
{
  bg_tn="bg_red_pink"
  bg_cft="bg_red_pink"
  bg="red_pink_w4"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime118091",this.totalTime)
    localStorage.setItem("avDuration118091",this.avDuration)
  }
