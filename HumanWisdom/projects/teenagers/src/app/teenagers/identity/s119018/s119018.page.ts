...
@Component({
  selector: 'app-s119018',
  templateUrl: './s119018.page.html',
  styleUrls: ['./s119018.page.scss'],
})

export class S119018Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w2" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime119018",this.totalTime)
    localStorage.setItem("avDuration119018",this.avDuration)
  }
