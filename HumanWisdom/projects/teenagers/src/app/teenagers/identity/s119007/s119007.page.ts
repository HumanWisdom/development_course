...
@Component({
  selector: 'app-s119007',
  templateUrl: './s119007.page.html',
  styleUrls: ['./s119007.page.scss'],
})

export class S119007Page implements OnInit,OnDestroy 
{
  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w2" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime119007",this.totalTime)
    localStorage.setItem("avDuration119007",this.avDuration)
  }
