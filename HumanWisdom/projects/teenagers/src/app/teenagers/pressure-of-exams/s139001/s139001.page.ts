...
export class S139001Page implements OnInit,OnDestroy {
  ...
  t:any
  pgResume: any;
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/139.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    this.service.clickModule(139,this.userId).subscribe(res=>
      {
