...
export class S139046Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r139046 = JSON.parse(sessionStorage.getItem("r139046"))
  shared: any
  confirmed: any
  ...
  submitProgress(e) 
  {
    ...
    sessionStorage.setItem("r139046", JSON.stringify(e))
    this.r139046 = sessionStorage.getItem("r139046")
    console.log(this.r139046)
