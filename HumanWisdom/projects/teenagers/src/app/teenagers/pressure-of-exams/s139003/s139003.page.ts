...
@Component({
  selector: 'app-s139003',
  templateUrl: './s139003.page.html',
  styleUrls: ['./s139003.page.scss'],
})
export class S139003Page implements OnInit 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="pressure-of-exams/s139003t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime139003",this.totalTime)
    localStorage.setItem("avDuration139003",this.avDuration)
  }
