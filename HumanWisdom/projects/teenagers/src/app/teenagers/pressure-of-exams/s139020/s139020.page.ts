...
@Component({
  selector: 'app-s139020',
  templateUrl: './s139020.page.html',
  styleUrls: ['./s139020.page.scss'],
})
export class S139020Page implements OnInit {
 ...
 ngOnInit() {
  ...
  // /multistep wizard
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark139020"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark139020"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark139020",JSON.stringify(this.bookmark))
  }
createScreen(){
