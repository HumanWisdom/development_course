...
@Component({
  selector: 'app-s139021',
  templateUrl: './s139021.page.html',
  styleUrls: ['./s139021.page.scss'],
})
export class S139021Page implements OnInit {
 ...
 ngOnInit() {
  ...
  // /multistep wizard
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark139021"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark139021"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark139021",JSON.stringify(this.bookmark))
  }
createScreen(){
  ...
  prev(){
    ...
    this.router.navigate(['/teenagers/pressure-of-exams/s139020'])
