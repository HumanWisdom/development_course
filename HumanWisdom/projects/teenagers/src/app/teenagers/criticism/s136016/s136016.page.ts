...
@Component({
  selector: 'app-s136016',
  templateUrl: './s136016.page.html',
  styleUrls: ['./s136016.page.scss'],
})
export class S136016Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark136016"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark136016"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark136016",JSON.stringify(this.bookmark))
  }
