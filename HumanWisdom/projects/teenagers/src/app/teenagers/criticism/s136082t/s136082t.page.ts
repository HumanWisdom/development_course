...
@Component({
  selector: 'app-s136082t',
  templateUrl: './s136082t.page.html',
  styleUrls: ['./s136082t.page.scss'],
})
export class S136082tPage implements OnInit {
  ...
  audioPage="/teenagers/criticism/s136082"
  ...
  avDuration=localStorage.getItem("avDuration136082")
  totalTime=localStorage.getItem("totalTime136082")
