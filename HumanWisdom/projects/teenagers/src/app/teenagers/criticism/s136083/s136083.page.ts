...
@Component({
  selector: 'app-s136083',
  templateUrl: './s136083.page.html',
  styleUrls: ['./s136083.page.scss'],
})
export class S136083Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s136083t"
  ...
  submitProgress() {
    ...
    this.router.navigate(['/criticism/s136084'])
  ...
  ngOnDestroy() {
    localStorage.setItem("totalTime136083", this.totalTime)
    localStorage.setItem("avDuration136083", this.avDuration)
  }
