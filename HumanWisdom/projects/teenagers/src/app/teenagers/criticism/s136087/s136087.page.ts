...
@Component({
  selector: 'app-s136087',
  templateUrl: './s136087.page.html',
  styleUrls: ['./s136087.page.scss'],
})
export class S136087Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s136087t"
  ...
  ngOnDestroy() {
    localStorage.setItem("totalTime136087", this.totalTime)
    localStorage.setItem("avDuration136087", this.avDuration)
  }
