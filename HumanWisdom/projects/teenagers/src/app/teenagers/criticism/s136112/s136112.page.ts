...
export class S136112Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r136112=JSON.parse(sessionStorage.getItem("r136112"))
  r136112 = sessionStorage.getItem("r136112") !== 'null' ? sessionStorage.getItem("r136112") : '';
  ...
  prev() {
    this.router.navigate(['/teenagers/criticism/s136111'])
  }
