...
@Component({
  selector: 'app-s136017',
  templateUrl: './s136017.page.html',
  styleUrls: ['./s136017.page.scss'],
})
export class S136017Page implements OnInit {
...
avDuration:any
transcriptPage="/criticism/s136017t"
...
submitProgress()
{
  ...
  this.router.navigate(['/criticism/s136018'])
...
prev()
{
  this.router.navigate(['/criticism/s136016'])
}

ngOnDestroy()
{
  localStorage.setItem("totalTime136017",this.totalTime)
  localStorage.setItem("avDuration136017",this.avDuration)
}
