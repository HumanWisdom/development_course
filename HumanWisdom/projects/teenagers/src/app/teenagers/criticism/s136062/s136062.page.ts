...
@Component({
  selector: 'app-s136062',
  templateUrl: './s136062.page.html',
  styleUrls: ['./s136062.page.scss'],
})
export class S136062Page implements OnInit {
  ...
  avDuration:any
  transcriptPage="/criticism/s136062t"
...
createScreen(){
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime136062",this.totalTime)
    localStorage.setItem("avDuration136062",this.avDuration)
