...
@Component({
  selector: 'app-s136034t',
  templateUrl: './s136034t.page.html',
  styleUrls: ['./s136034t.page.scss'],
})
export class S136034tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration136034")
  totalTime=localStorage.getItem("totalTime136034")
