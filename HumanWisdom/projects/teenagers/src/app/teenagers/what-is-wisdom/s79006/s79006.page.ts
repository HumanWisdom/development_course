...
@Component({
  selector: 'app-s79006',
  templateUrl: './s79006.page.html',
  styleUrls: ['./s79006.page.scss'],
})
export class S79006Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/modules/what-is-wisdom/audios/1.1.mp3'

  transcriptPage="what-is-wisdom/s79006t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime79006",this.totalTime)
    localStorage.setItem("avDuration79006",this.avDuration)
  }
}