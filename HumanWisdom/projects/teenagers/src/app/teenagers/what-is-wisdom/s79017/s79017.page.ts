...
@Component({
  selector: 'app-s79017',
  templateUrl: './s79017.page.html',
  styleUrls: ['./s79017.page.scss'],
})
export class S79017Page implements OnInit,OnDestroy {
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/what-is-wisdom/s79018'])
