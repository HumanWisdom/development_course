...
@Component({
  selector: 'app-s160066t',
  templateUrl: './s160066t.page.html',
  styleUrls: ['./s160066t.page.scss'],
})

export class S160066tPage implements OnInit 
{
  ...
  audioPage="/teenagers/career-success/s160066"
  ...
  avDuration=localStorage.getItem("avDuration160066")
  totalTime=localStorage.getItem("totalTime160066")
