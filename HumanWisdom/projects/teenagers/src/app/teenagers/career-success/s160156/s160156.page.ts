...
@Component({
  selector: 'app-s160156',
  templateUrl: './s160156.page.html',
  styleUrls: ['./s160156.page.scss'],
})
export class S160156Page implements OnInit {
  ...
  progressPercent:any
  progressText="6/9"
  link="/teenagers/career-success/s160157"
  name="#7 What gets in the way of thinking clearly"
  progressImg=""
