...
@Component({
  selector: 'app-s160152',
  templateUrl: './s160152.page.html',
  styleUrls: ['./s160152.page.scss'],
})
export class S160152Page implements OnInit {
  ...
  progressPercent:any
  progressText="5/9"
  link="/teenagers/career-success/s160153"
  name="#6 What is a successful career"
  progressImg=""
