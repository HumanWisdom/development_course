...
@Component({
  selector: 'app-s160166',
  templateUrl: './s160166.page.html',
  styleUrls: ['./s160166.page.scss'],
})
export class S160166Page implements OnInit,OnDestroy {
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/teenagers/career-success/s160167'])
