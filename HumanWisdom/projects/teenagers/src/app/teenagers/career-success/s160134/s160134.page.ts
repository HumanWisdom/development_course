...
@Component({
  selector: 'app-s160134-audio',
  templateUrl: './s160134.page.html',
  styleUrls: ['./s160134.page.scss'],
})

export class S160134Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime160134",this.totalTime)
    localStorage.setItem("avDuration160134",this.avDuration)
  }
