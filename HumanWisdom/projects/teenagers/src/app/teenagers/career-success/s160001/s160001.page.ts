...
@Component({
  selector: 'app-s160001',
  templateUrl: './s160001.page.html',
  styleUrls: ['./s160001.page.scss'],
})
export class S160001Page implements OnInit,OnDestroy {
