...
@Component({
  selector: 'app-s160044-audio',
  templateUrl: './s160044.page.html',
  styleUrls: ['./s160044.page.scss'],
})

export class S160044Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime160044",this.totalTime)
    localStorage.setItem("avDuration160044",this.avDuration)
  }
