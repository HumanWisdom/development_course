...
@Component({
  selector: 'app-s160081-audio',
  templateUrl: './s160081.page.html',
  styleUrls: ['./s160081.page.scss'],
})

export class S160081Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime160081",this.totalTime)
    localStorage.setItem("avDuration160081",this.avDuration)
  }
