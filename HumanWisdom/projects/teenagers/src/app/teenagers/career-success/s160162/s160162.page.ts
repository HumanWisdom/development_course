...
@Component({
  selector: 'app-s160162',
  templateUrl: './s160162.page.html',
  styleUrls: ['./s160162.page.scss'],
})
export class S160162Page implements OnInit,OnDestroy {

  bg_tn="bg_dark_blue"
  bg_cft="bg_dark_blue"
  bg="dark_blue_w1"
   mediaVideo=JSON.parse(localStorage.getItem("mediaVideo"))
  videoLink=this.mediaVideo+'/teenagers/modules/career-success/videos/8.1.mp4'  
  title="In this video we explore the life skills we need to develop to succeed at work/"
