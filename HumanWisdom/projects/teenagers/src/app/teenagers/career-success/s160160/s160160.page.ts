...
@Component({
  selector: 'app-s160160',
  templateUrl: './s160160.page.html',
  styleUrls: ['./s160160.page.scss'],
})
export class S160160Page implements OnInit {
  ...
  progressPercent:any
  progressText="7/9"
  link="/teenagers/career-success/s160161"
  name="#8  Life skills you need for work"
  progressImg=""
