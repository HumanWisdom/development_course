...
@Component({
  selector: 'HumanWisdom-s160005',
  templateUrl: './s160005.page.html',
  styleUrls: ['./s160005.page.scss'],
})
export class S160005Page implements OnInit {
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/career-success/s160004'])
  }
