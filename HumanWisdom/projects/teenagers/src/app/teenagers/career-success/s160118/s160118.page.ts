...
@Component({
  selector: 'app-s160118-audio',
  templateUrl: './s160118.page.html',
  styleUrls: ['./s160118.page.scss'],
})

export class S160118Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime160118",this.totalTime)
    localStorage.setItem("avDuration160118",this.avDuration)
  }
