...
@Component({
  selector: 'app-s133053',
  templateUrl: './s133053.page.html',
  styleUrls: ['./s133053.page.scss'],
})
export class S133053Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r133053 = JSON.parse(sessionStorage.getItem("r133053"))
