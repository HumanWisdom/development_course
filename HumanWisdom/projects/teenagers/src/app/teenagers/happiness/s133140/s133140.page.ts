...
@Component({
  selector: 'app-s133140',
  templateUrl: './s133140.page.html',
  styleUrls: ['./s133140.page.scss'],
})
export class S133140Page implements OnInit {
  ...
  transcriptPage="happiness/s133140t"
  ...
  prev()
  {
    this.router.navigate(['/teenagers/happiness/s133139'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime133140",this.totalTime)
    localStorage.setItem("avDuration133140",this.avDuration)
  }
