...
@Component({
  selector: 'app-s133007',
  templateUrl: './s133007.page.html',
  styleUrls: ['./s133007.page.scss'],
})
export class S133007Page implements OnInit {
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark133007",JSON.stringify(this.bookmark))
  }
createScreen(){
  ...
  prev(){
    ...
    this.router.navigate(['/teenagers/happiness/s133006'])
