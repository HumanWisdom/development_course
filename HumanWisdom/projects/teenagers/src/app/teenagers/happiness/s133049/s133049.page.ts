...
@Component({
  selector: 'app-s133049',
  templateUrl: './s133049.page.html',
  styleUrls: ['./s133049.page.scss'],
})
export class S133049Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime133049",this.totalTime)
    localStorage.setItem("avDuration133049",this.avDuration)
  }
