...
@Component({
  selector: 'app-s133008',
  templateUrl: './s133008.page.html',
  styleUrls: ['./s133008.page.scss'],
})
export class S133008Page implements OnInit {
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark133008",JSON.stringify(this.bookmark))
  }
createScreen(){
