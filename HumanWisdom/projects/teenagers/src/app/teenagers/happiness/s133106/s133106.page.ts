...
@Component({
  selector: 'app-s133106',
  templateUrl: './s133106.page.html',
  styleUrls: ['./s133106.page.scss'],
})
export class S133106Page implements OnInit 
{
  bg_tn="bg_red_pink"
  bg_cft="bg_red_pink"
  bg="red_pink_w8"
  ...
  transcriptPage="happiness/s133106t"
  userId:any
  ...
  prev()
  {
    ...
    this.router.navigate(['/happiness/s133105'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime133106",this.totalTime)
    localStorage.setItem("avDuration133106",this.avDuration)
  }
