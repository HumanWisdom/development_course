...
@Component({
  selector: 'app-s23083',
  templateUrl: './s23083.page.html',
  styleUrls: ['./s23083.page.scss'],
})
export class S23083Page implements OnInit {
  ...
  transcriptPage="happiness/s23083t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime23083",this.totalTime)
    localStorage.setItem("avDuration23083",this.avDuration)
  }
}