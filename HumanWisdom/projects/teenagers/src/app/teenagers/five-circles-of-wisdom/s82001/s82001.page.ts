...
@Component({
  selector: 'app-s82001',
  templateUrl: './s82001.page.html',
  styleUrls: ['./s82001.page.scss'],
})
export class S82001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/5circles_of_wisdom.jpg"
  tocColor="white"
