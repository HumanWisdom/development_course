...
@Component({
  selector: 'app-s102001',
  templateUrl: './s102001.page.html',
  styleUrls: ['./s102001.page.scss'],
})
export class S102001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/102.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
