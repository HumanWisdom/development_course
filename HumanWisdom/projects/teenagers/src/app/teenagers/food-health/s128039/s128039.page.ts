...
@Component({
  selector: 'app-s128039',
  templateUrl: './s128039.page.html',
  styleUrls: ['./s128039.page.scss'],
})
export class S128039Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w4"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime128039",this.totalTime)
    localStorage.setItem("avDuration128039",this.avDuration)
  }
