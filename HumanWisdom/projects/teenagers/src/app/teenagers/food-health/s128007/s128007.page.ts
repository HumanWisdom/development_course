...
@Component({
  selector: 'app-s128007',
  templateUrl: './s128007.page.html',
  styleUrls: ['./s128007.page.scss'],
})
export class S128007Page implements OnInit, OnDestroy {
  ...
  ngOnInit() 
  {
    ...
    if (JSON.parse(sessionStorage.getItem("bookmark128007")) == 0)
      this.bookmark = 0
  ...
  receiveBookmark(e) 
  {
    ...
    if (e == true)
      ...
      this.bookmark = 0
    sessionStorage.setItem("bookmark128007", JSON.stringify(this.bookmark))
  }
