...
@Component({
  selector: 'app-s128075',
  templateUrl: './s128075.page.html',
  styleUrls: ['./s128075.page.scss'],
})
export class S128075Page implements OnInit 
{
  ...
  submitProgress() 
  {
    ...
    this.router.navigate(['/teenagers/food-health/s128076'])
  ...
  prev() 
  {
    this.router.navigate(['/teenagers/food-health/s128074'])
  }
