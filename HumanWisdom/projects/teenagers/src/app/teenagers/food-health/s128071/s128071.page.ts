...
@Component({
  selector: 'app-s128071',
  templateUrl: './s128071.page.html',
  styleUrls: ['./s128071.page.scss'],
})

export class S128071Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w11" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime128071",this.totalTime)
    localStorage.setItem("avDuration128071",this.avDuration)
  }
