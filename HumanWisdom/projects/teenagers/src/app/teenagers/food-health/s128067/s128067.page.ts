...
@Component({
  selector: 'app-s128067',
  templateUrl: './s128067.page.html',
  styleUrls: ['./s128067.page.scss'],
})

export class S128067Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w2" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime128067",this.totalTime)
    localStorage.setItem("avDuration128067",this.avDuration)
  }
