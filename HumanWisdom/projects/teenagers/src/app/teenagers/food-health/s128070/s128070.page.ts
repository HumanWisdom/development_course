...
@Component({
  selector: 'app-s128070',
  templateUrl: './s128070.page.html',
  styleUrls: ['./s128070.page.scss'],
})

export class S128070Page implements OnInit,OnDestroy 
{
  bg_tn="bg_green"
  bg_cft="bg_green"
  bg="green_w11" 
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime128070",this.totalTime)
    localStorage.setItem("avDuration128070",this.avDuration)
  }
