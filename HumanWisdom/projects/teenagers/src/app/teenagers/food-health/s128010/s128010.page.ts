...
@Component({
  selector: 'app-s128010',
  templateUrl: './s128010.page.html',
  styleUrls: ['./s128010.page.scss'],
})
export class S128010Page implements OnInit {
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime128010",this.totalTime)
    localStorage.setItem("avDuration128010",this.avDuration)
