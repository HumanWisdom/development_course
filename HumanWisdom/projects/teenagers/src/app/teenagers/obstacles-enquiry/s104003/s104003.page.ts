...
@Component({
  selector: 'app-s104003-audio',
  templateUrl: './s104003.page.html',
  styleUrls: ['./s104003.page.scss'],
})
export class S104003Page implements OnInit,OnDestroy {
  ...
  prev()
  {
    this.router.navigate(['/teenagers/obstacles-enquiry/s104002'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime104003",this.totalTime)
    localStorage.setItem("avDuration104003",this.avDuration)
  }
