...
export class S104001Page implements OnInit,OnDestroy {
  ...
  t:any
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/104.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    else
    {
     ...
     // continue where you left    
    this.service.clickModule(104, this.userId).subscribe(res => {
