...
@Component({
  selector: 'app-s104021t',
  templateUrl: './s104021t.page.html',
  styleUrls: ['./s104021t.page.scss'],
})
export class S104021tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration104021")
  totalTime=localStorage.getItem("totalTime104021")
  ...
  ngOnInit() {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark104021"))==0)
    this.bookmark=0
