...
@Component({
  selector: 'app-s99014',
  templateUrl: './s99014.page.html',
  styleUrls: ['./s99014.page.scss'],
})
export class S99014Page implements OnInit,OnDestroy {
...
createScreen(){
  ...
  submitProgress(){
    ...
    this.service.submitProgressText({
      ...
      ()=>{
        //this.router.navigate(['/conditioning/s2399014'])
      })
  ...
  prev(){
    this.router.navigate(['/teenagers/insight/s99013'])
