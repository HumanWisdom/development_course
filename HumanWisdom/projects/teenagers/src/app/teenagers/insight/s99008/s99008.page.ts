...
@Component({
  selector: 'app-s99008-audio',
  templateUrl: './s99008.page.html',
  styleUrls: ['./s99008.page.scss'],
})
export class S99008Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/modules/insight/audios/1.3.mp3'
 
  transcriptPage="insight/s99008t"
  ...
  submitProgress(){
    ...
    this.router.navigate(['/teenagers/insight/s99009'])
