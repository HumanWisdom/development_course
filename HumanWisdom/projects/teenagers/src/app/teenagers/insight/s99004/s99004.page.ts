...
@Component({
  selector: 'app-s99004-audio',
  templateUrl: './s99004.page.html',
  styleUrls: ['./s99004.page.scss'],
})
export class S99004Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/modules/insight/audios/1.1.mp3'
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime99004",this.totalTime)
    localStorage.setItem("avDuration99004",this.avDuration)
