...
export class S99013tPage implements OnInit {
  ...
  audioPage="/teenagers/insight/s99013"
  ...
  avDuration=localStorage.getItem("avDuration99013")
  totalTime=localStorage.getItem("totalTime99013")
  ...
  submitProgress(){
    this.router.navigate(['/teenagers/insight/s99014'])
  ...
  prev(){
    this.router.navigate(['/teenagers/insight/s99012'])
  }
