...
@Component({
  selector: 'app-s103001',
  templateUrl: './s103001.page.html',
  styleUrls: ['./s103001.page.scss']
 
})
export class S103001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/103.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    else
    {
     ...
     // continue where you left    
    this.service.clickModule(103, this.userId).subscribe(res => {
