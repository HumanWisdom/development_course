...
@Component({
  selector: 'app-s121019',
  templateUrl: './s121019.page.html',
  styleUrls: ['./s121019.page.scss'],
})

export class S121019Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime121019",this.totalTime)
    localStorage.setItem("avDuration121019",this.avDuration)
  }
