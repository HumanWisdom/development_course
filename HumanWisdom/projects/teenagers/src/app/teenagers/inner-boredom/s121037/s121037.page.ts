...
@Component({
  selector: 'app-s121037',
  templateUrl: './s121037.page.html',
  styleUrls: ['./s121037.page.scss'],
})

export class S121037Page implements OnInit,OnDestroy 
{
  ...
  prev()
  {
    this.router.navigate(['/teenagers/inner-boredom/s121036'])
  }

  ngOnDestroy()
  {
    localStorage.setItem("totalTime121037",this.totalTime)
    localStorage.setItem("avDuration121037",this.avDuration)
  }
