...
@Component({
  selector: 'app-s121001',
  templateUrl: './s121001.page.html',
  styleUrls: ['./s121001.page.scss'],
})
export class S121001Page implements OnInit,OnDestroy {
 ...
 localFreeScreens =localStorage.getItem("freeScreens");
  ...
  t:any
  innerboredomResume=sessionStorage.getItem("innerboredomResume")
   pgResume=sessionStorage.getItem("pgResume")
  tocImage="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/background/toc/teenagers/121.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
   ...
   // continue where you left    
    this.service.clickModule(121, this.userId).subscribe(res => {
