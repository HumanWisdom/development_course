...
@Component({
  selector: 'app-s121041',
  templateUrl: './s121041.page.html',
  styleUrls: ['./s121041.page.scss'],
})

export class S121041Page implements OnInit,OnDestroy 
{
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime121041",this.totalTime)
    localStorage.setItem("avDuration121041",this.avDuration)
  }
