...
@Component({
  selector: 'app-s23164',
  templateUrl: './s23164.page.html',
  styleUrls: ['./s23164.page.scss'],
})
export class S23164Page implements OnInit,OnDestroy {
  ...
  transcriptPage="happiness/s23164t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime23164",this.totalTime)
    localStorage.setItem("avDuration23164",this.avDuration)
