...
@Component({
  selector: 'HumanWisdom-s77076',
  templateUrl: './s77076.page.html',
  styleUrls: ['./s77076.page.scss'],
})
export class S77076Page implements OnInit,OnDestroy {
  ...
  transcriptPage="making-better-decisions/s77076t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77076",this.totalTime)
    localStorage.setItem("avDuration77076",this.avDuration)
  }
}