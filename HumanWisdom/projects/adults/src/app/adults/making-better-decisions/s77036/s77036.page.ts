...
@Component({
  selector: 'HumanWisdom-s77036',
  templateUrl: './s77036.page.html',
  styleUrls: ['./s77036.page.scss'],
})
export class S77036Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark77036"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark77036"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark77036",JSON.stringify(this.bookmark))
  }
