...
@Component({
  selector: 'HumanWisdom-s77045',
  templateUrl: './s77045.page.html',
  styleUrls: ['./s77045.page.scss'],
})
export class S77045Page implements OnInit,OnDestroy {
  ...
  transcriptPage="making-better-decisions/s77045t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77045",this.totalTime)
    localStorage.setItem("avDuration77045",this.avDuration)
  }
}