...
@Component({
  selector: 'HumanWisdom-s77052',
  templateUrl: './s77052.page.html',
  styleUrls: ['./s77052.page.scss'],
})
export class S77052Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/making-better-decisions/audios/making-better-decisions+2.4.mp3'

  transcriptPage="making-better-decisions/s77052t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77052",this.totalTime)
    localStorage.setItem("avDuration77052",this.avDuration)
  }
}