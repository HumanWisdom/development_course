...
@Component({
  selector: 'HumanWisdom-s77031',
  templateUrl: './s77031.page.html',
  styleUrls: ['./s77031.page.scss'],
})
export class S77031Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark77031"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark77031"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark77031",JSON.stringify(this.bookmark))
  }
