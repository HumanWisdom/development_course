...
@Component({
  selector: 'HumanWisdom-s77059',
  templateUrl: './s77059.page.html',
  styleUrls: ['./s77059.page.scss'],
})
export class S77059Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/making-better-decisions/audios/making-better-decisions+2.6.mp3'

  transcriptPage="making-better-decisions/s77059t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77059",this.totalTime)
    localStorage.setItem("avDuration77059",this.avDuration)
  }
}