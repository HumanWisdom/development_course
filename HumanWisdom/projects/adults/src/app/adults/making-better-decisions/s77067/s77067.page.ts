...
@Component({
  selector: 'HumanWisdom-s77067',
  templateUrl: './s77067.page.html',
  styleUrls: ['./s77067.page.scss'],
})
export class S77067Page implements OnInit,OnDestroy {
  ...
  transcriptPage="making-better-decisions/s77067t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77067",this.totalTime)
    localStorage.setItem("avDuration77067",this.avDuration)
  }
}