...
@Component({
  selector: 'HumanWisdom-s77080',
  templateUrl: './s77080.page.html',
  styleUrls: ['./s77080.page.scss'],
})
export class S77080Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/making-better-decisions/audios/making-better-decisions+3.3.mp3'

  transcriptPage="making-better-decisions/s77080t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77080",this.totalTime)
    localStorage.setItem("avDuration77080",this.avDuration)
  }
}