...
@Component({
  selector: 'HumanWisdom-s77003',
  templateUrl: './s77003.page.html',
  styleUrls: ['./s77003.page.scss'],
})
export class S77003Page implements OnInit,OnDestroy {
  ...
  transcriptPage="making-better-decisions/s77003t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77003",this.totalTime)
    localStorage.setItem("avDuration77003",this.avDuration)
  }
}