...
@Component({
  selector: 'HumanWisdom-s77039',
  templateUrl: './s77039.page.html',
  styleUrls: ['./s77039.page.scss'],
})
export class S77039Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/making-better-decisions/audios/making-better-decisions+1.4.mp3'

  transcriptPage="making-better-decisions/s77039t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77039",this.totalTime)
    localStorage.setItem("avDuration77039",this.avDuration)
  }
}