...
@Component({
  selector: 'HumanWisdom-s77061',
  templateUrl: './s77061.page.html',
  styleUrls: ['./s77061.page.scss'],
})
export class S77061Page implements OnInit,OnDestroy {
  ...
  transcriptPage="making-better-decisions/s77061t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime77061",this.totalTime)
    localStorage.setItem("avDuration77061",this.avDuration)
  }
}