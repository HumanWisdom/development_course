...
@Component({
  selector: 'HumanWisdom-s77037',
  templateUrl: './s77037.page.html',
  styleUrls: ['./s77037.page.scss'],
})
export class S77037Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark77037"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark77037"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark77037",JSON.stringify(this.bookmark))
  }
