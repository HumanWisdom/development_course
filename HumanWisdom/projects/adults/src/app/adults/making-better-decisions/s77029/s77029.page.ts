...
@Component({
  selector: 'HumanWisdom-s77029',
  templateUrl: './s77029.page.html',
  styleUrls: ['./s77029.page.scss'],
})
export class S77029Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark77029"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark77029"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark77029",JSON.stringify(this.bookmark))
  }
