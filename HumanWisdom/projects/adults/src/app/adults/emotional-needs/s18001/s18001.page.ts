...
@Component({
  selector: 'app-s18001',
  templateUrl: './s18001.page.html',
  styleUrls: ['./s18001.page.scss'],
})
export class S18001Page implements OnInit,OnDestroy {
  ...
  bookmarkList=[]
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/18.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(18, this.userId).subscribe(res => {
