...
@Component({
  selector: 'app-s53004',
  templateUrl: './s53004.page.html',
  styleUrls: ['./s53004.page.scss'],
})
export class S53004Page implements OnInit,OnDestroy {
  ...
  transcriptPage="communication/s53004t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime53004",this.totalTime)
    localStorage.setItem("avDuration53004",this.avDuration)
