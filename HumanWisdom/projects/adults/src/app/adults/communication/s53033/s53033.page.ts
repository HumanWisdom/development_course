...
@Component({
  selector: 'app-s53033',
  templateUrl: './s53033.page.html',
  styleUrls: ['./s53033.page.scss'],
})
export class S53033Page implements OnInit {
  ...
  transcriptPage="communication/s53033t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime53033",this.totalTime)
    localStorage.setItem("avDuration53033",this.avDuration)
