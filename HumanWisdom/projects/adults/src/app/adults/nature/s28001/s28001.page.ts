...
@Component({
  selector: 'app-s28001',
  templateUrl: './s28001.page.html',
  styleUrls: ['./s28001.page.scss'],
})
export class S28001Page implements OnInit,OnDestroy {
  ...
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/28.jpg"
  tocColor="white"
  lastvisited = false;
  stories: any = []
