...
@Component({
  selector: 'app-s43029p3',
  templateUrl: './s43029p3.page.html',
  styleUrls: ['./s43029p3.page.scss'],
})
export class S43029p3Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r43029p3 = sessionStorage.getItem("r43029p3") !== 'null' ? sessionStorage.getItem("r43029p3") : '';
  ...
  submitProgress() {
    ...
    //this.r43029p3 = sessionStorage.getItem("r43029p3")
    console.log(this.r43029p3)
