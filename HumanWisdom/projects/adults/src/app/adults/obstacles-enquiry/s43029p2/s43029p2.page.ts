...
@Component({
  selector: 'app-s43029p2',
  templateUrl: './s43029p2.page.html',
  styleUrls: ['./s43029p2.page.scss'],
})
export class S43029p2Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r43029p2 = (sessionStorage.getItem("r43029p2"))
  r43029p2 = sessionStorage.getItem("r43029p2") !== 'null' ? sessionStorage.getItem("r43029p2") : '';
