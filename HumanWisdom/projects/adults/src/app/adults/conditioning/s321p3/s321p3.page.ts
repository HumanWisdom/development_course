...
@Component({
  selector: 'app-s321p3',
  templateUrl: './s321p3.page.html',
  styleUrls: ['./s321p3.page.scss'],
})
export class S321p3Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r321p3 = sessionStorage.getItem("r321p3")
  r321p3 = sessionStorage.getItem("r321p3") !== 'null' ? sessionStorage.getItem("r321p3") : '';
