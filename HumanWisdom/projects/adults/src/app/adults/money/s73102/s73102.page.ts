...
@Component({
  selector: 'app-s73102',
  templateUrl: './s73102.page.html',
  styleUrls: ['./s73102.page.scss'],
})
export class S73102Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(73102,73102,73102)";
    ...
    this.q1 = this.findQuestion(278).Question
    this.optionList1 = this.findQuestion(278).optionList
    this.q2 = this.findQuestion(279).Question
    this.optionList2 = this.findQuestion(279).optionList
    this.q3 = this.findQuestion(280).Question
    this.optionList3 = this.findQuestion(280).optionList
    this.q4 = this.findQuestion(281).Question
    this.optionList4 = this.findQuestion(281).optionList
    this.q5 = this.findQuestion(282).Question
    this.optionList5 = this.findQuestion(282).optionList
