...
@Component({
  selector: 'app-s73060-audio',
  templateUrl: './s73060.page.html',
  styleUrls: ['./s73060.page.scss'],
})
export class S73060Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/money/audios/money+2.5.mp3'

  transcriptPage="money/s73060t"
  toc="money/s73001"
  bookmark=0
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime73060",this.totalTime)
    localStorage.setItem("avDuration73060",this.avDuration)
