...
@Component({
  selector: 'app-s26001',
  templateUrl: './s26001.page.html',
  styleUrls: ['./s26001.page.scss'],
})
export class S26001Page implements OnInit,OnDestroy {
  ...
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/26.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  ...
  ngOnInit() {
    ...
    this.service.clickModule(26, this.userId).subscribe(res => {
