...
@Component({
  selector: 'HumanWisdom-s41019p6',
  templateUrl: './s41019p6.page.html',
  styleUrls: ['./s41019p6.page.scss'],
})
export class S41019p6Page implements OnInit {
  ...
  r41019p6 = sessionStorage.getItem("r41019p6") !== 'null' ? sessionStorage.getItem("r41019p6") : '';
