...
@Component({
  selector: 'HumanWisdom-s41019p5',
  templateUrl: './s41019p5.page.html',
  styleUrls: ['./s41019p5.page.scss'],
})
export class S41019p5Page implements OnInit {
  ...
  //r41019p5:any
  r41019p5 = sessionStorage.getItem("r41019p5") !== 'null' ? sessionStorage.getItem("r41019p5") : '';
