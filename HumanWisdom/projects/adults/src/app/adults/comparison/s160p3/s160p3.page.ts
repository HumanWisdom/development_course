...
@Component({
  selector: 'app-s160p3',
  templateUrl: './s160p3.page.html',
  styleUrls: ['./s160p3.page.scss'],
})
export class S160p3Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r160p3 = JSON.parse(sessionStorage.getItem("r160p3"))
  r160p3 = sessionStorage.getItem("r160p3") !== 'null' ? sessionStorage.getItem("r160p3") : '';
  ...
  submitProgress() {
    ...
    //this.r160p3 = sessionStorage.getItem("r160p3")
    console.log(this.r160p3)
    if (this.r160p3 != "undefined") {
