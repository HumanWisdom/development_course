...
export class S27Page implements OnInit 
{
  ...
  selectOption(id,e, divid)
  {
    ...
    if(e==true)
    {
      document.getElementById(divid).style.backgroundColor = '#ED7D6F';  //For adults else teens '#E58D82'
      this.sendOption.push(id)
    }
    else if(e==false)
    {
        document.getElementById(divid).style.backgroundColor = '#FFE8BB'     //For adults else teens:  'rgba(255,255,255,0.1)';
