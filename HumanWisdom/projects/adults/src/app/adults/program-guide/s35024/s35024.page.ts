...
@Component({
  selector: 'app-s35024',
  templateUrl: './s35024.page.html',
  styleUrls: ['./s35024.page.scss'],
})
export class S35024Page implements OnInit,OnDestroy {
  ...
  videoLink=this.mediaVideo+'/program_guide/videos/1.5.mp4'  
  title="Video tour of the app"
  poster="https://humanwisdoms3.s3.eu-west-2.amazonaws.com/assets/images/tiles/video_posters/introduction/introduction_05.jpg"
...
ngOnInit() {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark35024"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark35024"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark35024",JSON.stringify(this.bookmark))
  }
createScreen(){
