...
@Component({
  selector: 'app-s429',
  templateUrl: './s429.page.html',
  styleUrls: ['./s429.page.scss'],
})
export class S429Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r429 = (sessionStorage.getItem("r429"))
  r429 = sessionStorage.getItem("r429") !== 'null' ? sessionStorage.getItem("r429") : '';
