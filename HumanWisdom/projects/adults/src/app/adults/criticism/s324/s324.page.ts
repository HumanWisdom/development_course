...
@Component({
  selector: 'app-s324',
  templateUrl: './s324.page.html',
  styleUrls: ['./s324.page.scss'],
})
export class S324Page implements OnInit,OnDestroy {
  userId:any
  ...
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/16.jpg"
  tocColor="white"
  lastvisited = false;
  stories: any = []
