...
@Component({
  selector: 'app-s47000',
  templateUrl: './s47000.page.html',
  styleUrls: ['./s47000.page.scss'],
})
export class S47000Page implements OnInit,OnDestroy {
  ...
  bookmarkList=[]
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/47.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(47, this.userId).subscribe(res => {
