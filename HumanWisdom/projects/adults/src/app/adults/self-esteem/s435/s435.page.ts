...
@Component({
  selector: 'app-s435',
  templateUrl: './s435.page.html',
  styleUrls: ['./s435.page.scss'],
})
export class S435Page implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    console.log("bm5",JSON.parse(sessionStorage.getItem("bookmark435")))
  ...
  prev(){
    this.router.navigate(['/adults/self-esteem/s434'])
