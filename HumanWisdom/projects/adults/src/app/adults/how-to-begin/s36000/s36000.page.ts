...
@Component({
  selector: 'app-s36000',
  templateUrl: './s36000.page.html',
  styleUrls: ['./s36000.page.scss'],
})
export class S36000Page implements OnInit,OnDestroy {
  ...
  bookmarkList=[]
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/36.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(36, this.userId).subscribe(res => {
