...
@Component({
  selector: 'app-s45062',
  templateUrl: './s45062.page.html',
  styleUrls: ['./s45062.page.scss'],
})
export class S45062Page implements OnInit {
  ...
  transcriptPage="habit-addiction/s45062t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime45062",this.totalTime)
    localStorage.setItem("avDuration45062",this.avDuration)
  }
}
