...
@Component({
  selector: 'app-s45079-audio',
  templateUrl: './s45079.page.html',
  styleUrls: ['./s45079.page.scss'],
})
export class S45079Page implements OnInit,OnDestroy {
 ...
 mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  ...
  transcriptPage="habit-addiction/s45079t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime45079",this.totalTime)
    localStorage.setItem("avDuration45079",this.avDuration)
