...
@Component({
  selector: 'app-s45156',
  templateUrl: './s45156.page.html',
  styleUrls: ['./s45156.page.scss'],
})
export class S45156Page implements OnInit {
  ...
  submitProgress() {
    ...
    sessionStorage.setItem("r45156", this.r45156)
    //this.r45156 = sessionStorage.getItem("r45156")
    console.log(this.r45156)
