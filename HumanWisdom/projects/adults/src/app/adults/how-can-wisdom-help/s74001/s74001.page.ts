...
export class S74001Page implements OnInit,OnDestroy {
  ...
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/74.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  ...
  ngOnInit() 
  {
    ...
    this.service.clickModule(74, this.userId).subscribe(res => {
