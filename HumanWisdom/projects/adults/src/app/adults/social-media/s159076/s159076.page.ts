...
@Component({
  selector: 'app-s159076-audio',
  templateUrl: './s159076.page.html',
  styleUrls: ['./s159076.page.scss'],
})

export class S159076Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="social-media/s159076t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime159076",this.totalTime)
    localStorage.setItem("avDuration159076",this.avDuration)
  }
