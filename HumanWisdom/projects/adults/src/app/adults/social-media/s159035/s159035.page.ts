...
@Component({
  selector: 'app-s159035-audio',
  templateUrl: './s159035.page.html',
  styleUrls: ['./s159035.page.scss'],
})

export class S159035Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="social-media/s159035t"
  ...
  submitProgress()
  {
    ...
    this.router.navigate(['/social-media/s159036'])
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime159035",this.totalTime)
    localStorage.setItem("avDuration159035",this.avDuration)
  }
