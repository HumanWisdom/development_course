...
@Component({
  selector: 'app-s159068-audio',
  templateUrl: './s159068.page.html',
  styleUrls: ['./s159068.page.scss'],
})

export class S159068Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime159068",this.totalTime)
    localStorage.setItem("avDuration159068",this.avDuration)
  }
