...
@Component({
  ...
  templateUrl: './s159113.page.html',
  styleUrls: ['./s159113.page.scss'],
})
export class S159113Page implements OnInit {
 ...
 ngOnInit() {
  ...
  // /multistep wizard
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark159113"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark159113"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark159113",JSON.stringify(this.bookmark))
  }
createScreen(){
