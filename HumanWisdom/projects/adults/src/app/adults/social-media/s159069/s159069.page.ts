...
@Component({
  selector: 'app-s159069-audio',
  templateUrl: './s159069.page.html',
  styleUrls: ['./s159069.page.scss'],
})

export class S159069Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="social-media/s159069t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime159069",this.totalTime)
    localStorage.setItem("avDuration159069",this.avDuration)
  }
