...
@Component({
  selector: 'app-s159120',
  templateUrl: './s159120.page.html',
  styleUrls: ['./s159120.page.scss'],
})
export class S159120Page implements OnInit {
 ...
 ngOnInit() {
  ...
  // /multistep wizard
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark159120"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark159120"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark159120",JSON.stringify(this.bookmark))
  }
createScreen(){
