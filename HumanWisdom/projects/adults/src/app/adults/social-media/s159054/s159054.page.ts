...
@Component({
  selector: 'app-s159054-audio',
  templateUrl: './s159054.page.html',
  styleUrls: ['./s159054.page.scss'],
})

export class S159054Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime159054",this.totalTime)
    localStorage.setItem("avDuration159054",this.avDuration)
  }
