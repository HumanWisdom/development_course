...
@Component({
  selector: 'app-s159058-audio',
  templateUrl: './s159058.page.html',
  styleUrls: ['./s159058.page.scss'],
})

export class S159058Page implements OnInit,OnDestroy 
{
  bg_tn=""
  bg_cft=""
  bg=""
  ...
  transcriptPage="social-media/s159058t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime159058",this.totalTime)
    localStorage.setItem("avDuration159058",this.avDuration)
  }
