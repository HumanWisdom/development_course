...
@Component({
  ...
  styleUrls: ['./s159121.page.scss'],
})
export class S159121Page implements OnInit {
 ...
 ngOnInit() {
  ...
  // /multistep wizard
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark159121"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark159121"))==1)
      this.bookmark=1
  ...
  receiveBookmark(e)
  {
   ...
   if(e==true)
    this.bookmark=1
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark159121",JSON.stringify(this.bookmark))
  }
createScreen(){
