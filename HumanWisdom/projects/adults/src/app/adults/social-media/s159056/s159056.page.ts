...
export class S159056Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if (JSON.parse(sessionStorage.getItem("bookmark159056")) == 0)
      this.bookmark = 0
    else if (this.bookmarkList.includes(this.screenNumber) || JSON.parse(sessionStorage.getItem("bookmark159056")) == 1)
      this.bookmark = 1
  }
  ...
  receiveBookmark(e) 
  {
    ...
    if (e == true)
      ...
      this.bookmark = 0
    sessionStorage.setItem("bookmark159056", JSON.stringify(this.bookmark))
  }
