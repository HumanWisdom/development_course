...
@Component({
  selector: 'app-s143003',
  templateUrl: './s143003.page.html',
  styleUrls: ['./s143003.page.scss'],
})
export class S143003Page implements OnInit,OnDestroy 
{
  ...
  audioLink=this.mediaAudio+'/diversity-and-inclusion/audios/1.1.mp3'
  transcriptPage="diversity-and-inclusion/s143003t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime143003",this.totalTime)
    localStorage.setItem("avDuration143003",this.avDuration)
  }
