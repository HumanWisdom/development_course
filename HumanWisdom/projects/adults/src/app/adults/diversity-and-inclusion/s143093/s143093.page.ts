...
@Component({
  selector: 'app-s143093',
  templateUrl: './s143093.page.html',
  styleUrls: ['./s143093.page.scss'],
})
export class S143093Page implements OnInit 
{
  bg_tn = "bg_292d56"
  bg_cft = "bg_292d56"
  bg = "bg_292d56"
  ...
  goNext() 
  {
    this.router.navigate(['/adults/diversity-and-inclusion/s143094'])
