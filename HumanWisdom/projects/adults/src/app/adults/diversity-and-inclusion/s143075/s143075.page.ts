...
@Component({
  selector: 'app-s143075',
  templateUrl: './s143075.page.html',
  styleUrls: ['./s143075.page.scss'],
})
export class S143075Page implements OnInit,OnDestroy 
{
  bg_tn="bg_292d56"
  bg_cft="bg_292d56"
  bg="bg_292d56"
  ...
  audioLink=this.mediaAudio+'/diversity-and-inclusion/audios/3.2.mp3'
  transcriptPage="diversity-and-inclusion/s143075t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime143075",this.totalTime)
    localStorage.setItem("avDuration143075",this.avDuration)
  }
