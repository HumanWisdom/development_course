...
@Component({
  selector: 'app-s143059t',
  templateUrl: './s143059t.page.html',
  styleUrls: ['./s143059t.page.scss'],
})
export class S143059tPage implements OnInit 
{
  ...
  avDuration=localStorage.getItem("avDuration143059")
  totalTime=localStorage.getItem("totalTime143059")
