...
@Component({
  selector: 'app-s143012t',
  templateUrl: './s143012t.page.html',
  styleUrls: ['./s143012t.page.scss'],
})
export class S143012tPage implements OnInit 
{
  ...
  audioPage="/diversity-and-inclusion/s143012"
  ...
  avDuration=localStorage.getItem("avDuration143012")
  totalTime=localStorage.getItem("totalTime143012")
