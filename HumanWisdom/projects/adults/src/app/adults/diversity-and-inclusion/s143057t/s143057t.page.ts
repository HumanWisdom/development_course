...
@Component({
  selector: 'app-s143057t',
  templateUrl: './s143057t.page.html',
  styleUrls: ['./s143057t.page.scss'],
})
export class S143057tPage implements OnInit 
{
  ...
  audioPage="/diversity-and-inclusion/s143057"
  ...
  avDuration=localStorage.getItem("avDuration143057")
  totalTime=localStorage.getItem("totalTime143057")
