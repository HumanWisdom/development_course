...
@Component({
  selector: 'app-s143047',
  templateUrl: './s143047.page.html',
  styleUrls: ['./s143047.page.scss'],
})
export class S143047Page implements OnInit,OnDestroy 
{
  ...
  transcriptPage="diversity-and-inclusion/s143047t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime143047",this.totalTime)
    localStorage.setItem("avDuration143047",this.avDuration)
  }
