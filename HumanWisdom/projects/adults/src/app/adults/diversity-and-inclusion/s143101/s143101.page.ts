...
@Component({
  selector: 'app-s143101',
  templateUrl: './s143101.page.html',
  styleUrls: ['./s143101.page.scss'],
})
export class S143101Page implements OnInit 
{
  ...
  ngOnInit() 
  {
    ...
    this.q1 = this.findQuestion(499).Question
    this.optionList1 = this.findQuestion(499).optionList
    this.q2 = this.findQuestion(500).Question
    this.optionList2 = this.findQuestion(500).optionList
    this.q3 = this.findQuestion(501).Question
    this.optionList3 = this.findQuestion(501).optionList
    this.q4 = this.findQuestion(502).Question
    this.optionList4 = this.findQuestion(502).optionList
    this.q5 = this.findQuestion(503).Question
    this.optionList5 = this.findQuestion(503).optionList
  ...
  submitProgress() 
  {
    ...
    this.router.navigate(['/adults/diversity-and-inclusion/s143102'])
  ...
  routeNext() 
  {
    this.router.navigate(['/adults/diversity-and-inclusion/s160p1'])
  }
