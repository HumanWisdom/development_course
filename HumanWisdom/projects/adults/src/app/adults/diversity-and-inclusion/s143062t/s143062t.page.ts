...
@Component({
  selector: 'app-s143062t',
  templateUrl: './s143062t.page.html',
  styleUrls: ['./s143062t.page.scss'],
})
export class S143062tPage implements OnInit 
{
  ...
  audioPage="/diversity-and-inclusion/s143062"
  ...
  avDuration=localStorage.getItem("avDuration143062")
  totalTime=localStorage.getItem("totalTime143062")
