...
@Component({
  selector: 'app-s143053',
  templateUrl: './s143053.page.html',
  styleUrls: ['./s143053.page.scss'],
})
export class S143053Page implements OnInit,OnDestroy 
{
  ...
  audioLink=this.mediaAudio+'/diversity-and-inclusion/audios/2.3.mp3'
  transcriptPage="diversity-and-inclusion/s143053t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime143053",this.totalTime)
    localStorage.setItem("avDuration143053",this.avDuration)
  }
