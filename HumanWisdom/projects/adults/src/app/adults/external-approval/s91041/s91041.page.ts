...
@Component({
  selector: 'app-s91041',
  templateUrl: './s91041.page.html',
  styleUrls: ['./s91041.page.scss'],
})
export class S91041Page implements OnInit,OnDestroy {

  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w5"
  title="Our need for Need for approval can influence our behaviour"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/external-approval/audios/1.8.mp3'

  transcriptPage="external-approval/s91041t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91041",this.totalTime)
    localStorage.setItem("avDuration91041",this.avDuration)
  }
}