...
@Component({
  selector: 'app-s91013',
  templateUrl: './s91013.page.html',
  styleUrls: ['./s91013.page.scss'],
})
export class S91013Page implements OnInit,OnDestroy {
  ...
  transcriptPage="external-approval/s91013t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91013",this.totalTime)
    localStorage.setItem("avDuration91013",this.avDuration)
  }
}