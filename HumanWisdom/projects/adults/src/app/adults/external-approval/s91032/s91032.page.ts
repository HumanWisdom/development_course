...
@Component({
  selector: 'app-s91032',
  templateUrl: './s91032.page.html',
  styleUrls: ['./s91032.page.scss'],
})
export class S91032Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/external-approval/audios/1.5.mp3'

  transcriptPage="external-approval/s91032t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91032",this.totalTime)
    localStorage.setItem("avDuration91032",this.avDuration)
  }
}