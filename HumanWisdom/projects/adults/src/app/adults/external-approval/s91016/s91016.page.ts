...
@Component({
  selector: 'app-s91016',
  templateUrl: './s91016.page.html',
  styleUrls: ['./s91016.page.scss'],
})
export class S91016Page implements OnInit {
  ...
  ngOnInit() 
  {
    ...
    if(JSON.parse(sessionStorage.getItem("bookmark91016"))==0)
      this.bookmark=0
    else if(this.bookmarkList.includes(this.screenNumber)||JSON.parse(sessionStorage.getItem("bookmark91016"))==1)
      this.bookmark=1
  }
  ...
  receiveBookmark(e)
  {
    ...
    if(e==true)
      ...
      this.bookmark=0
    sessionStorage.setItem("bookmark91016",JSON.stringify(this.bookmark))
  }
