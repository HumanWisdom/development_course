...
@Component({
  selector: 'app-s91003',
  templateUrl: './s91003.page.html',
  styleUrls: ['./s91003.page.scss'],
})
export class S91003Page implements OnInit,OnDestroy {
  ...
  transcriptPage="external-approval/s91003t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91003",this.totalTime)
    localStorage.setItem("avDuration91003",this.avDuration)
  }
}