...
@Component({
  selector: 'app-s91039',
  templateUrl: './s91039.page.html',
  styleUrls: ['./s91039.page.scss'],
})
export class S91039Page implements OnInit,OnDestroy {

  bg_tn="bg_blue"
  bg_cft="bg_blue"
  bg="blue_w3"
  title="Our need for Need for approval can also result in anxiety"
  mediaAudio=JSON.parse(localStorage.getItem("mediaAudio"))
  audioLink=this.mediaAudio+'/external-approval/audios/1.7.mp3'

  transcriptPage="external-approval/s91039t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91039",this.totalTime)
    localStorage.setItem("avDuration91039",this.avDuration)
  }
}