...
@Component({
  selector: 'app-s91045',
  templateUrl: './s91045.page.html',
  styleUrls: ['./s91045.page.scss'],
})
export class S91045Page implements OnInit,OnDestroy {
  ...
  transcriptPage="external-approval/s91045t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91045",this.totalTime)
    localStorage.setItem("avDuration91045",this.avDuration)
  }
}