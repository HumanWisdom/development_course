...
@Component({
  selector: 'app-s91057',
  templateUrl: './s91057.page.html',
  styleUrls: ['./s91057.page.scss'],
})
export class S91057Page implements OnInit,OnDestroy {
  ...
  transcriptPage="external-approval/s91057t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime91057",this.totalTime)
    localStorage.setItem("avDuration91057",this.avDuration)
  }
}