...
@Component({
  selector: 'app-s64007-audio',
  templateUrl: './s64007.page.html',
  styleUrls: ['./s64007.page.scss'],
})
export class S64007Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-death/s64007t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime64007",this.totalTime)
    localStorage.setItem("avDuration64007",this.avDuration)
