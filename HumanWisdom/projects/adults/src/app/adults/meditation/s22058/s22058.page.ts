...
@Component({
  selector: 'app-s22058',
  templateUrl: './s22058.page.html',
  styleUrls: ['./s22058.page.scss'],
})
export class S22058Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r22058 = JSON.parse(sessionStorage.getItem("r22058"))
  r22058 = sessionStorage.getItem("r22058") !== 'null' ? sessionStorage.getItem("r22058") : ''
