...
@Component({
  selector: 'app-s22001',
  templateUrl: './s22001.page.html',
  styleUrls: ['./s22001.page.scss'],
})
export class S22001Page implements OnInit,OnDestroy {
  userId:any
  ...
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/22.jpg"
  tocColor="white"
  lastvisited = false;
  stories: any = []
