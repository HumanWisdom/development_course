...
@Component({
  selector: 'app-s49061',
  templateUrl: './s49061.page.html',
  styleUrls: ['./s49061.page.scss'],
})
export class S49061Page implements OnInit {
  ...
  transcriptPage="opinions-beliefs/s49061t"
  ...
  prev(){
    this.router.navigate(['/adults/opinions-beliefs/s49060'])
 
 
  }
  ngOnDestroy(){
    localStorage.setItem("totalTime49061",this.totalTime)
    localStorage.setItem("avDuration49061",this.avDuration)
  }
}
