...
@Component({
  selector: 'app-s49052-audio',
  templateUrl: './s49052.page.html',
  styleUrls: ['./s49052.page.scss'],
})
export class S49052Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/opinions-beliefs/audios/opinions-beliefs+2.1.mp3'

  transcriptPage="opinions-beliefs/s49052t"
  ...
  ngOnDestroy(){
    localStorage.setItem("totalTime49052",this.totalTime)
    localStorage.setItem("avDuration49052",this.avDuration)
