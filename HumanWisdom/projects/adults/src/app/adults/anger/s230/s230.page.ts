...
@Component({
  selector: 'app-s230',
  templateUrl: './s230.page.html',
  styleUrls: ['./s230.page.scss'],
})
export class S230Page implements OnInit {
  ...
  ngOnInit() {
    ...
    this.q1 = this.findQuestion(51).Question
    this.optionList1 = this.findQuestion(51).optionList
    this.q2 = this.findQuestion(52).Question
    this.optionList2 = this.findQuestion(52).optionList
    this.q3 = this.findQuestion(53).Question
    this.optionList3 = this.findQuestion(53).optionList
    this.q4 = this.findQuestion(54).Question
    this.optionList4 = this.findQuestion(54).optionList
    this.q5 = this.findQuestion(55).Question
    this.optionList5 = this.findQuestion(55).optionList
