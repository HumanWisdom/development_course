...
@Component({
  selector: 'app-s54001',
  templateUrl: './s54001.page.html',
  styleUrls: ['./s54001.page.scss'],
})
export class S54001Page implements OnInit,OnDestroy {
  ...
  pgResume: any; 
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/54.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(54, this.userId).subscribe(res => {
