...
@Component({
  selector: 'app-s54079',
  templateUrl: './s54079.page.html',
  styleUrls: ['./s54079.page.scss'],
})
export class S54079Page implements OnInit {
  ...
  ngOnInit() {
    ...
    $(document).ready(function () {
      // var base_color = "rgb(54079,54079,54079)";
    ...
    this.q1 = this.findQuestion(169).Question
    this.optionList1 = this.findQuestion(169).optionList
    this.q2 = this.findQuestion(170).Question
    this.optionList2 = this.findQuestion(170).optionList

    this.q4 = this.findQuestion(171).Question
    this.optionList4 = this.findQuestion(171).optionList
    this.q5 = this.findQuestion(172).Question
    this.optionList5 = this.findQuestion(172).optionList
    this.q6 = this.findQuestion(173).Question
    this.optionList6 = this.findQuestion(173).optionList
