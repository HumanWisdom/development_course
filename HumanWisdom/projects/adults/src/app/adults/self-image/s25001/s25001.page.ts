...
@Component({
  selector: 'app-s25001',
  templateUrl: './s25001.page.html',
  styleUrls: ['./s25001.page.scss'],
})
export class S25001Page implements OnInit,OnDestroy {
  ...
  bookmarkList=[]
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/25.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() 
  {
    ...
    this.service.setmoduleID(25);
    this.service.clickModule(25,this.userId).subscribe(res=>
      {
