...
@Component({
  selector: 'app-s57001',
  templateUrl: './s57001.page.html',
  styleUrls: ['./s57001.page.scss'],
})
export class S57001Page implements OnInit,OnDestroy {
  ...
  bookmarkList=[]
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/57.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = [];
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(57, this.userId).subscribe(res => {
