...
@Component({
  selector: 'app-s62001',
  templateUrl: './s62001.page.html',
  styleUrls: ['./s62001.page.scss'],
})
export class S62001Page implements OnInit,OnDestroy {
  ...
  bookmarkList=[]
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/62.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(62, this.userId).subscribe(res => {
