...
@Component({
  selector: 'HumanWisdom-s76080t',
  templateUrl: './s76080t.page.html',
  styleUrls: ['./s76080t.page.scss'],
})
export class S76080tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration76080")
  totalTime=localStorage.getItem("totalTime76080")
