...
@Component({
  selector: 'HumanWisdom-s76009',
  templateUrl: './s76009.page.html',
  styleUrls: ['./s76009.page.scss'],
})
export class S76009Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76009t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76009",this.totalTime)
    localStorage.setItem("avDuration76009",this.avDuration)
  }
}