...
@Component({
  selector: 'HumanWisdom-s76053',
  templateUrl: './s76053.page.html',
  styleUrls: ['./s76053.page.scss'],
})
export class S76053Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76053t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76053",this.totalTime)
    localStorage.setItem("avDuration76053",this.avDuration)
  }
}