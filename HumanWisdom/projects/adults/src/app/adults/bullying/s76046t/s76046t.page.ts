...
@Component({
  selector: 'HumanWisdom-s76046t',
  templateUrl: './s76046t.page.html',
  styleUrls: ['./s76046t.page.scss'],
})
export class S76046tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration76046")
  totalTime=localStorage.getItem("totalTime76046")
