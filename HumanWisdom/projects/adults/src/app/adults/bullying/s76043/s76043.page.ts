...
@Component({
  selector: 'HumanWisdom-s76043',
  templateUrl: './s76043.page.html',
  styleUrls: ['./s76043.page.scss'],
})
export class S76043Page implements OnInit,OnDestroy {
  ...
  transcriptPage="bullying/s76043t"
  toc="bullying/s76001"
  bookmark=0
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime76043",this.totalTime)
    localStorage.setItem("avDuration76043",this.avDuration)
  }
}