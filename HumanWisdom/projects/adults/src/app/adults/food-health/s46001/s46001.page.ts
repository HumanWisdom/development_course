...
@Component({
  selector: 'app-s46001',
  templateUrl: './s46001.page.html',
  styleUrls: ['./s46001.page.scss'],
})
export class S46001Page implements OnInit,OnDestroy {
  ...
  pgResume: any;
  tocImage="https://d1tenzemoxuh75.cloudfront.net/assets/images/background/toc/46.webp"
  tocColor="white"
  lastvisited = false;
  stories: any = []
  isLoggedIn = false;
  ...
  ngOnInit() {
    ...
    this.service.clickModule(46, this.userId).subscribe(res => {
