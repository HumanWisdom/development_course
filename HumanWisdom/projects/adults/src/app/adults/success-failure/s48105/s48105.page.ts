...
@Component({
  selector: 'app-s48105',
  templateUrl: './s48105.page.html',
  styleUrls: ['./s48105.page.scss'],
})
export class S48105Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  r48105 = JSON.parse(sessionStorage.getItem("r48105"))
  ...
  submitProgress() {
    ...
    this.r48105 = sessionStorage.getItem("r48105")
