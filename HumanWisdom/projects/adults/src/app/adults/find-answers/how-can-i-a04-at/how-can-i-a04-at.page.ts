...
@Component({
  selector: 'app-how-can-i-a04-at',
  templateUrl: './how-can-i-a04-at.page.html',
  styleUrls: ['./how-can-i-a04-at.page.scss'],
})
export class HowCanIA04AtPage implements OnInit {
