...
@Component({
  selector: 'app-how-can-i-a02-at',
  templateUrl: './how-can-i-a02-at.page.html',
  styleUrls: ['./how-can-i-a02-at.page.scss'],
})
export class HowCanIA02AtPage implements OnInit {
