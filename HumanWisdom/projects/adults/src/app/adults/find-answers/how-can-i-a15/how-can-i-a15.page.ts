...
@Component({
  selector: 'app-how-can-i-a15',
  templateUrl: './how-can-i-a15.page.html',
  styleUrls: ['./how-can-i-a15.page.scss'],
})
export class HowCanIA15Page implements OnInit {
  ...
  goBack() 
  {
    ...
    if (isLoggedIn && isSubscribed) {
      ...
      this.router.navigate(['/adults/find-answers/how-can-i/how-can-i-a15-at']);
    } else {
