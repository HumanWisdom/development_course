...
@Component({
  selector: 'app-how-can-i-a13-at',
  templateUrl: './how-can-i-a13-at.page.html',
  styleUrls: ['./how-can-i-a13-at.page.scss'],
})
export class HowCanIA13AtPage implements OnInit {
