...
@Component({
  selector: 'app-how-can-i-a06-at',
  templateUrl: './how-can-i-a06-at.page.html',
  styleUrls: ['./how-can-i-a06-at.page.scss'],
})
export class HowCanIA06AtPage implements OnInit {
