...
@Component({
  selector: 'app-how-can-i-a11-at',
  templateUrl: './how-can-i-a11-at.page.html',
  styleUrls: ['./how-can-i-a11-at.page.scss'],
})
export class HowCanIA11AtPage implements OnInit {
