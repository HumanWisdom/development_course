...
@Component({
  selector: 'app-how-can-i-a15-at',
  templateUrl: './how-can-i-a15-at.page.html',
  styleUrls: ['./how-can-i-a15-at.page.scss'],
})
export class HowCanIA15AtPage implements OnInit {
