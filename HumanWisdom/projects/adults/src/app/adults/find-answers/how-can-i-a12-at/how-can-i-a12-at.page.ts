...
@Component({
  selector: 'app-how-can-i-a12-at',
  templateUrl: './how-can-i-a12-at.page.html',
  styleUrls: ['./how-can-i-a12-at.page.scss'],
})
export class HowCanIA12AtPage implements OnInit {
