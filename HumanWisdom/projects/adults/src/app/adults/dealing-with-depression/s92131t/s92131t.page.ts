...
@Component({
  selector: 'app-s92131t',
  templateUrl: './s92131t.page.html',
  styleUrls: ['./s92131t.page.scss'],
})
export class S92131tPage implements OnInit {
  ...
  audioPage="/dealing-with-depression/s92131"
  ...
  avDuration=localStorage.getItem("avDuration92131")
  totalTime=localStorage.getItem("totalTime92131")
