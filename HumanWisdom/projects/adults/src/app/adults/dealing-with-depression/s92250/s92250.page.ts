...
@Component({
  selector: 'app-s92250',
  templateUrl: './s92250.page.html',
  styleUrls: ['./s92250.page.scss'],
})
export class S92250Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s92250t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92250",this.totalTime)
    localStorage.setItem("avDuration92250",this.avDuration)
  }
}