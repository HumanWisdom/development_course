...
@Component({
  selector: 'app-s92101',
  templateUrl: './s92101.page.html',
  styleUrls: ['./s92101.page.scss'],
})
export class S92101Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/dealing-with-depression/audios/3.2.mp3'

  transcriptPage="dealing-with-depression/s92101t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92101",this.totalTime)
    localStorage.setItem("avDuration92101",this.avDuration)
  }
}