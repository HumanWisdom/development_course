...
@Component({
  selector: 'app-s92179',
  templateUrl: './s92179.page.html',
  styleUrls: ['./s92179.page.scss'],
})
export class S92179Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s92179t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92179",this.totalTime)
    localStorage.setItem("avDuration92179",this.avDuration)
  }
}