...
@Component({
  selector: 'app-s92092t',
  templateUrl: './s92092t.page.html',
  styleUrls: ['./s92092t.page.scss'],
})
export class S92092tPage implements OnInit {
  ...
  audioPage="/dealing-with-depression/s92092"
  ...
  avDuration=localStorage.getItem("avDuration92092")
  totalTime=localStorage.getItem("totalTime92092")
