...
@Component({
  selector: 'app-s92043',
  templateUrl: './s92043.page.html',
  styleUrls: ['./s92043.page.scss'],
})
export class S92043Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/dealing-with-depression/audios/1.4.mp3'

  transcriptPage="dealing-with-depression/s92043t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92043",this.totalTime)
    localStorage.setItem("avDuration92043",this.avDuration)
  }
}