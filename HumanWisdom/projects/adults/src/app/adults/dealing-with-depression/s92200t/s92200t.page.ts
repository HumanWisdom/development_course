...
@Component({
  selector: 'app-s92200t',
  templateUrl: './s92200t.page.html',
  styleUrls: ['./s92200t.page.scss'],
})
export class S92200tPage implements OnInit {
  ...
  audioPage="/dealing-with-depression/s92200"
  ...
  avDuration=localStorage.getItem("avDuration92200")
  totalTime=localStorage.getItem("totalTime92200")
