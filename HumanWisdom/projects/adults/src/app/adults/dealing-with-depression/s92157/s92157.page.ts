...
@Component({
  selector: 'app-s92157',
  templateUrl: './s92157.page.html',
  styleUrls: ['./s92157.page.scss'],
})
export class S92157Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s92157t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92157",this.totalTime)
    localStorage.setItem("avDuration92157",this.avDuration)
  }
}