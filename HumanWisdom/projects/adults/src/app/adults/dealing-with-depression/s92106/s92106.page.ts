...
@Component({
  selector: 'app-s92106',
  templateUrl: './s92106.page.html',
  styleUrls: ['./s92106.page.scss'],
})
export class S92106Page implements OnInit,OnDestroy {
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92106",this.totalTime)
    localStorage.setItem("avDuration92106",this.avDuration)
  }
}