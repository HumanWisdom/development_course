...
@Component({
  selector: 'app-s92230t',
  templateUrl: './s92230t.page.html',
  styleUrls: ['./s92230t.page.scss'],
})
export class S92230tPage implements OnInit {
  ...
  audioPage="/dealing-with-depression/s92230"
  ...
  avDuration=localStorage.getItem("avDuration92230")
  totalTime=localStorage.getItem("totalTime92230")
