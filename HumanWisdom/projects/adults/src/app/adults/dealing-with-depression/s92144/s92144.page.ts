...
@Component({
  selector: 'app-s92144',
  templateUrl: './s92144.page.html',
  styleUrls: ['./s92144.page.scss'],
})
export class S92144Page implements OnInit,OnDestroy {
  ...
  transcriptPage="dealing-with-depression/s92144t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92144",this.totalTime)
    localStorage.setItem("avDuration92144",this.avDuration)
  }
}