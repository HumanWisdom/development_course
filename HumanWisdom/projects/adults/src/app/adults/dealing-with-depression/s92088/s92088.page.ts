...
@Component({
  selector: 'app-s92088',
  templateUrl: './s92088.page.html',
  styleUrls: ['./s92088.page.scss'],
})
export class S92088Page implements OnInit,OnDestroy {
  ...
  audioLink=this.mediaAudio+'/dealing-with-depression/audios/2.2.mp3'

  transcriptPage="dealing-with-depression/s92088t"
  ...
  ngOnDestroy()
  {
    localStorage.setItem("totalTime92088",this.totalTime)
    localStorage.setItem("avDuration92088",this.avDuration)
  }
}