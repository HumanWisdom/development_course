...
@Component({
  selector: 'app-s511t',
  templateUrl: './s511t.page.html',
  styleUrls: ['./s511t.page.scss'],
})
export class S511tPage implements OnInit {
  ...
  avDuration=localStorage.getItem("avDuration511")
  totalTime=localStorage.getItem("totalTime511")
