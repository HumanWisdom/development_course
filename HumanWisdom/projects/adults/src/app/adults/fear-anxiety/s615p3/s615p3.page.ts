...
@Component({
  selector: 'app-s615p3',
  templateUrl: './s615p3.page.html',
  styleUrls: ['./s615p3.page.scss'],
})
export class S615p3Page implements OnInit {
  ...
  reflection: any
  reflectionA: any
  //r615p3 = JSON.parse(sessionStorage.getItem("r615p3"))
  r615p3 = sessionStorage.getItem("r615p3") !== 'null' ? sessionStorage.getItem("r615p3") : '';
  ...
  submitProgress() {
    ...
    this.r615p3 = sessionStorage.getItem("r615p3")
    console.log(this.r615p3)
