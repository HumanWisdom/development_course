...
//   beforeEach(async () => {
//     mockRouterUrl = '/adults/wisdom-shorts';
//     mockActivatedRoute = {
//       snapshot: {
//         fragment: null
//       }
...
//     // Mock window.location.href - set it directly since it's not configurable
...
//       expect(component.address).toBe('/adults/wisdom-shorts');
//     });
...
//     it('should filter wisdom shorts by ProgramId', fakeAsync(() => {
//       const mockShorts = [
//         { ProgIDs: [ProgramType.Adults], Title: 'Adult Short', PreferenceIDs: '1' },
//         { ProgIDs: [ProgramType.Teenagers], Title: 'Teen Short', PreferenceIDs: '2' },
//         { ProgIDs: [ProgramType.Adults], Title: 'Another Adult Short' }
//       ];
...
//       expect(component.allwisdomshorts[0].Title).toBe('Adult Short');
//     }));

//     it('should set wisdomShortData in localStorage', fakeAsync(() => {
//       const mockShorts = [
//         { ProgIDs: [ProgramType.Adults], Title: 'Test Short' }
//       ];
//       mockCommonService.GetWisdomShorts.and.returnValue(of(mockShorts));
...
//     it('should call getUserPref with all when no pref parameter', fakeAsync(() => {
...
//         { id: 'voices', displayName: 'Voices', active: false, name: 'voices' }
//       ]);
//       mockCommonService.GetWisdomShorts.and.returnValue(of(mockShorts));
...
//       expect(component.getUserPref).toHaveBeenCalledWith('voices');
//     }));
//   });
...
//     it('should navigate to video when user is logged in subscriber', fakeAsync(() => {
//       localStorage.setItem('isloggedin', 'T');
//       localStorage.setItem('Subscriber', '1');
//       const video = '/adults/wisdom-shorts/video.123.mp4';
//       const title = 'Test Title';
...
//     it('should show modal when user is not logged in or not subscriber', fakeAsync(() => {
//       localStorage.setItem('isloggedin', 'F');
//       localStorage.setItem('Subscriber', '0');
//       const video = '/adults/wisdom-shorts/video.123.mp4';
//       const title = 'Test Title';
...
//       expect(component.wisdomshorts.length).toBe(1);
//       expect(component.wisdomshorts[0].Title).toBe('Short 4');
//     });
//   });
