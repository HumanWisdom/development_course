...
export class YoutubeContentComponent implements OnInit {
  ...
  ngOnInit()
  {
    let code = `https://www.youtube.com/embed/${this.linkcode}?cc_load_policy=0&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&fs=1&enablejsapi=1&allowfullscreen=1`;
