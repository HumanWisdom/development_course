...
describe('AnxietyPage', () => {
  ...
  beforeEach(async () => {
    ...
    Object.defineProperty(mockRouter, 'url', {
      get: () => '/adults/feel-better-now/anxiety',
      configurable: true
    });
  ...
  describe('routeVideoaudio', () => {
    ...
    it('should navigate to feel-better-now for page type when subscribed', () => {
      ...
      component.routeVideoaudio('page', 'anxiety-at', '');

      expect(mockRouter.navigate).toHaveBeenCalledWith(['/adults/feel-better-now', 'anxiety-at']);
    });
