...
describe('CopingWithIllnessPage', () => {
  ...
  beforeEach(async () => {
    ...
    Object.defineProperty(mockRouter, 'url', {
      get: () => '/adults/feel-better-now/coping-with-illness',
      configurable: true
    });
  ...
  describe('constructor', () => {
    ...
    it('should set mediaUrl with url and youtubeUrl', () => {
      expect(component.mediaUrl).toEqual({
  ...
  describe('ngOnInit', () => {
    ...
    it('should set isIOS from SharedService', () => {
      Object.defineProperty(SharedService, 'isIos', {
        get: () => true,
        configurable: true
      });
  ...
  describe('routeToYoutube', () => {
    it('should navigate to teenagers youtubelink when ProgramId is Teenagers', () => {
      ...
      component.routeToYoutube('vid123');

      expect(mockRouter.navigate).toHaveBeenCalledWith(['/teenagers/feel-better-now/feeling-upset/youtubelink/', 'vid123']);
    });

    it('should navigate to adults youtubelink when ProgramId is Adults', () => {
      component.routeToYoutube('vid456');

      expect(mockRouter.navigate).toHaveBeenCalledWith(['/adults/feel-better-now/feeling-upset/youtubelink/', 'vid456']);
    });
  });
  ...
  describe('routeVideoaudio', () => {
    ...
    it('should navigate to teenagers trial when not subscribed and on teenagers route', () => {
      localStorage.setItem('isloggedin', 'T');
      component.isSubscribed = false;
      Object.defineProperty(mockRouter, 'url', {
        get: () => '/teenagers/feel-better-now/coping-with-illness',
        configurable: true
      });
    ...
    it('should navigate to feel-better-now for page type when subscribed', () => {
      ...
      component.routeVideoaudio('page', 'coping-with-illness-at', '');

      expect(mockRouter.navigate).toHaveBeenCalledWith(['/adults/feel-better-now', 'coping-with-illness-at']);
    });
  ...
  describe('determineRouterLink', () => {
    ...
    it('should navigate to teenagers trial when not subscribed and ProgramId is Teenagers', () => {
      component.isSubscribed = false;
      mockProgramId = ProgramType.Teenagers;
      Object.defineProperty(SharedService, 'ProgramId', {
        get: () => mockProgramId,
