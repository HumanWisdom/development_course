...
describe('RelationshipProblemsPage', () => {
  ...
  beforeEach(() => {
    ...
    (mockRouter as any).url = '/adults/feel-better-now/relationship-problems';

    mockLocation = jasmine.createSpyObj('Location', ['back']);
    mockSanitizer = jasmine.createSpyObj('DomSanitizer', ['sanitize', 'bypassSecurityTrustResourceUrl', 'bypassSecurityTrustHtml', 'bypassSecurityTrustScript', 'bypassSecurityTrustStyle', 'bypassSecurityTrustUrl']);
  ...
  describe('routeVideoaudio', () => {
    ...
    it('should navigate to teenagers trial when router url includes teenagers and not subscribed', () => {
      (mockRouter as any).url = '/teenagers/feel-better-now/relationship-problems';
      localStorage.setItem('Subscriber', '0');
      fixture = TestBed.createComponent(RelationshipProblemsPage);
      component = fixture.componentInstance;
      component.ngOnInit();
    ...
    it('should navigate for type video when logged in and subscribed', () => {
      component.routeVideoaudio('video', '/adults/videopage/breathing-videos-1.5.mp4', 'Humming bee');
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/adults/videopage/breathing-videos-1.5.mp4', 'F', 'Humming bee']);
    });
    ...
    it('should navigate for type page when Adults', () => {
      component.routeVideoaudio('page', 'relationship-problems-at');
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/adults/feel-better-now', 'relationship-problems-at']);
    });
    ...
    it('should navigate for type page when Teenagers', () => {
      ...
      component.ngOnInit();
      component.routeVideoaudio('page', 'relationship-problems-at');
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/teenagers/feel-better-now', 'relationship-problems-at']);
    });
  });
  ...
  describe('determineVideoUrl', () => {
    it('should return teenagers videopage url when ProgramId is Teenagers', () => {
      ...
      fixture = TestBed.createComponent(RelationshipProblemsPage);
      component = fixture.componentInstance;
      const url = component.determineVideoUrl('breathing-videos-1.5.mp4');
      expect(url).toBe('/teenagers/videopage/breathing-videos-1.5.mp4');
    });

    it('should return adults videopage url when ProgramId is Adults', () => {
      const url = component.determineVideoUrl('breathing-videos-1.5.mp4');
      expect(url).toBe('/adults/videopage/breathing-videos-1.5.mp4');
    });
  });
  ...
  describe('getClickEvent', () => {
    it('should navigate to trial when not subscribed', () => {
      ...
      component.getClickEvent({
        MediaUrl: 'https://d1tenzemoxuh75.cloudfront.net/soundscapes/14.mp3',
        SoundscapeID: 14,
        Title: 'Serenity Flow'
      });
      expect(mockRouter.navigate).toHaveBeenCalledWith(['/subscription/start-your-free-trial']);
    ...
    it('should navigate to audiopage when subscribed with cloudfront MediaUrl', () => {
      ...
      expect(mockRouter.navigate).toHaveBeenCalledWith([
        'adults/audiopage/',
        encodeURIComponent('~soundscapes~14.mp3'),
        14,
        'T',
        'Serenity-Flow',
        'Soundscapes'
    ...
    it('should use config moduleName when config is set', () => {
      ...
      expect(mockRouter.navigate).toHaveBeenCalledWith(
        jasmine.arrayContaining([jasmine.any(String), jasmine.any(String), 14, 'T', 'Serenity-Flow', 'CustomModule'])
      );
    });
    ...
    it('should use Soundscapes as moduleName when config has no moduleName', () => {
      ...
      expect(mockRouter.navigate).toHaveBeenCalledWith(
        jasmine.arrayContaining([jasmine.any(String), jasmine.any(String), 14, 'T', 'Serenity-Flow', 'Soundscapes'])
      );
    });

    it('should handle MediaUrl without cloudfront prefix', () => {
      component.getClickEvent({
        MediaUrl: 'https://other-cdn.com/audio/15.mp3',
        SoundscapeID: 15,
        Title: 'Custom-Sound'
      });
      expect(mockRouter.navigate).toHaveBeenCalledWith(
        jasmine.arrayContaining([
          jasmine.any(String),
          encodeURIComponent('https://other-cdn.com/audio/15.mp3'.replaceAll('/', '~')),
          15,
          'T',
          'Custom-Sound',
          jasmine.any(String)
  ...
  describe('constructor with localStorage', () => {
    it('should handle missing mediaAudio in localStorage', () => {
      ...
      expect(() => TestBed.createComponent(RelationshipProblemsPage)).not.toThrow();
    });

    it('should handle null mediaAudio in localStorage', () => {
      localStorage.setItem('mediaAudio', 'null');
      const comp = TestBed.createComponent(RelationshipProblemsPage).componentInstance;
