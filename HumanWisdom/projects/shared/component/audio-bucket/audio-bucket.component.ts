...
@Component({
  ...
  templateUrl: './audio-bucket.component.html',
  styleUrls: ['./audio-bucket.component.scss'],
})
export class AudioBucketComponent implements OnInit,OnDestroy,AfterViewInit {
yellow="#FFC455"
@Input() bg: any;
@Input() title: string;
