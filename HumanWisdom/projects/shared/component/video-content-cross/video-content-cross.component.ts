...
@Component({
  selector: 'app-video-content-cross',
  templateUrl: './video-content-cross.component.html',
  styleUrls: ['./video-content-cross.component.scss'],
})
export class VideoContentCrossComponent implements OnInit, OnDestroy {
