...
export class CommonService {
  ...
  GetGuidedJourneyDays(guidedJourneyId: any, progId: any, userId: any): Observable<any> {
    return this.http.get(this.path + `/GetGuidedJourneyDays/${guidedJourneyId}/${progId}/${userId}`);
  }
