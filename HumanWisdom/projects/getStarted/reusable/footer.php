...
<div class="row center_flex display_m_none">
  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0">
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p0">
      <h4 class="mt0px mb15px fs_12px fw_600 lh_150p fc_ffffff">
        About us
      </h4>

      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 dfooter_links">
          <a href="https://staging.happierme.app/about-us">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Our story
            </h4>
          </a>

          <a href="https://staging.happierme.app/adults/hwp-project">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              HappierMe app
            </h4>
          </a>

          <a href="https://staging.happierme.app/adults/testimonials">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Testimonials
            </h4>
          </a>

          <a href="https://staging.happierme.app/adults/blogs">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Blog
            </h4>
          </a>

          <a href="https://staging.happierme.app/partnership-app">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Partnership Program
            </h4>
          </a>
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p0">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 dfooter_links">
          <a href="https://staging.happierme.app/onboarding/add-to-cart">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Gift HappierMe
            </h4>
          </a>
          ...
          <a href="https://staging.happierme.app/wisdom-for-work">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              HappierMe for businesses
            </h4>
          </a>

          <a href="https://staging.happierme.app/wisdom-for-students">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 p0">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 dfooter_links">
          <a href="https://staging.happierme.app/faqs">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              FAQ
            </h4>
          </a>

          <a href="https://staging.happierme.app/contact-us">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Contact us
            </h4>
          </a>

          <a href="https://staging.happierme.app/terms-and-conditions">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Terms & conditions
            </h4>
          </a>

          <a href="https://staging.happierme.app/privacy-policy">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Privacy policy
            </h4>
          </a>

          <a href="https://staging.happierme.app/cookies-policy">
            <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
              Cookie policy
            </h4>
          </a>
  ...
  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0">
    <div class="panel-group" id="accordion_footer">
      ...
      <div class="panel panel-default">
        ...
        <div id="get_happierme" class="panel-collapse collapse">
          <div class="panel-body">
            <!-- links -->
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 dfooter_links">
      ...
      <div class="panel panel-default">
        ...
        <div id="asupport" class="panel-collapse collapse">
          <div class="panel-body">
            <!-- links -->
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0 dfooter_links">
