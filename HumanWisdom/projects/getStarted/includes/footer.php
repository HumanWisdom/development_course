      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 p0  dfooter_links">
            ...
            <a href="https://happierme.app/adults/blogs">
              <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
                Blog
              </h4>
            </a>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12 ">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 p0 dfooter_links">
            ...
            <a href="https://happierme.app/adults/redeem-subscription-landing">
              <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
                Redeem a gift
              </h4>
            </a>
            ...
            <a href="https://happierme.app/pages/newsletter.php">
              <h4 class="mtb0px fs_12px fw_400 lh_150p fc_ffffff">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12  dfooter_social_links">
            ...
            <a href="https://www.linkedin.com/company/humanwisdom" target="_blank">
              <img src="https://d1tenzemoxuh75.cloudfront.net/assets/svgs/v1_3/web_linkedin.svg" class="img-responsive" alt="linkdn">
            </a>
            ...
            <a href="https://www.youtube.com/channel/UCdNujB6X0slYKxLSdWuqCrA" target="_blank">
              <img src="https://d1tenzemoxuh75.cloudfront.net/assets/svgs/v1_3/web_youtube.svg" class="img-responsive" alt="youtube">
            </a>
          </div>
        </div>
  ...
  <div class="row">
    ...
    <div class="banner_ratings" style="padding-left:0 !important;">
      <div class="rating_row">
        ...
        <span class="rating_text">App store</span>
        <span class="rating_score">4.8</span>
        <span class="rating_star"><img class="pb_4px" src ="https://d1tenzemoxuh75.cloudfront.net/website/star.png" alt="star" ></span>
      </div>
      <div class="rating_row">
        <img src="https://d1tenzemoxuh75.cloudfront.net/website/svgs/wh_playstore.svg" class="rating_icon" alt="playstore">
        <span class="rating_text">Google Play</span>
