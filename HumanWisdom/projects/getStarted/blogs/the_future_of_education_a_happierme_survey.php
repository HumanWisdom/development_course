          ...
          <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0">
            ...
            <div class="row rmb80px">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                ...
                The Future of Education: A HappierMe Survey                </h1>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                ...
                - 30% for communication skills                </h4>

                <h4 class="mtb0px blog_desc">
                  
                - 21% for how to manage mental health                </h4>
                ...
                <h4 class="mtb0px blog_desc">
                We need to teach students how to understand and manage their emotions in the context of relationships, empathise with others, and how to be more respectful of different points of view.                </h4>
                ...
                HappierMe
                 ...
                 survey sheds light on a growing consensus: education should evolve to include life skills that support emotional and social well-being. By integrating these elements into the curriculum, we can hope to nurture well-rounded adults who are prepared for the complexities of modern life.
                </h4>
