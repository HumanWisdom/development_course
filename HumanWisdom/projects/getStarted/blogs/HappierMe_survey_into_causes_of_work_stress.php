        ...
        <div class="row center_flex">
          <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0">
            ...
            <div class="row mt20px rmb80px">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                <img src="https://d1tenzemoxuh75.cloudfront.net/blogs/50.webp" class="img-responsive" alt=" 
                HappierMe survey into causes of work stress.">
              </div>
            </div>
            ...
            <div class="row">
             ...
             <h4 class="mtb0px blog_desc">
                  ...
                  18% of people said that they felt stressed because of a negative attitude towards their work. This can lead to dissatisfaction, boredom and cynicism. We need to shift our mindset to being more positive. Our mind usually takes what we already have for granted and focuses on what we don't have. With a positive attitude we can see the best in people and situations and this can make us happier and more productive. We need to bring our happiness to work rather than expecting work to make us happy. 
