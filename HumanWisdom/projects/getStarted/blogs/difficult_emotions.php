    ...
    <main id="main" class="hptblog120px">
      ...
      <section class="rpt_01">
        <div class="row center_flex">
          ...
          <div class="row mt40px rmb80px">
            ...
            <div class="row mt20px rmb80px">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                <img src="https://d1tenzemoxuh75.cloudfront.net/blogs/52_new.webp" class="img-responsive" alt="Difficult emotions: a guide to freedom" style="height:653px;">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                <h4 class="mtb0px blog_desc">
                  ...
                  and enrich our lives — like falling in love or enjoying the beauty of a spring morning. They can also protect us from harm — like expressing anger when it’s appropriate. Quite often though these feelings can be overwhelming and are behind many of the mental health problems we face.
                </h4>

                <h4 class="mtb0px blog_desc">
                  <span class="blog_highlight_black">
                    In this article we explore 6 practical steps 
                  </span>
                  we can all follow to feel better now, and then understand where these feelings come from, for long-term benefit. This process is the same no matter what the emotion we may be dealing with. There are also links here to the relevant sections of the 
            ...
            onclick="return logevent('click_play_video_home', 'index.php')"></iframe>
                ...
                <h4 class="mtb0px blog_desc">
                  The first step is to find ways of calming the mind. These feelings are often powerful and you lose your ability to control them, or reason and think your way out of them. Lean into the sensation of the feeling in your body without naming it and 
                  <span class="blog_highlight_black">
                    do a breathing exercise, or go for a walk in nature, or listen to an audio meditation or do a tapping exercise. 
                  </span>
                  They activate the parasympathetic nervous system, slowing our breathing down and reducing the stress response. It is important that you have practiced these beforehand so when the challenge arises you are ready.
                </h4>

                <h4 class="mtb0px blog_desc">
                  <span class="blog_highlight_black">
                    Learn a new skill — to be able to notice a feeling without naming it. 
                  </span>
                ...
                <h4 class="mtb0px blog_desc">
                  Once the mind feels a bit more calm you need to 
                  <span class="blog_highlight_black">
                    become aware of what is going on around you, in your body, and in your mind.
                  </span>
                </h4>
                ...
                <h4 class="mtb0px blog_desc">
                  ...
                  and connect with them to realize that your thoughts and feelings are not your reality. Use all your senses to connect with the present — you could touch something like a table, or smell something like a fruit or some coffee, or listen to some music, or drink some cold water and feel it going down slowly, or just look at the sky and be awed by its vast beauty.
                </h4>

                <h4 class="mtb0px blog_desc">
                  Once you become aware of your surroundings, 
                  <span class="blog_highlight_black">
                    bring this awareness to your body,
                  </span>
                  noticing where you are feeling this emotion — it could be in your chest, stomach , or body. Stay with the sensation of that feeling without naming it if you can.
                </h4>
                ...
                <h4 class="mtb0px blog_desc">
                  <span class="blog_highlight_black">
                    It involves taking ownership of how we feel 
                  </span>
                ...
                <h4 class="mtb0px blog_desc">
                  In steps 1–3 you’ve put out the fire using the fire extinguisher. 
                  <span class="blog_highlight_black">
                    In steps 4–6 we are going to investigate why the fire started in our mind in the first place, so it doesn’t occur again.
                  </span>
       ...
       <h4 class="mtb0px blog_desc">
                ...
                <h4 class="mtb0px blog_desc">
                  There will come a point though, and it will come unexpectedly, like a shaft of light breaking through the clouds, when 
                  <span class="blog_highlight_black">
                    you will have a flash of insight or a realization, see something in yourself really clearly, and you will be changed for the long term. It will be like walking into a room and putting the light on.
                  </span>
                </h4>
                ...
                <h4 class="mtb0px blog_desc">
                  <span class="blog_highlight_black">
                    Nobody can give you this insight, 
                  </span>
                  you have to discover it for yourself through your own journey of looking and learning about yourself. It’s not an intellectual business — and anyone who wants to can do this — just like anyone who wants to swim can learn to do so. More than anything else you strive for, investing time and energy in this process of learning about yourself and growing as a person will help you make the most of your life.
                </h4>
