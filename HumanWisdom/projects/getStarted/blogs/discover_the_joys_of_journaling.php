        ...
        <div class="row center_flex">
          <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0">
            ...
            <div class="row mt20px rmb80px">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                <img src="https://d1tenzemoxuh75.cloudfront.net/blogs/55.webp" class="img-responsive" alt="Discover the joys of journaling">
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                ...
                <h4 class="mtb0px blog_desc">
                  All through the app you will find
                  <a class="blog_highlight_peach td_underline" href="https://happierme.app/adults/conditioning/s242">
                    reflection screens
                  </a>
                  which ask you a question about that particular topic. It is in asking ourselves that question and noticing what is happening in our own mind that helps us learn about ourselves and it is in that process that an inner transformation can occur.
                </h4>

                <h4 class="mtb0px blog_desc">
                  For example if someone said you are
                  <a class="blog_highlight_peach td_underline" href="https://happierme.app/adults/conditioning/">
                    conditioned
                  </a>
                  by all your past influences and not aware of that process you may agree but that will not bring any change. But if you are asked a particular question - like - ‘How has your conditioning shaped your political beliefs’ that you can reflect on that and realise your beliefs are not originally yours anyway and allow you to question them for yourself.
                </h4>
