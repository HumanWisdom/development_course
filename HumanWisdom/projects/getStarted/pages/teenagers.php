              ...
              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0 div_dyk_l1">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      ...
                      of teens reports a mental health problem 
                      </h5>
                    </div>
                  </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      of teens feel persistently sad
                      </h5>
                    </div>
                  </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      of teens feel addicted to social media 
                      </h5>
                    </div>
                  </div>
                  ...
                  <div class="div_testimonialst">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        HappierMe is more than an app to me. Whenever I need an answer to a question and I'm too shy or impatient to talk to somebody about it, HappierMe is my go to app. It has helped me be emotionally intelligent and given me an understanding of my emotions.
                        </h5>
                      </div>
                    </div>
                ...
                <a class="item" data-aos="fade-up" data-aos-delay="300">
                  <div class="div_testimonialst">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h5 class="mt20px mb12px fs_15px fw_500 lh_150p fc_ffffff">
                        The HappierMe app has been a game-changer in my journey towards wellness and wisdom. The app offers a range of practical tools such as the Awareness exercises and Journaling that have been incredibly beneficial to me.
                        </h5>
                      </div>
                    </div>
                ...
                <a class="item" data-aos="fade-up" data-aos-delay="400">
                  <div class="div_testimonialst">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h5 class="mt20px mb12px fs_15px fw_500 lh_150p fc_ffffff">
                        HappierMe has helped me become emotionally intelligent. I used to be shy, passive and fearful. The app has transformed my way of thinking and relieved me of my anxiety. Whatever you struggle with, there are modules to help.                        </h5>
                      </div>
                    </div>
              ...
              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0 tcenter div_inspire">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      The app guides you to manage the pressure of exams with practical tips on how to plan your studies.
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      Unlock the power of your emotional intelligence, and understand and manage your emotions like anger, envy or loneliness.
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      Navigate the confusion of choosing a career for yourself and make better choices.
                      </h5>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0 tcenter div_inspire">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="500">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      Find out what success means to each of us, how we can be successful in our lives, and how we can deal with failure when it occurs.                       
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="600">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      ...
                      The app guides you to think clearly, have more confidence and make better decisions at every step of your life.  </h5>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="700">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      Understand how habits form and the hidden driver behind addiction. Use this to self-regulate your habits and deal with addiction.
                      </h5>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 p0 tcenter div_inspire">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="800">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      Have happier relationships with your parents and friends. Overcome your loneliness and be happier.                       
                          </h5>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="900">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      <h5 class="mtb0px fs_15px fw_400 lh_140p fc_000000">
                      The app offers quick solutions to relieve stress and anxiety, and also helps you to avoid and manage them better for the long term.                      </h5>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 p0" data-aos="fade-up" data-aos-delay="1000">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
                      ...
                      The Communication module explores how you can be a better listener, speak with care, and deepen your connection with others.                      </h5>
                    </div>
                  </div>
                </div>
