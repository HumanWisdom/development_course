...
@media (max-width: 767px) {
 ...
 .single-line-container {
    ...
    /* Update all black color classes to 75% opacity */
      .fc_000000, .fc_000000_0_7, .fc_000000_0.7, .fc_00000 {
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center_flex header_new">
    ...
    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8 p0 dflex_end">
      ...
      <!-- <a class="btn_tff btn_tff_tn" href="https://onelink.to/hsnt8b">Try for free</a>
...
<!-- /header -->
    ...
    <section class="hpt1px">
      ...
      <div class="row center_flex web_home_divnew width_mob">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8  ddflex_mblock max-w-50">

          <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12 p0 pd-left-10p"  data-aos="fade-up" data-aos-delay="100" style="max-width: fit-content;">
          ...
          <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-xs-12 p0 cmh40px ml-5"  data-aos="fade-up" data-aos-delay="200">
            <div class="row">
            ...
            <div class="row mt20px">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  p-tp">
                <h1  style=" color:rgba(0,0,0,0.75);" class="mt10px fs_45px fw_600 lh_130p  ta_lc resp-font">
  ...
  <div class="row center_flex" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="row align-items-center single-line-container">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-9 text-container mt-3p">
    ...
    <!-- happyuser -->
        ...
        <div class="row center_flex" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p0">
            <img src="https://d1tenzemoxuh75.cloudfront.net/website/svgs/surveycircle.svg" class="img-responsive display_m_none display_mw_none w100p" alt="modules" loading=lazy>
          ...
          <img src="https://d1tenzemoxuh75.cloudfront.net/website/svgs/survetcirclewider.svg" class="happy-wide-img" alt="happy user" loading=lazy>
          </div>
        </div>
