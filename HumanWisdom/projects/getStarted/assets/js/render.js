...
$(".owl_container .owl-carousel").owlCarousel({
    ...
    $(window).resize(function () {
        window.matchMedia("(max-width: 768px)").matches, $(".btn_tff").attr("href", url+"/splash_options.html");
    }),
    $(window).resize(),
    $(window).resize(function () {
        window.matchMedia("(max-width: 768px)").matches ? $(".btn_tff_tn").attr("href", "https://onelink.to/qsptex") : $(".btn_tff_tn").attr("href", url+"/splash_options.html");
    }),
    $(window).resize(),
